...
该接口用于获取客服技能。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=helpdesk&version=v1&resource=agent_skill&method=get)
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >agent\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	客服 info
	</md-dt-td>
