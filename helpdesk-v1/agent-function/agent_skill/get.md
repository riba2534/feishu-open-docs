---
title: "查询指定客服技能"
fullPath: "/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/agent_skill/get"
updateTime: "1692084860000"
---
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `id` | `string` | rule id, 参考[获取客服技能rules](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/agent_skill_rule/list) 用于获取rules options |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `selected_operator` | `int` | 运算符比较, 参考[客服技能运算符选项](https://open.larkoffice.com/document/ukTMukTMukTM/ucDOyYjL3gjM24yN4IjN/operator-options) |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `operator_options` | `int\[\]` | rule操作数value，[客服技能及运算符](https://open.larkoffice.com/document/ukTMukTMukTM/ucDOyYjL3gjM24yN4IjN/operator-options) |
