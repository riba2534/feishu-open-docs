---
title: "查询指定客服工作日程"
fullPath: "/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/agent-schedules/get"
updateTime: "1692084859000"
---

# 查询指定客服工作日程

该接口用于获取客服信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=helpdesk&version=v1&resource=agent.schedules&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/helpdesk/v1/agents/:agent_id/schedules</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >agent_schedule</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >agent_schedule</md-text>
	</md-dt-td>
	<md-dt-td>
	客服日程
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >agent</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >agent_user</md-text>
	</md-dt-td>
	<md-dt-td>
	客服信息
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >schedule</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >weekday_schedule\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	工作日程列表
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >weekday</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >agent_skills</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >agent_skill_less_info\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	客服技能
	</md-dt-td>
