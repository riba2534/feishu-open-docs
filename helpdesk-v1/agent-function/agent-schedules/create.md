...
| &nbsp;&nbsp;└ `agent_id` | `string` | 否 | 客服id<br>[可以以普通用户身份在服务台发起工单，从工单详情里面获取用户guest.id](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/ticket/get)<br>**示例值**："agent-id" |
