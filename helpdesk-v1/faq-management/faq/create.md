...
该接口用于创建知识库。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=helpdesk&version=v1&resource=faq&method=create)
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >faq</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >faq_update_info</md-text>
	</md-dt-td>
	<md-dt-td>
	否
	</md-dt-td>
