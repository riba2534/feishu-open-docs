---
title: "搜索知识库"
fullPath: "/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/faq/search"
updateTime: "1692084863000"
---

# 搜索知识库

该接口用于搜索服务台知识库。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=helpdesk&version=v1&resource=faq&method=search)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/helpdesk/v1/faqs/search</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >base64</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
