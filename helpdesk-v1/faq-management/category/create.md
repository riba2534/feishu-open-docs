---
title: "创建知识库分类"
fullPath: "/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/category/create"
updateTime: "1709724839000"
---

# 创建知识库分类

该接口用于创建知识库分类。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=helpdesk&version=v1&resource=category&method=create)
