---
title: "删除知识库分类详情"
fullPath: "/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/category/delete"
updateTime: "1709724840000"
---

# 删除知识库分类详情

该接口用于删除知识库分类详情。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=helpdesk&version=v1&resource=category&method=delete)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/helpdesk/v1/categories/:id</md-td>
    </md-tr>
    <md-tr>
