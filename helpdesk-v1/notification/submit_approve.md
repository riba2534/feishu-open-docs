---
title: "提交审核"
fullPath: "/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/notification/submit_approve"
updateTime: "1692084864000"
---

# 提交审核

正常情况下调用创建推送接口后，就可以调用提交审核接口，如果创建人是服务台owner则会自动审核通过，否则会通知服务台owner审核此推送信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=helpdesk&version=v1&resource=notification&method=submit_approve)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/helpdesk/v1/notifications/:notification_id/submit_approve</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >has_access</md-text>
	</md-dt-td>
	<md-dt-td>
