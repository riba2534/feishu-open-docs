---
title: "预览推送"
fullPath: "/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/notification/preview"
updateTime: "1692084864000"
---

# 预览推送

在正式执行推送之前是可以调用此接口预览设置的推送内容。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=helpdesk&version=v1&resource=notification&method=preview)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/helpdesk/v1/notifications/:notification_id/preview</md-td>
    </md-tr>
    <md-tr>
