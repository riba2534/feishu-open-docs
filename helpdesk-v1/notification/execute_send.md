---
title: "执行推送"
fullPath: "/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/notification/execute_send"
updateTime: "1692084864000"
---

# 执行推送

审核通过后调用此接口设置推送时间，等待调度系统调度，发送消息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=helpdesk&version=v1&resource=notification&method=execute_send)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/helpdesk/v1/notifications/:notification_id/execute_send</md-td>
    </md-tr>
    <md-tr>
