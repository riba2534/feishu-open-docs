---
title: "取消审核"
fullPath: "/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/notification/cancel_approve"
updateTime: "1692084864000"
---

# 取消审核

提交审核后，如果需要取消审核，则调用此接口。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=helpdesk&version=v1&resource=notification&method=cancel_approve)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/helpdesk/v1/notifications/:notification_id/cancel_approve</md-td>
    </md-tr>
    <md-tr>
