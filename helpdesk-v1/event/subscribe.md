...
本接口用于订阅服务台事件。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=helpdesk&version=v1&resource=event&method=subscribe)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/helpdesk/v1/events/subscribe</md-td>
    </md-tr>
    <md-tr>
