---
title: "取消订阅服务台事件"
fullPath: "/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/event/unsubscribe"
updateTime: "1692084865000"
---

# 取消订阅服务台事件

本接口用于取消订阅服务台事件。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=helpdesk&version=v1&resource=event&method=unsubscribe)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/helpdesk/v1/events/unsubscribe</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >subtype</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
