...
该接口用于获取单个服务台工单详情。仅支持自建应用。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=helpdesk&version=v1&resource=ticket&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/helpdesk/v1/tickets/:ticket_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	工单 ID。可通过[查询全部工单详情](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/ticket/list)获取
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >ticket_v2</md-text>
	</md-dt-td>
	<md-dt-td>
	工单详情
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >ticket_tag\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	工单标签（仅工单含有工单标签会返回）
	</md-dt-td>
...
<md-tr>
  ...
  <md-td>请求不合法，请检查路径参数 `ticket_id` 填写是否正确</md-td>
</md-tr>
