...
| &nbsp;&nbsp;└ `customized_fields` | `customized_field_display_item\[\]` | 自定义字段<br>**注意**：该事件不会返回该值，你可以获取 ticket_id 后调用[查询指定工单详情](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/ticket/get)接口查询自定义字段信息。 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `id` | `string` | 自定义字段ID |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `value` | `string` | 自定义字段值 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `key_name` | `string` | 键名 |
