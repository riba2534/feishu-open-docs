---
title: "工单状态变更"
fullPath: "/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/ticket/events/updated"
updateTime: "1725268181000"
---

# 工单状态变更

可监听工单状态和阶段变更事件。需使用订阅接口订阅：[事件订阅](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/event/subscribe)。
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>helpdesk.ticket.updated_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >ticket_event_update_info</md-text>
	</md-dt-td>
	<md-dt-td>
