...
该接口用于获取服务台自定义字段详情。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=helpdesk&version=v1&resource=ticket&method=customized_fields)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/helpdesk/v1/customized_fields</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >visible_only</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >user_customized_fields</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >user_customized_field\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	用户自定义字段
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >user_customized_field_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >ticket_customized_fields</md-text>
	</md-dt-td>
	<md-dt-td>
