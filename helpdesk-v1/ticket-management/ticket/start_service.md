...
该接口用于创建服务台对话。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=helpdesk&version=v1&resource=ticket&method=start_service)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/helpdesk/v1/start_service</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="helpdesk:helpdesk:access" desc="访问服务台" support_app_types="custom,isv" tags="">访问服务台</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >human_service</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >appointed_agents</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >customized_info</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-tr>
  <md-td>401</md-td>
  <md-td>154402</md-td>
  <md-td>Helpdesk can't be see by user</md-td>
  <md-td>用户不在服务台可见范围内</md-td>
</md-tr>
