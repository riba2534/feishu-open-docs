---
title: "更新工单详情"
fullPath: "/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/ticket/update"
updateTime: "1709724839000"
---

# 更新工单详情

该接口用于更新服务台工单详情。只会更新数据，不会触发相关操作。如修改工单状态到关单，不会关闭聊天页面。仅支持自建应用。要更新的工单字段必须至少输入一项。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=helpdesk&version=v1&resource=ticket&method=update)
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >tag_names</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
