...
fullPath: "/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/bot-message/create"
updateTime: "1746759359000"
---

# 服务台机器人向工单绑定的群内发送消息

通过服务台机器人给指定用户的服务台专属群或私聊发送消息，支持文本、富文本、卡片、图片。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=helpdesk&version=v1&resource=bot.message&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/helpdesk/v1/message</md-td>
    </md-tr>
    <md-tr>
...
**可选值有**：
<md-enum>
<md-enum-item key="text" >普通文本</md-enum-item>
<md-enum-item key="post" >富文本</md-enum-item>
<md-enum-item key="image" >图片</md-enum-item>
<md-enum-item key="interactive" >卡片消息</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >receiver_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >receive_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="chat" >通过服务台专属群发送</md-enum-item>
<md-enum-item key="user" >通过服务台机器人私聊发送</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
