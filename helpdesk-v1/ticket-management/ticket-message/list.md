---
title: "获取工单消息详情"
fullPath: "/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/ticket-message/list"
updateTime: "1692084861000"
---

# 获取工单消息详情

该接口用于获取服务台工单消息详情。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=helpdesk&version=v1&resource=ticket.message&method=list)
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >ticket.message\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	工单消息列表
	</md-dt-td>
