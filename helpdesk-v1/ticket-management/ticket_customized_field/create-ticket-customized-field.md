...
### 请求体
:::html
引用类型：<md-text type="field-type" >ticket_customized_field</md-text>
:::
:::html
<md-table>
  <md-thead>
...
<md-tr>
	...
	<md-td>
	服务台ID（需要和请求 Header 中的服务台 ID 保持一致，可以省略）。
...
<md-tr>
	<md-td>
	<md-text type="field-name" >dropdown_options</md-text>
	</md-td>
	<md-td>
...
<md-tr>
 ...
 <md-tr>
	<md-td>
	&emsp;&emsp;&emsp;<span style="color: #8F959E">∟</span>&nbsp;<md-text type="field-name" >tag</md-text>
	</md-td>
	<md-td>
	<md-text type="field-type" >string</md-text>
	</md-td>
...
<md-tr>
	<md-td>
	<md-text type="field-name" >dropdown_allow_multiple</md-text>
	</md-td>
	<md-td>
	<md-text type="field-type" >boolean</md-text>
	</md-td>
