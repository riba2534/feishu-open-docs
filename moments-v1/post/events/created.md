---
title: "发布帖子"
fullPath: "/uAjLw4CM/ukTMukTMukTM/moments-v1/post/events/created"
updateTime: "1728531077000"
---

# 发布帖子

公司圈用户发布帖子时触发此事件。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=moments&version=v1&resource=post&event=created)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>moments.post.created_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
