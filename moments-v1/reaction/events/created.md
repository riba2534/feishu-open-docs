---
title: "表情互动"
fullPath: "/uAjLw4CM/ukTMukTMukTM/moments-v1/reaction/events/created"
updateTime: "1728531078000"
---

# 表情互动

公司圈用户表情互动时触发此事件。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=moments&version=v1&resource=reaction&event=created)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>moments.reaction.created_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >帖子</md-enum-item>
<md-enum-item key="2" >评论</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
