---
title: "帖子统计数据变更"
fullPath: "/uAjLw4CM/ukTMukTMukTM/moments-v1/post_statistics/events/updated"
updateTime: "1725018427000"
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>moments.post_statistics.updated_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >statistics_type</md-text>
	</md-dt-td>
	<md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >分享次数</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >post_statistics</md-text>
	</md-dt-td>
	<md-dt-td>
	帖子统计数据
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >share_count</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
