...
根据用户的 id 获取 OKR 列表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=okr&version=v1&resource=user.okr&method=list)
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >period_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
