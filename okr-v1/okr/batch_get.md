---
title: "批量获取 OKR"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/okr-v1/okr/batch_get"
updateTime: "1704766578000"
---

# 批量获取 OKR

根据 OKR id 批量获取 OKR。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=okr&version=v1&resource=okr&method=batch_get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/okr/v1/okrs/batch_get</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="okr:okr:readonly" desc="获取 OKR 信息" support_app_types="custom,isv" tags="">获取 OKR 信息</md-perm>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >okr_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >okr_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >okr_batch\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	OKR 列表
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="0" >此时OKR只返回id</md-enum-item>
<md-enum-item key="1" >返回OKR的其他具体字段</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >objective_list</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >progress_report</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >kr_list</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >kr_weight</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >number(float)</md-text>
	</md-dt-td>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >progress_record_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >progress_record_simplify\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	该KR的进度列表
	</md-dt-td>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >progress_rate_percent_last_updated_time</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >progress_rate_status_last_updated_time</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >progress_record_last_updated_time</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >progress_report_last_updated_time</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >score_last_updated_time</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >mentioned_user_list</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >aligned_objective_list</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >aligning_objective_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >okr_objective_aligned_objective\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >confirm_status</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="0" >初始状态</md-enum-item>
<md-enum-item key="1" >待提交/未提交</md-enum-item>
<md-enum-item key="2" >待处理/待确认</md-enum-item>
<md-enum-item key="3" >已拒绝/已建议</md-enum-item>
<md-enum-item key="4" >已通过/已确认</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
