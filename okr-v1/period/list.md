...
获取 OKR 周期列表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=okr&version=v1&resource=period&method=list)
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >period\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	数据项
	</md-dt-td>
...
<md-enum-item key="1" >暂不处理</md-enum-item>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >period_start_time</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >period_end_time</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
