---
title: "修改 OKR 周期状态"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/okr-v1/period/patch"
updateTime: "1704766577000"
---

# 修改 OKR 周期状态

修改某个 OKR 周期的状态为「正常」、「失效」或「隐藏」，对租户所有人生效，请谨慎操作{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=okr&version=v1&resource=period&method=patch)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/okr/v1/periods/:period_id</md-td>
    </md-tr>
    <md-tr>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >正常状态</md-enum-item>
<md-enum-item key="2" >标记失效</md-enum-item>
<md-enum-item key="3" >隐藏周期</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
