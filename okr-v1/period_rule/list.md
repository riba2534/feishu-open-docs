...
获取租户的周期规则列表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=okr&version=v1&resource=period_rule&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/okr/v1/period_rules</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >period_rules</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >period_rule\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	周期规则列表
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >first_month</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
