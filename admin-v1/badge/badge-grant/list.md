---
title: "获取授予名单列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/admin-v1/badge-grant/list"
updateTime: "1684228045000"
---

# 获取授予名单列表

通过该接口可以获取特定勋章下的授予名单列表，授予名单的排列顺序按照创建时间倒序排列。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=admin&version=v1&resource=badge.grant&method=list)
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >grants</md-text>
	</md-dt-td>
	<md-dt-td>
