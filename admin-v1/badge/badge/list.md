---
title: "获取勋章列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/admin-v1/badge/list"
updateTime: "1684228044000"
---

# 获取勋章列表

可以通过该接口列出租户下所有的勋章，勋章的排列顺序是按照创建时间倒序排列。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=admin&version=v1&resource=badge&method=list)
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >badges</md-text>
	</md-dt-td>
	<md-dt-td>
