---
title: "修改勋章信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/admin-v1/badge/update"
updateTime: "1684228043000"
---

# 修改勋章信息

通过该接口可以修改勋章的信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=admin&version=v1&resource=badge&method=update)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/admin/v1/badges/:badge_id</md-td>
    </md-tr>
    <md-tr>
