...
简历信息解析接口，支持PDF/DOCX/PNG/JPG四种文件类型的一次性的识别。文件大小需要小于30M。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=document_ai&version=v1&resource=resume&method=parse)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/document_ai/v1/resume/parse</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="document_ai:resume:recognize" desc="识别简历" support_app_types="custom,isv" tags="">识别简历</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >resumes</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >resume\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	简历信息
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >file_md5</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >new_content</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >mobile_is_virtual</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >country_code</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >resume_education\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	教育经历
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >qualification</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-enum-item key="3" >中职</md-enum-item>
<md-enum-item key="4" >高中</md-enum-item>
<md-enum-item key="5" >专科</md-enum-item>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >careers</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >resume_career\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	职业经历
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >实习</md-enum-item>
<md-enum-item key="2" >全职</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >type_str</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >job_description</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >projects</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >resume_project\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	项目经历
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >work_year</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-enum-item key="1" >男性</md-enum-item>
<md-enum-item key="2" >女性</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >willing_positions</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >current_location</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >willing_locations</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >home_location</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >resume_language\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	语言
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >awards</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >resume_award\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	获奖
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >award</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >certificates</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >resume_certificate\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	证书
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >competitions</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >resume_competition\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	竞赛
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >urls</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >social_links</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>2110002</md-td>
  <md-td>No resume detected</md-td>
  <md-td>未检测出简历文件，参考文档检查输入文件是否有效</md-td>
</md-tr>
