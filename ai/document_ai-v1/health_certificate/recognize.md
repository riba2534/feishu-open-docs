...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `type` | `string` | 识别的字段种类<br>**可选值有**：<br>- `name`: 姓名 - `issued_by`: 发证机关 - `date_of_handling`: 办证日期 - `date_of_issue`: 发证日期 - `date_of_medical_examination`: 体检日期 - `valid_date`: 有效日期 - `other_date`: 其他日期 |
