---
title: "查询所有考勤组"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/group/list"
updateTime: "1723544573000"
---

# 查询所有考勤组

翻页获取所有考勤组列表。列表中的数据为考勤组信息，字段包含考勤组名称和考勤组id{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=attendance&version=v1&resource=group&method=list)
