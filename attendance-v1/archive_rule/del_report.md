...
按月份、用户和归档规则ID直接删除归档报表行数据{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=attendance&version=v1&resource=archive_rule&method=del_report)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/attendance/v1/archive_rule/del_report</md-td>
    </md-tr>
    <md-tr>
