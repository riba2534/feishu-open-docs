...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `en` | `string` | 英文名称 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `ja` | `string` | 日文名称 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `archive_rule_id` | `string` | 归档报表规则ID，可用于[查询归档报表表头](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/archive_rule/user_stats_fields_query) |
