...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| `leave_id` | `string` | 假期类型ID，可通过[获取假期类型列表](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/leave/leave_types)获取<br>**示例值**："7111688079785723436" |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `accrual_source` | `int` | 发放来源<br>**可选值有**：<br>- `1`: 系统发放 - `2`: 人工发放 - `3`: 外部系统发放 - `4`: 虚拟发放 - `5`: 旧系统导入 - `6`: 加班转入 |
