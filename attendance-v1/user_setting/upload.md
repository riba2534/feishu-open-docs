---
title: "上传用户人脸识别照片"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/file/upload"
updateTime: "1723544610000"
---

# 上传用户人脸识别照片

上传用户人脸照片并获取文件 ID，对应小程序端的人脸录入功能{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=attendance&version=v1&resource=file&method=upload)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/attendance/v1/files/upload</md-td>
    </md-tr>
    <md-tr>
