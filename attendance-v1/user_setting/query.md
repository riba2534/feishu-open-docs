---
title: "批量查询用户人脸识别信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/user_setting/query"
updateTime: "1723544610000"
---
...
](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/file/download){尝试一下}(url=/api/tools/api_explore/api_explore_config?project=attendance&version=v1&resource=user_setting&method=query)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/attendance/v1/user_settings/query</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >user_settings</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >face_key</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
	<md-dt-td>
	人脸照片文件 ID，可用于：[下载用户人脸识别照片](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/file/download)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >face_key_update_time</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
