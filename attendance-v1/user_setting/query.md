...
](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/file/download)
...
| 支持的应用类型 | custom |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 | `attendance:rule:readonly` 导出打卡管理规则 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `face_key` | `string` | 人脸照片文件 ID，可用于：[下载用户人脸识别照片](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/file/download) |
