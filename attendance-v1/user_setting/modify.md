---
title: "修改用户人脸识别信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/user_setting/modify"
updateTime: "1724832276000"
---

# 修改用户人脸识别信息

修改授权内员工的用户设置信息，包括人脸照片文件 ID。修改用户人脸识别信息目前只支持 API 方式修改，管理后台已无法修改。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=attendance&version=v1&resource=user_setting&method=modify)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/attendance/v1/user_settings/modify</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	人脸照片文件 ID，获取方式：[上传用户人脸识别照片](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/file/upload)
