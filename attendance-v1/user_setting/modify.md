...
| &nbsp;&nbsp;└ `face_key` | `string` | 是 | 人脸照片文件 ID，获取方式：[上传用户人脸识别照片](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/file/upload)<br>**示例值**："xxxxxb306842b1c189bc5212eefxxxxx" |
