...
创建一个邮箱联系人{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=mail&version=v1&resource=user_mailbox.mail_contact&method=create)
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >mail_contact</md-text>
	</md-dt-td>
	<md-dt-td>
