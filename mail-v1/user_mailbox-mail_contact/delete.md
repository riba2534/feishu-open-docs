...
| `mail_contact_id` | `string` | 邮箱联系人 id，获取方式见 [列出邮箱联系人](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/user_mailbox-mail_contact/list)<br>**示例值**："123" |
