---
title: "更新邮件模板"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/user_mailbox-template/update"
updateTime: "1778067791000"
---
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `template` | `template` | 是 | 替换后的完整模板内容（全量替换） |
