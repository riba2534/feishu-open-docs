---
title: "批量删除邮件会话"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/user_mailbox-thread/batch_trash"
updateTime: "1776073180000"
---
...
| 项目 | 值 |
| --- | --- |
| HTTP URL | https://open.feishu.cn/open-apis/mail/v1/user_mailboxes/:user_mailbox_id/threads/batch_trash |
| HTTP Method | POST |
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `thread_ids` | `string\[\]` | 否 | 邮箱会话ID，可通过列出邮件会话接口获取<br>**示例值**：["NzR3Zkd5NGhBTS9NVkZnSklidDVGT3VoQmM4PQ=="]<br>**数据校验规则**：<br>- 长度范围：`0` ～ `20` |
...
| HTTP状态码 | 错误码 | 描述 | 排查建议 |
| --- | --- | --- | --- |
| 400 | 1230001 | param is invalid | 参数错误，请检查参数后重试 |
