---
title: "获取邮件卡片的邮件列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/user_mailbox-message/get_by_card"
updateTime: "1745841534000"
---

# 获取邮件卡片的邮件列表

获取邮件卡片下的邮件列表{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=mail&version=v1&resource=user_mailbox.message&method=get_by_card)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/mail/v1/user_mailboxes/:user_mailbox_id/messages/get_by_card</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	邮件卡片ID，可通过[接收消息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/events/receive)事件的推送获取
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	邮件卡片OwnerID，可通过[接收消息]( /ssl:ttdoc/server-docs/im-v1/message/events/receive)事件的推送获取（与`user_id_type`无关）
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >owner_info</md-text>
	</md-dt-td>
	<md-dt-td>
