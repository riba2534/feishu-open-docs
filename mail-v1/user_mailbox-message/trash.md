---
title: "删除邮件"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/user_mailbox-message/trash"
updateTime: "1776073440000"
---
...
| 项目 | 值 |
| --- | --- |
| HTTP URL | https://open.feishu.cn/open-apis/mail/v1/user_mailboxes/:user_mailbox_id/messages/:message_id/trash |
| HTTP Method | POST |
...
| `message_id` | `string` | 邮件ID，可通过列出邮件接口获得<br>**示例值**："NzR3Zkd5NGhBTS9NVkZnSklidDVGT3VoQmM4PQ==" |
