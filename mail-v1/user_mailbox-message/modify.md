---
title: "修改邮件"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/user_mailbox-message/modify"
updateTime: "1776073450000"
---
...
> **Tip**: 不支持移动邮件到已删除文件夹，如需，请使用删除邮件接口。
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| `user_mailbox_id` | `string` | 用户邮箱地址。当使用用户身份访问时，可以输入"me"代表当前调用接口用户<br>**示例值**："abc@abc.com" |
