---
title: "创建草稿"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/user_mailbox-draft/create"
updateTime: "1776073347000"
---
...
| 400 | 1236001 | raw size over limit | 草稿大小超过限制，请减小后重试 |
| 400 | 1236002 | invalid mime format | 草稿MIME格式错误，请检查并修改后重试 |
| 400 | 1236003 | the number of recipients exceeds the limit | 收件人数量超过限制，请减少后重试 |
| 400 | 1236004 | the number of attachments exceeds the limit | 附件数量超过限制，请减少后重试 |
...
| 429 | 1236006 | Concurrent write conflict. Please retry later | 请求被限流，请勿并发访问，请稍后重试 |
...
| 400 | 1236021 | inline image content type does not match an allowed image format; supported: image/jpeg, image/png, image/gif, image/webp", detected | 嵌图片的 Content-Type不在允许范围内，支持的格式包括：image/jpeg、image/png、image/gif、image/webp，请修改后重试 |
