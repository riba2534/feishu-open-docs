...
一次请求可以给一个邮件组添加多个权限成员。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=mail&version=v1&resource=mailgroup.permission_member&method=batch_create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/mail/v1/mailgroups/:mailgroup_id/permission_members/batch_create</md-td>
    </md-tr>
    <md-tr>
