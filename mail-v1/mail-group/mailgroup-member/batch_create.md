...
一次请求可以给一个邮件组添加多个成员。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=mail&version=v1&resource=mailgroup.member&method=batch_create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/mail/v1/mailgroups/:mailgroup_id/members/batch_create</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1234030</md-td>
  <md-td>mailing group member count is over max limit</md-td>
  <md-td>邮件组成员数量已经到达最大数量限制</md-td>
</md-tr>
