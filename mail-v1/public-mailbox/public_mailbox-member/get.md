---
title: "查询指定公共邮箱成员信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/public_mailbox-member/get"
updateTime: "1745841720000"
---

# 查询指定公共邮箱成员信息

获取公共邮箱单个成员信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=mail&version=v1&resource=public_mailbox.member&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/mail/v1/public_mailboxes/:public_mailbox_id/members/:member_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	<md-text type="field-type" >public_mailbox.member</md-text>
	</md-dt-td>
	<md-dt-td>
	\-
	</md-dt-td>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1234040</md-td>
  <md-td>public mailbox member not found</md-td>
  <md-td>请确认公共邮箱成员是否存在</md-td>
</md-tr>
