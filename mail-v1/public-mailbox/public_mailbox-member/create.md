...
向公共邮箱添加单个成员。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=mail&version=v1&resource=public_mailbox.member&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/mail/v1/public_mailboxes/:public_mailbox_id/members</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1234027</md-td>
  <md-td>the user have exceeded the limit on the number of bindable public mailboxes</md-td>
  <md-td>公共邮箱成员数已达上限，请尝试删除后再添加</md-td>
</md-tr>
