...
一次请求可以给一个公共邮箱添加多个成员。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=mail&version=v1&resource=public_mailbox.member&method=batch_create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/mail/v1/public_mailboxes/:public_mailbox_id/members/batch_create</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1234027</md-td>
  <md-td>some users have exceeded the limit on the number of bindable public mailboxes</md-td>
  <md-td>请检查并去除绑定公共邮箱已达数量限制的用户</md-td>
</md-tr>
