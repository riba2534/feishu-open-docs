...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/mail/v1/public_mailboxes</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1234008</md-td>
  <md-td>email or name is invalid</md-td>
  <md-td>邮件地址或名称不合法，请修改后重试</md-td>
</md-tr>
...
<md-tr>
  <md-td>200</md-td>
  <md-td>1234026</md-td>
  <md-td>The number of tenant public mailboxes has reached the limit and cannot be created</md-td>
  <md-td>公共邮箱创建数已达上限，请删除后重试</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1234042</md-td>
  <md-td>req set geo not find in geo list</md-td>
