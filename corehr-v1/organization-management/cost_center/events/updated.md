---
title: "更新成本中心"
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/cost_center/events/updated"
...
:::html
<md-alert type="warn">
[【搜索成本中心信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/cost_center/search)接口数据查询存在一定延迟(2s内)，不建议收到事件后立即查询以上接口。
- 以下字段变更会收到事件：
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>corehr.cost_center.updated_v2</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	成本中心ID。
- 调用[【搜索成本中心信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/cost_center/search)接口返回成本中心详细信息
	</md-dt-td>
</md-dt-tr>
