...
删除成本中心记录{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=cost_center&method=delete)
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1160408</md-td>
  <md-td>Unable to delete</md-td>
  <md-td>所有被引用过的成本中心都不可被删除</md-td>
</md-tr>
