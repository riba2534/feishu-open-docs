...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `org_id` | `string` | 是 | 自定义组织 ID - 可从 [批量查询自定义组织](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/custom_org/query)的 org_id 字段中获取。<br>**示例值**："6862995757234914823" |
