...
- 接口支持对象版本相关字段的查询和返回（默认返回id和version_id）{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=location&method=query_multi_timeline)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/locations/query_multi_timeline</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	返回数据的字段列表，可选["location_name", "code", "active", "parent_location", "description", "effective_date", "expiration_date", "location_usage", "working_hours_type", "locale", "time_zone", "display_language", "address"]
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >location_timeline\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	地点信息
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >location_version_data</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >location_version_data\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	地点版本信息
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >location_version_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >location_names</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >parent_location_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >location_usages</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	区域设置ID 
- 枚举值及详细信息可通过[【获取字段详情】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/get_by_param)接口查询获得。
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	时区 ID 
- 详细信息可通过[【查询时区信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-time_zone/search)接口查询获得。
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	默认语言 ID 
- 详细信息可通过[【查询语言信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-language/search)。
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	工时制度 ID
- 详细信息可通过[【批量查询工时制度】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/working_hours_type/list)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	城市ID。ID获取方式：
- 调用[【查询城市信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-city/search)接口可以返回城市ID
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	区县ID。ID获取方式：
- 调用[【查询区县信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-district/search)接口可以返回区县ID
	</md-dt-td>
</md-dt-tr>
