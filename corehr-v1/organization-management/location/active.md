...
启用/停用地点{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=location&method=active)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/locations/active</md-td>
    </md-tr>
    <md-tr>
