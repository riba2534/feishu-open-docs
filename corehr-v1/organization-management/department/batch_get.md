...
> **Warning**: - 延迟说明：数据库主从延迟 2 秒以内，即：直接创建部门后 2 秒内调用此接口可能查询不到数据。
> - 对比历史版本[批量查询部门](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/department/list)
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `lang` | `string` | 语言信息，中文用zh-CN，英文用en-US |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `value` | `string` | 文本内容 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `custom_fields` | `custom_field_data\[\]` | 自定义字段<br>**字段权限要求**： `corehr:department.custom_fields:read` 获取部门自定义字段 |
