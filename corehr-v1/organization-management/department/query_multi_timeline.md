...
根据部门ID列表，批量查询开始结束时间内的所有部门版本信息，含部门名称、部门类型、上级、编码、负责人、是否启用、描述等信息{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=department&method=query_multi_timeline)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/departments/query_multi_timeline</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	部门 ID 列表，可请求[搜索部门信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/department/search)获取。
...
- effective_date
- expiration_date
- custom_fields(自定义字段需传入具体的"custom_api_name"详细见[获取自定义字段列表](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/query) ,比如:"shifouleixing_7795__c)
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >department_timeline\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	部门信息
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	上级部门 ID 
- 详细信息可通过[【查询单个部门】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/department/get)接口获得
- 若查询的是一级部门，则该字段不展示
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	部门负责人雇佣 ID，枚举值及详细信息可通过[【搜索员工信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/search)接口查询获得
