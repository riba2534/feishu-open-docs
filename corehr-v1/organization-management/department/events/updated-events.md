---
title: "更新部门"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/department/events/updated"
...
:::html
<md-alert type="warn">
- **使用场景**：此事件为无序事件（创建有上下级关系的部门创建之后，上下级部门事件可能乱序），若对事件顺序无依赖则可以使用V1版本事件，否则请使用[【更新部门事件V2】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/department/events/updated)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>corehr.department.updated_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
