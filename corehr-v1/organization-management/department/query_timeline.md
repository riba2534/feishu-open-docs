...
updateTime: "1770621138000"
---

# 查询指定日期的部门基本信息

查询指定生效的部门基本信息，含部门名称、部门类型、上级、编码、负责人、是否启用、描述等信息{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=department&method=query_timeline)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/departments/query_timeline</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  ...
  <md-td>接口超时，详情可联系飞书人事 [Oncall](https://applink.feishu.cn/TLJpeNdW)</md-td>
</md-tr>
