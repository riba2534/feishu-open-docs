---
title: "删除公司"
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/company/events/deleted"
updateTime: "1728545285000"
---

# 【事件】删除公司

飞书人事中「公司被删除」时将触发此事件。
{使用示例}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=company&event=deleted)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>corehr.company.deleted_v2</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
