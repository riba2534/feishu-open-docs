---
title: "更新公司"
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/company/events/updated"
...
:::html
<md-alert type="warn">
- [【批量查询公司】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/company/list)、[【查询单个公司】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/company/get)、[【通过 ID 批量查询公司信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/company/batch_get)数据查询存在一定延迟(2s以内)，不建议收到事件后立即查询以上接口。
- 以下字段变更会收到事件：
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>corehr.company.updated_v2</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	公司ID。
- 调用[【查询单个公司】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/company/get)、[【通过 ID 批量查询公司信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/company/batch_get)接口返回公司详细信息
	</md-dt-td>
</md-dt-tr>
