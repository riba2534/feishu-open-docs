...
通过 ID 批量查询公司信息{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=company&method=batch_get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/companies/batch_get</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	数字代码（ISO 4217），对应币种的指代代码，通过系统内部查找，通过[查询货币信息v2](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-currency/search)查询获取。
	</md-dt-td>
</md-dt-tr>
