...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `employment_ids` | `string\[\]` | 否 | 雇佣 ID 列表，可通过[【搜索员工信息】](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/search)接口获取<br>**示例值**：["7140964208476371111"] |
| `department_ids` | `string\[\]` | 否 | 部门 ID 列表，可通过[【批量查询部门】](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/department/batch_get)接口获取<br>**示例值**：["7140964208476371121"] |
...
| `probation_status` | `string` | 否 | 试用期状态<br>**示例值**："approved"<br>**可选值有**：<br>- `pending`: 审批中 - `rejected`: 已拒绝 - `waiting`: 待发起转正 - `approved`: 审批通过 - `converted`: 已转正 - `offboarded`: 已离职 |
| `final_assessment_result` | `string` | 否 | 试用期最终考核结果<br>**示例值**："approved"<br>**可选值有**：<br>- `approved`: 通过 - `rejected`: 不通过 |
| `final_assessment_grade` | `string` | 否 | 试用期最终考核等级，枚举值 api_name 可通过[【获取字段详情】](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/get_by_param)接口查询，查询参数如下： - object_api_name：probation_management - custom_api_name：final_assessment_grade 字段权限要求： 按照试用期考核等级搜索 (corehr:probation.grade.search:read)<br>**示例值**："grade_a" |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `employment_id` | `string` | 雇佣 ID，可通过[【搜索员工信息】](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/search)接口获取 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `submission_type` | `enum` | 发起方 - hr_submission：HR 发起 - self_submission：员工发起 - system ：系统发起 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `enum_name` | `string` | 枚举值 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `display` | `i18n\[\]` | 枚举多语展示 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `lang` | `string` | 语言编码（IETF BCP 47） |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `value` | `string` | 文本内容 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `initiator_id` | `string` | 转正发起人的雇佣 ID，当系统发起转正时该字段为空，可通过[【搜索员工信息】](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/search)接口获取 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `probation_status` | `enum` | 试用期状态： - pending：审批中 - rejected：已拒绝 - waiting：待发起转正 - approved：审批通过 - converted：已转正 - offboarded：已离职 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `enum_name` | `string` | 枚举值 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `display` | `i18n\[\]` | 枚举多语展示 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `lang` | `string` | 语言编码（IETF BCP 47） |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `value` | `string` | 文本内容 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `final_assessment_status` | `enum` | 试用期考核最终状态： - not_started：未开始 - in_process：进行中 - completed：已完成 - no_need：无需考核 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `enum_name` | `string` | 枚举值 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `display` | `i18n\[\]` | 枚举多语展示 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `lang` | `string` | 语言编码（IETF BCP 47） |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `value` | `string` | 文本内容 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `final_assessment_result` | `enum` | 试用期考核最终结果： - approved：通过 - rejected：不通过 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `enum_name` | `string` | 枚举值 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `display` | `i18n\[\]` | 枚举多语展示 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `lang` | `string` | 语言编码（IETF BCP 47） |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `value` | `string` | 文本内容 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `final_assessment_grade` | `enum` | 试用期考核最终等级，枚举值 api_name 可通过[【获取字段详情】](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/get_by_param)接口查询，查询参数如下： - object_api_name = "probation_management" - custom_api_name = "final_assessment_grade"<br>**字段权限要求（满足任一）**： `corehr:probation.assessment:read` 获取试用期考核信息 `corehr:probation.assessment:write` 读写试用期考核信息 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `enum_name` | `string` | 枚举值 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `display` | `i18n\[\]` | 枚举多语展示 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `lang` | `string` | 语言编码（IETF BCP 47） |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `value` | `string` | 文本内容 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `assessments` | `assessment\[\]` | 试用期考核结果列表<br>**字段权限要求（满足任一）**： `corehr:probation.assessment:read` 获取试用期考核信息 `corehr:probation.assessment:write` 读写试用期考核信息 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `assessment_id` | `string` | 考核结果 ID |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `assessment_status` | `enum` | 考核状态 - not_started：未开始 - in_process：进行中 - completed：已完成 - no_need：无需考核 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `enum_name` | `string` | 枚举值 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `display` | `i18n\[\]` | 枚举多语展示 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `lang` | `string` | 语言编码（IETF BCP 47） |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `value` | `string` | 文本内容 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `assessment_result` | `enum` | 试用期考核结果 - approved：通过 - rejected：不通过 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `enum_name` | `string` | 枚举值 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `display` | `i18n\[\]` | 枚举多语展示 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `lang` | `string` | 语言编码（IETF BCP 47） |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `value` | `string` | 文本内容 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `assessment_score` | `number(float)` | 考核得分 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `assessment_grade` | `enum` | 试用期考核等级，枚举值 api_name 可通过[【获取字段详情】](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/get_by_param)接口查询，查询参数如下： - object_api_name = "probation_management" - custom_api_name = "final_assessment_grade" |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `enum_name` | `string` | 枚举值 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `display` | `i18n\[\]` | 枚举多语展示 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `lang` | `string` | 语言编码（IETF BCP 47） |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `value` | `string` | 文本内容 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `probation_extend_expected_end_date` | `string` | 试用期延长后的预计结束日期<br>**字段权限要求（满足任一）**： `corehr:probation.probation_outcome:read` 获取试用期结果字段 `corehr:probation.probation_outcome:write` 写试用期结果字段 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `extended_probation_period_duration` | `int` | 试用期延长时间<br>**字段权限要求（满足任一）**： `corehr:probation.probation_outcome:read` 获取试用期结果字段 `corehr:probation.probation_outcome:write` 写试用期结果字段 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `extended_probation_period_unit` | `enum` | 试用期延长时间单位<br>**字段权限要求（满足任一）**： `corehr:probation.probation_outcome:read` 获取试用期结果字段 `corehr:probation.probation_outcome:write` 写试用期结果字段 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `enum_name` | `string` | 枚举值 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `display` | `i18n\[\]` | 枚举多语展示 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `lang` | `string` | 语言编码（IETF BCP 47） |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `value` | `string` | 文本内容 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `probation_outcome` | `enum` | 试用期结果<br>**字段权限要求（满足任一）**： `corehr:probation.probation_outcome:read` 获取试用期结果字段 `corehr:probation.probation_outcome:write` 写试用期结果字段 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `enum_name` | `string` | 枚举值 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `display` | `i18n\[\]` | 枚举多语展示 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `lang` | `string` | 语言编码（IETF BCP 47） |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `value` | `string` | 文本内容 |
