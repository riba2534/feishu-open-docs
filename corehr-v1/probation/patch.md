...
更新试用期的考核结果{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=probation.assessment&method=patch)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/probation/assessments/:assessment_id</md-td>
    </md-tr>
    <md-tr>
