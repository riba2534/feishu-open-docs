...
新增员工试用期考核结果{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=probation.assessment&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/probation/assessments</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	<md-text type="field-type" >assessment_for_create\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	是
	</md-dt-td>
...
<md-enum-item key="in_process" >进行中</md-enum-item>
<md-enum-item key="completed" >已完成</md-enum-item>
<md-enum-item key="no_need" >无需考核</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >assessment_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
