...
启用/停用试用期考核功能，启用后系统功能中针对试用期考核相关的字段会自动启用，并可通过接口更新试用期考核结果{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=probation&method=enable_disable_assessment)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/probation/enable_disable_assessment</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >app_url</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1161025</md-td>
  <md-td>Do not repeatedly turn on/off the function</md-td>
  <md-td>请勿重复开启/关闭功能</md-td>
</md-tr>
