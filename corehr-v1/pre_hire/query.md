...
- 性能说明：本接口返回数据量较多，查询时请控制每批次数量（<10）和适当减少查询字段数(<50){尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=pre_hire&method=query)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/pre_hires/query</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="corehr:pre_hire:read_only" desc="查询待入职信息" support_app_types="custom,isv" tags="">查询待入职信息</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-dt-tr level="0">
	...
	返回数据的字段列表，填写方式：
- 为空时只返回 pre_hire_id
- 不为空时按照传入的字段返回数据，数据结构可以参考response的数据结构，格式示例如下：
    - person_info（个人信息） 字段：person_info.gender，person_info.age
    - employment_info（雇佣信息） 字段：employment_info.department
    - onboarding_info（入职信息） 字段：onboarding_info.onboarding_date
    - probation_info（试用期信息） 字段：probation_info.probation_period
    - contract_info（合同信息） 字段：contract_info.contract_type
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	民族，枚举值可通过文档[枚举常量介绍](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/feishu-people-enum-constant)民族（race）枚举定义获得
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	婚姻状况，枚举值可通过文档[枚举常量介绍](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/feishu-people-enum-constant)婚姻状况（marital_status）枚举定义获得
...
<md-dt-tr level="4">
	...
	<md-dt-td>
	主要行政区ID 可以通过[查询省份/行政区信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-country_region_subdivision/search)接口获取详情
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="4">
	...
	<md-dt-td>
	户口类型，枚举值可通过文档[枚举常量介绍](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/feishu-people-enum-constant)户口类型（hukou_type）枚举定义获得
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	出生国家/地区，可以通过接口[查询国家/地区信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-country_region/search)获取详情
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	部门 ID ，可以通过[搜索部门信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/department/search)接口获取详情
