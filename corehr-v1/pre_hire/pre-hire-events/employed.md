...
以下业务场景会触发此事件：
- 开放平台[操作员工完成入职](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/pre_hire/complete)接口
- 开放平台[添加人员](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/create)接口
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>corehr.job_data.employed_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	任职记录 ID，详细信息可通过[【获取任职记录】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/job_data/get)接口查询
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	雇佣记录 ID，详细信息可通过[【查询员工信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/batch_get)接口查询
	</md-dt-td>
</md-dt-tr>
