---
title: "获取异动原因列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/transfer_reason/query"
updateTime: "1709799353000"
---

# 获取异动原因列表

获取异动原因列表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=transfer_reason&method=query)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v1/transfer_reasons/query</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            ...
            <md-perm name="corehr:transfer_reason:read" desc="获取异动原因信息" support_app_types="custom,isv" tags="">获取异动原因信息</md-perm>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >transfer_reason\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	异动原因列表
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >parent_transfer_reason_unique_identifier</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-tr>
  ...
  <md-td>相同 Request ID 的请求只有第一条会成功，多次请求请更换Request ID</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>检查自定义字段格式是否符合元数据定义</md-td>
</md-tr>
