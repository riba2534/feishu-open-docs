...
该接口用于发起员工异动（变更员工雇佣信息），若发起成功，会生成一条员工的异动数据{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=job_change&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/job_changes</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="corehr:job_change:create" desc="写员工异动信息" support_app_types="custom" tags="">写员工异动信息</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
可通过接口[获取异动类型列表](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/transfer_type/query)获取
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	<md-text type="field-type" >create_transfer_info</md-text>
	</md-dt-td>
	<md-dt-td>
	是
	</md-dt-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	是否撤销虚线上级，当值为true时，target_dotted_manager值为空。
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	是否有试用期，当值为true时，target_probation_end_date值不应为空。
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >target_cost_center_rates</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1160100</md-td>
  <md-td>The job status change type can't be empty</md-td>
  <md-td>请确保传入了正确的异动类型唯一标识（transfer_type_unique_identifier），并检查该字段是否为空。可通过接口[获取异动类型列表](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/transfer_type/query)获取。</md-td>
</md-tr>
...
具体错误码以及错误文案请参考[发起异动错误校验](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/job_change/job_change_error_msg)
