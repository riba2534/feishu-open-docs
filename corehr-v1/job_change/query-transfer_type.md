...
获取异动类型列表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=transfer_type&method=query)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v1/transfer_types/query</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            ...
            <md-perm name="corehr:transfer_type:readonly" desc="获取异动类型信息" support_app_types="custom" tags="">获取异动类型信息</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >transfer_type\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	异动类型列表
	</md-dt-td>
