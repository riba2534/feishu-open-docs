...
:::html
<md-alert type="warn">
为了保证系统稳定可靠，事件消费需要做好错误处理&幂等消费，建议参考文档 [事件概述](/ssl:ttdoc/ukTMukTMukTM/uUTNz4SN1MjL1UzM#521f7631)
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>corehr.job_change.status_updated_v2</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
    ...
    <md-th>
      ...
      <md-td>
            <md-perm name="corehr:job_change.status_update_event:read" desc="获取员工异动状态变更信息" support_app_types="custom,isv" tags="">获取员工异动状态变更信息</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
