...
:::html
<md-alert type="error">
本事件不再推荐使用，请使用新版本[异动状态变更事件](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/job_change/events/status_updated)
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>corehr.job_change.updated_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
    ...
    <md-th>
      ...
      <md-td>
            ...
            <md-perm name="corehr:job_change.update_event:read" desc="获取员工异动状态变更信息" support_app_types="custom,isv" tags="">获取员工异动状态变更信息</md-perm>
            ...
            <md-perm name="corehr:job_data:readonly" desc="获取任职信息" support_app_types="custom" tags="">获取任职信息</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	雇员ID，可通过[【搜索员工信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/search)接口获取
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	用户 ID，飞书相关ID，
可通过[【通讯录接口】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/user/field-overview)接口获取
	</md-dt-td>
</md-dt-tr>
