...
更新员工的个人信息，包括姓名、个人电话、邮箱、联系地址、政治面貌、户口信息等{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=person&method=patch)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/persons/:person_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >no_need_query</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	尊称，可通过 [【获取字段详情】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/get_by_param)获取，按如下参数查询即可：
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	头衔，可通过 [【获取字段详情】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/get_by_param)获取，按如下参数查询即可：
- custom_api_name：social
- object_api_name：person_name
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	民族 / 种族，可通过[【获取字段详情】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/get_by_param)获取，按如下参数查询即可： 
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	婚姻状况，可通过[【获取字段详情】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/get_by_param)接口获取，按如下参数查询即可： 
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	地址 ID，在[【创建个人信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/person/create)时返回的的地址ID；不可与其他地址使用相同 ID；为空时会返回新的ID
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	国家地区ID，可通过[【查询国家/地区信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-country_region/search)获取
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	国籍 ID，可通过[【查询国籍信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-nationality/search)获取
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	地址 ID，在[【创建个人信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/person/create)时返回的的地址ID；不可与其他地址使用相同 ID；为空时返回新的ID
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	文件ID，可通过[【上传文件】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/person/upload)获取
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	居民身份，可通过 [【获取字段详情】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/get_by_param)接口查询，查询参数如下：
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	婚姻状况，可通过[【获取字段详情】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/get_by_param)获取，按如下参数查询即可： 
- custom_api_name：marital_status 
- object_api_name：person
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	学校名称
- 枚举值可通过[【获取字段详情】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/get_by_param)获取，查询参数：
  - custom_api_name：school_name
  - object_api_name：education
- 如果学校有对应枚举，请使用该字段，否则可使用 school 直接写入文本 
	</md-dt-td>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	国家地区 ID，可通过[【查询国家/地区信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-country_region/search)接口获得
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	货币 ID，可通过[【查询货币信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-currency/search)接口查询获得
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	国家证件类型，可通过[【批量查询国家证件类型】](../../basic-infomation/national_id_type/list.md)接口获取
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	国家地区 ID，可通过[【查询国家/地区信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-country_region/search)接口查询获得
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	人才 ID，可通过[【获取人才信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-country_region_subdivision/search)查询详细信息
	</md-dt-td>
</md-dt-tr>
