---
title: "【事件】更新个人信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/person/events/updated"
updateTime: "1725365583000"
---

# 【事件】更新个人信息

员工个人信息发生变更时发送该事件，场景举例：
- 调用[【更新个人信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/person/patch)接口
...
<md-alert type="tip">
- 目前事件不保证有序
- 该事件在个人信息数据有变更时就会发送，故频次可能较高。推荐使用[【人员信息变更事件】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/events/domain_event)
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>corehr.person.updated_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
    ...
    <md-th>
      ...
      <md-td>
            ...
            <md-perm name="corehr:employee:read" desc="获取员工信息" support_app_types="custom,isv" tags="">获取员工信息</md-perm>
            <md-perm name="corehr:person:read" desc="查看员工个人信息" support_app_types="custom,isv" tags="">查看员工个人信息</md-perm>
