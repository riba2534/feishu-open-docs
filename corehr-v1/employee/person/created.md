...
目前以下场景会触发该事件：
- 调用[【创建个人信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/person/create)、[【添加人员】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/create)接口
...
<md-alert type="tip">
- 目前事件不保证有序
- 创建个人信息后，可能同时触发计算字段的变更，所以也会发送[【更新个人信息事件】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/person/events/updated)
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>corehr.person.created_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
