---
title: "删除人员自定义组织变更记录"
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee-custom_org/del"
updateTime: "1774839470000"
---
...
| 项目 | 值 |
| --- | --- |
| HTTP URL | https://open.feishu.cn/open-apis/corehr/v2/custom_org/del |
| HTTP Method | POST |
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `user_id` | `string` | 是 | 用户ID<br>**示例值**："7358801371828602412" |
