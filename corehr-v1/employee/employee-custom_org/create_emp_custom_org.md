---
title: "新增人员自定义组织变更记录"
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee-custom_org/create_emp_custom_org"
updateTime: "1774839428000"
---
...
| 项目 | 值 |
| --- | --- |
| HTTP URL | https://open.feishu.cn/open-apis/corehr/v2/custom_org/create_emp_custom_org |
| HTTP Method | POST |
...
| `custom_org_with_rates` | `custom_org_with_rate\[\]` | 是 | 自定义组织列表<br>**数据校验规则**：<br>- 长度范围：`1` ～ `100` |
| &nbsp;&nbsp;└ `id` | `string` | 是 | 自定义组织id<br>**示例值**："7382048365313261588" |
| &nbsp;&nbsp;└ `rate` | `string` | 否 | 比例<br>**示例值**："50.01" |
| `start_reason` | `string` | 否 | 变更原因<br>**示例值**："开放平台变更"<br>**数据校验规则**：<br>- 最大长度：`1000` 字符 |
| `effective_time` | `string` | 是 | 生效时间<br>**示例值**："2024-06-01" |
...
| `msg` | `string` | 错误描述 |
| `data` | `\-` | \- |
| &nbsp;&nbsp;└ `job_data_custom_org_id` | `string` | 自定义组织ID |
