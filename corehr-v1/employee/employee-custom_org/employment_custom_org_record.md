---
title: "批量查询人员自定义组织变更记录"
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee-custom_org/employment_custom_org_record"
updateTime: "1774839460000"
---
...
| 项目 | 值 |
| --- | --- |
| HTTP URL | https://open.feishu.cn/open-apis/corehr/v2/custom_org/employment_custom_org_record |
| HTTP Method | GET |
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `user_ids` | `string\[\]` | 是 | 用户ID<br>**示例值**：7356072152375772716 |
...
| `object_api_names` | `string\[\]` | 是 | 组织类型编码，可在「飞书人事-设置-组织设置」中相应的自定义组织目录下查看<br>**示例值**：custom_org_01 |
...
| `msg` | `string` | 错误描述 |
| `data` | `\-` | \- |
| &nbsp;&nbsp;└ `custom_org_list` | `emp_custom_org_list\[\]` | 自定义组织列表 |
...
| HTTP状态码 | 错误码 | 描述 | 排查建议 |
| --- | --- | --- | --- |
| 400 | 1160400 | param is invalid | 请联系[技术支持](https://applink.feishu.cn/TLJpeNdW) |
| 403 | 1160403 | no permission | 请检查是否有权限 |
