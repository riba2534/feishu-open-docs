...
获取任职信息列表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=employees.job_data&method=query)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/employees/job_datas/query</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="4">
	...
	<md-dt-td>
	任职信息 ID，可通过[【查询单个任职信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/job_data/get)获取详细信息
	</md-dt-td>
</md-dt-tr>
