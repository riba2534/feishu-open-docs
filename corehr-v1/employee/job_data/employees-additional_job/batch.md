...
支持全量遍历和筛选查询。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=employees.additional_job&method=batch)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/employees/additional_jobs/batch</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="corehr:additional_job:read" desc="获取兼职信息" support_app_types="custom" tags="">获取兼职信息</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
      ...
      <md-td>
        ...
        <md-perm name="corehr:additional_job.compensation_type:read" desc="获取兼职的薪资类型" support_app_types="custom" tags="">获取兼职的薪资类型</md-perm>
        ...
        <md-perm name="corehr:additional_job.job:read" desc="获取兼职的职务信息" support_app_types="custom" tags="">获取兼职的职务信息</md-perm>
        <md-perm name="corehr:additional_job.job:write" desc="读写兼职的职务信息" support_app_types="custom" tags="">读写兼职的职务信息</md-perm>
        <md-perm name="corehr:additional_job.job_level:read" desc="获取兼职的职级信息" support_app_types="custom" tags="">获取兼职的职级信息</md-perm>
        <md-perm name="corehr:additional_job.job_level:write" desc="读写兼职的职级信息" support_app_types="custom" tags="">读写兼职的职级信息</md-perm>
        <md-perm name="corehr:additional_job.position:read" desc="读取兼职的岗位" support_app_types="custom" tags="">读取兼职的岗位</md-perm>
        <md-perm name="corehr:additional_job.position:write" desc="读写兼职的岗位" support_app_types="custom" tags="">读写兼职的岗位</md-perm>
        <md-perm name="corehr:additional_job.service_company:read" desc="获取兼职的任职公司" support_app_types="custom" tags="">获取兼职的任职公司</md-perm>
        <md-perm name="corehr:additional_job.service_company:write" desc="读写兼职的任职公司" support_app_types="custom" tags="">读写兼职的任职公司</md-perm>
        <md-perm name="corehr:additional_job.work_shift:read" desc="获取兼职的排班信息" support_app_types="custom" tags="">获取兼职的排班信息</md-perm>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >additional_job_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	<md-text type="field-type" >employees.additional_job_batch_req_date</md-text>
	</md-dt-td>
	<md-dt-td>
	否
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >is_effective</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >employees.additional_job\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	兼职信息
	</md-dt-td>
