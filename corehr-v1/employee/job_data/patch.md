...
默认为新增一条任职记录，包括职务、职级、序列、部门等信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=job_data&method=patch)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v1/job_datas/:job_data_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >strict_verify</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	业务类型（原：任职原因）
- 枚举值[【获取字段详情】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/get_by_param)
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	部门 ID，详细信息可通过[【批量查询部门】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/department/batch_get)接口查询获得
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	任职公司，可通过[【查询单个公司】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/company/get)
查询详细信息
...
<md-tr>
  <md-td>500</md-td>
  <md-td>1160813</md-td>
  <md-td>duplicate entry record</md-td>
  <md-td>重复录入记录</md-td>
</md-tr>
