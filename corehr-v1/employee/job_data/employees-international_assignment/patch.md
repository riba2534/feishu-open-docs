---
title: "更新外派信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/employees-international_assignment/patch"
updateTime: "1749438633000"
---

# 更新外派信息

更新指定的外派信息{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=employees.international_assignment&method=patch)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/employees/international_assignments/:international_assignment_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >international_assignment_id</md-text>
	</md-dt-td>
	<md-dt-td>
	...
	<md-dt-td>
	外派ID
- 可通过[批量查询外派](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employees-international_assignment/list)获取
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	外派工作地点 ID
  - 可通过[【批量查询地点】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/location/list)获取，并选择【地点用途】为外派地点（international_assignment）的记录
  - 该字段可不传，但不可传空值
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	人员类型ID
- 可通过[【批量查询人员类型】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/employee_type/list)获取
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	工作日历 ID
- 可通过[【查询工作日历】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/leave/work_calendar)获取
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >employees.international_assignment_resp</md-text>
	</md-dt-td>
	<md-dt-td>
	外派信息
	</md-dt-td>
...
<md-tr>
  ...
  <md-td>1160001</md-td>
  <md-td>参数错误</md-td>
  <md-td>请检查参数，必要情况请参照【飞书人事-档案配置】</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>1160002</md-td>
  <md-td>未知错误</md-td>
  <md-td>请重试或联系[技术支持](https://applink.feishu.cn/TLJpeNdW)</md-td>
</md-tr>
