...
| &nbsp;&nbsp;└ `cost_center_id` | `string` | 否 | 成本中心ID -可以调用[【搜索成本中心信息】](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/cost_center/search)接口，获取成本中心信息中的成本中心ID。<br>**示例值**："7039123253031711012" |
