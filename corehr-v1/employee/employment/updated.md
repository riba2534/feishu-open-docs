---
title: "【事件】更新雇佣信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/employment/events/updated"
...
员工雇佣信息变更时发送该事件，场景举例：
- 调用[【更新雇佣信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/employment/patch)接口
...
<md-alert type="tip">
- 目前事件不保证有序
- 该事件在雇佣信息数据有变更时就会发送，故频次可能较高。推荐使用[【人员信息变更事件】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/events/domain_event)
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>corehr.employment.updated_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
