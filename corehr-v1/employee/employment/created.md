---
title: "【事件】创建雇佣信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/employment/events/created"
updateTime: "1725006770000"
---

# 【事件】创建雇佣信息

员工雇佣信息被创建时发送该事件，场景举例：
- 调用[【创建雇佣信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/employment/create)、[【添加人员】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/create)接口
...
<md-alert type="tip">
- 目前事件不保证有序
- 创建雇佣信息后，可能同时触发计算字段的变更，所以也会发送[【更新雇佣信息事件】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/employment/events/updated)
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>corehr.employment.created_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
    ...
    <md-th>
      ...
      <md-td>
            ...
            <md-perm name="corehr:employment:read" desc="获取雇佣信息" support_app_types="custom,isv" tags="">获取雇佣信息</md-perm>
