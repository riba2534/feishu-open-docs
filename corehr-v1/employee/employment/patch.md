...
更新人事工作信息下的字段，如：工号、工作邮箱、雇佣类型、自定义字段等{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=employment&method=patch)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v1/employments/:employment_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	个人信息 ID，由[【创建个人信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/person/create)时生成
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >employment</md-text>
	</md-dt-td>
	<md-dt-td>
	雇佣信息
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	雇员ID；可通过[【批量查询员工信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/batch_get)获取更多信息；类型与 user_id_type 一致
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	成本中心 ID，可以通过[【搜索成本中心信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/cost_center/search)获取详细信息
	</md-dt-td>
</md-dt-tr>
...
<md-tr>
  <md-td>500</md-td>
  <md-td>1160025</md-td>
  <md-td>didn't find employment with ID</md-td>
