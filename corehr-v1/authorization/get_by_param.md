...
查询[飞书人事管理后台](https://people.feishu.cn/people/)里 -「设置」-「权限设置」中的单个用户授权信息。授权信息中包括员工ID、被授权的角色等信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=authorization&method=get_by_param)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v1/authorizations/get_by_param</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >role_authorization</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-tr>
  ...
  <md-td>参数缺失或无效，请检查参数是否缺失或格式是否符合要求</md-td>
</md-tr>
