...
更新角色被授权的管理范围  
更新后的数据范围，以本次提交的数据范围为准，本次未提交的部分将被移除。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=authorization&method=update_role_assign)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v1/authorizations/update_role_assign</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >assigned_organization_items</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >assigned_organization_with_code\[\]\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	是
	</md-dt-td>
