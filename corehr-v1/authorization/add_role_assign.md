...
为用户授权角色及管理范围  
对已被授权某个角色的用户继续授权，将在原授权的数据范围基础上追加数据范围。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=authorization&method=add_role_assign)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v1/authorizations/add_role_assign</md-td>
    </md-tr>
    <md-tr>
