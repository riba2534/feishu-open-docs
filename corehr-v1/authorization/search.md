---
title: "获取组织类角色授权列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/assigned_user/search"
updateTime: "1734434037000"
---

# 获取组织类角色授权列表

查询组织类角色的授权信息，返回的授权列表中包含被授权的用户ID和被授权的管理维度等信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=assigned_user&method=search)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v1/assigned_users/search</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >search_method</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
