...
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/employees-bp/batch_get"
updateTime: "1734434058000"
---
...
> **Tip**: 该接口会按照应用拥有的「员工资源」的权限范围返回数据，请确定在「开发者后台 - 权限管理 - 数据权限 - 飞书人事（企业版）数据权限范围」中已申请「员工资源」权限范围
