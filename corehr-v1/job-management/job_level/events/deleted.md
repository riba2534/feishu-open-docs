---
title: "删除职级"
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/job_level/events/deleted"
...
飞书人事中「职级被删除」时将触发此事件。
{使用示例}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=job_level&event=deleted)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>corehr.job_level.deleted_v2</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
