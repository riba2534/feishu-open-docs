...
适用场景：
- 适用于HR系统中新增职级的场景{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=job_level&method=create)
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	职级数值，单位：级。该字段主要用来在职级大小排序，职级的数值越大，代表职级越高
	</md-dt-td>
</md-dt-tr>
