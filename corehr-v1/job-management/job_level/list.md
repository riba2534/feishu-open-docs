---
title: "批量查询职级"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/job_level/list"
updateTime: "1775126178000"
---
...
> **Tip**: 使用建议：职级数量过多时，可以通过多次循环调用该接口获取所有职级详情信息
...
| `page_size` | `string` | 是 | 分页大小，最小支持传1，最大支持传100 - 最小长度为 1 字符，最大长度为100字符<br>**示例值**：100 |
