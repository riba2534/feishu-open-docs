...
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/job_grade/query_recent_change"
updateTime: "1736492468000"
---

# 查询当前生效信息发生变更的职等

查询指定时间范围内当前生效信息发生变更的职等，即只有职等当前生效版本的生效时间在查询时间范围内，才返回该地点id{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=job_grade&method=query_recent_change)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/job_grades/query_recent_change</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="corehr:job_grade:read" desc="查看职等信息" support_app_types="custom,isv" tags="">查看职等信息</md-perm>
            <md-perm name="corehr:job_grade:write" desc="查看、创建、更新、删除职等信息" support_app_types="custom,isv" tags="">查看、创建、更新、删除职等信息</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
- 非删除的数据，可通过[【批量查询职等信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/job_grade/query)获取详情
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >deleted_job_grade_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
