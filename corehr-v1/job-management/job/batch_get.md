---
title: "根据条件批量获取职务"
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/job/batch_get"
updateTime: "1760008898000"
---

# 根据条件批量获取职务

根据传入的职务ID或职务Code批量获取当前生效版本职务信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=job&method=batch_get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/jobs/batch_get</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="corehr:job.only:read" desc="获取职务信息（仅职务）" support_app_types="custom,isv" tags="">获取职务信息（仅职务）</md-perm>
            <md-perm name="corehr:job:read" desc="获取职务信息" support_app_types="custom,isv" tags="">获取职务信息</md-perm>
            <md-perm name="corehr:job:write" desc="读写职务信息" support_app_types="custom" tags="">读写职务信息</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >job_codes</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	需要查询的字段列表，默认返回id。可选以下预置字段及自定义字段：
可选值有：
- "job_name"：名称
- "code"：编码
- "active"：启用状态
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	自定义字段，格式参考：[【自定义字段说明】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom-fields-guide)岗位、职务、自定义组织模块
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	创建人，详细信息可通过[【搜索员工信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/search) 或 [【批量查询员工】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/batch_get)接口获取
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	更新人，详细信息可通过[【搜索员工信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/search) 或 [【批量查询员工】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/batch_get)接口获取
	</md-dt-td>
</md-dt-tr>
...
<md-tr>
  <md-td>503</md-td>
  <md-td>1161204</md-td>
  <md-td>Interface timeout</md-td>
  <md-td>接口超时，可尝试重试。如果无法解决可以联系飞书人事 [Oncall](https://applink.feishu.cn/TLJpeNdW)</md-td>
</md-tr>
...
<md-tr>
  <md-td>429</md-td>
  <md-td>1161604</md-td>
  <md-td>Interface rate limited</md-td>
