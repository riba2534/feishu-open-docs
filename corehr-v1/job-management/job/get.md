...
根据 ID 查询单个职务的详细信息，如职务名称、描述等{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=job&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/jobs/:job_id</md-td>
    </md-tr>
    <md-tr>
...
- 也可以通过[【事件】创建职务](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/job/events/created) [【事件】更新职务](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/department/events/updated) 获取ID
