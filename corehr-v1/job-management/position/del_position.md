...
删除整条岗位记录{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=position&method=del_position)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/positions/del_position</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1160265</md-td>
  <md-td>Unable to delete position as it's still in use</md-td>
  <md-td>请确认该岗位是否仍在使用，若在使用请先停用后再尝试删除</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>请检查传入的岗位 ID（position_id）是否正确，或确认该记录是否已被删除</md-td>
</md-tr>
