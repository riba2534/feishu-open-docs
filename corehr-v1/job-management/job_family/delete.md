...
该接口支持通过序列ID删除单个序列信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=job_family&method=delete)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v1/job_families/:job_family_id</md-td>
    </md-tr>
    <md-tr>
