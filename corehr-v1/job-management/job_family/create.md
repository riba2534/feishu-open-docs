...
{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=job_family&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v1/job_families</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	是否可被使用，true为可被使用，false为不可被使用。默认值为true，代表可被使用
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	通道ID，详情可以参考[【获取通道信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/pathway/batch_get)。默认值为空数组，表示不关联任何通道
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	编码 (不能与其他记录的编码重复)，当开启自动编码时，该字段会失效
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	自定义字段（序列暂时不支持自定义字段），格式参考：[【自定义字段说明】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom-fields-guide)岗位、职务、自定义组织模块。默认值为空数组，表示没有自定义字段
	</md-dt-td>
</md-dt-tr>
