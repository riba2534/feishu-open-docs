...
对通道进行 启用 或 停用 操作{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=pathway&method=active)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/pathways/active</md-td>
    </md-tr>
    <md-tr>
