...
创建通道，可以定义通道的名称、编码和描述信息{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=pathway&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/pathways</md-td>
    </md-tr>
    <md-tr>
