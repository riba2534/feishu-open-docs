...
根据通道的ID批量获取通道的名称、编码、描述信息{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=pathway&method=batch_get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/pathways/batch_get</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >pathway\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	查询的通道信息
	</md-dt-td>
