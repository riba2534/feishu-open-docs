...
批量创建/更新明细行后，可在【设置-编制规划设置-编制规划XXX-编辑数据】进行查看。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=workforce_plan_detail_row&method=batchSave)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/workforce_plan_detail_row/batchSave</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="corehr:workforce_detail:write" desc="写入编制规划明细信息" support_app_types="custom,isv" tags="">写入编制规划明细信息</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	预估在职人数相关信息。可从「设置-编制规划设置-编辑编制规划XXX」查看预估在职人数的时间，如果不存在该字段说明用户创建时即没有允许填写该字段，批量创建/更新明细行时则无需给该字段，如果存在，用户需要查看预估在职人数的日期，使用示例值格式进行传参。
...
<md-tr>
  ...
  <md-td>请先参考全量错误码详细描述进行错误排查，如问题始终无法解决请联系[技术支持](https://applink.feishu.cn/TLJpeNdW)
</md-td>
</md-tr>
