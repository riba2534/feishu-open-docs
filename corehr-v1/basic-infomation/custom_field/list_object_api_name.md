---
title: "获取飞书人事对象列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/list_object_api_name"
updateTime: "1719656375000"
---

# 获取飞书人事对象列表

获取「飞书人事」中的对象列表，含系统预置对象与自定义对象。使用方式可参考[【操作手册】如何通过 OpenAPI 维护自定义字段](https://feishu.feishu.cn/docx/QlUudBfCtosWMbxx3vxcOFDknn7){尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=custom_field&method=list_object_api_name)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v1/custom_fields/list_object_api_name</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1160009</md-td>
  <md-td>page token format error</md-td>
  <md-td>输入参数 page_token 的格式有误，请检查</md-td>
</md-tr>
