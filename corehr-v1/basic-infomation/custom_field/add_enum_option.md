---
title: "增加字段枚举值选项"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/common_data-meta_data/add_enum_option"
updateTime: "1726138256000"
---

# 增加字段枚举值选项

对于当前已有的所有自定义枚举字段，以及部分系统预置枚举字段，通过本接口可在字段中批量新增可选项{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=common_data.meta_data&method=add_enum_option)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v1/common_data/meta_data/add_enum_option</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  ...
  <md-td>入参中的 client_token 重复，请检查是否有异常并发重试</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1162041</md-td>
  <md-td>invalid enum option api name</md-td>
  <md-td>枚举选项的 API name 不合法，请确认 API name 长度不超过 63 个字符，以英文字母开头，且仅包含小写英文字母、数字和下划线</md-td>
</md-tr>
