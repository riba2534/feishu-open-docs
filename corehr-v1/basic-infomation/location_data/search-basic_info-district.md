---
title: "查询区/县信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-district/search"
updateTime: "1719656516000"
---

# 查询区 / 县信息

根据区/县 ID、上级城市 ID，查询区/县信息{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=basic_info.district&method=search)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/basic_info/districts/search</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	所属城市 ID 列表，详细信息可通过[查询城市信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-city/search)
接口查询获得，不填写则返回全部列表
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >district_id_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >district\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	查询到的区/县列表
	</md-dt-td>
