---
title: "查询货币信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-currency/search"
updateTime: "1719656609000"
---

# 查询货币信息

根据货币 ID、状态查询货币信息{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=basic_info.currency&method=search)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/basic_info/currencies/search</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >currency_id_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
