...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `bank_id_list` | `string\[\]` | 否 | 银行 ID 列表，可通过[批量查询员工信息](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/batch_get)等接口返回的 `person_info.bank_account_list.bank_id_v2` 字段获取<br>**示例值**：["MDBH00000080"]<br>**数据校验规则**：<br>- 最大长度：`100` |
