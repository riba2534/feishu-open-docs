...
根据国籍 ID、国家 ID，查询国籍信息{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=basic_info.nationality&method=search)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/basic_info/nationalities/search</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >nationality_id_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
	...
	<md-dt-td>
	国籍 ID 列表，可从[批量查询员工信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/batch_get)接口返回的 `person_info.nationality_id_v2` 等字段中获取，不填则返回全部
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	国家 / 地区 ID 列表，可通过[查询国家 / 地区信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-country_region/search)接口查询，不填则返回全部
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >nationality\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	查询到的国籍列表
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	国籍 ID，对应[批量查询员工信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/batch_get)接口返回的 `person_info.nationality_id_v2` 字段
	</md-dt-td>
</md-dt-tr>
