...
根据枚举的APIName查询枚举详细信息，用于BPM等场景获取枚举选项。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=enum&method=search)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/enums/search</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >enum_apiname_lists</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >enums</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >enums\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	查询的枚举信息
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >enum_apiname</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >enum_items</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >enum_field\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	枚举值
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >enum_api_name</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
