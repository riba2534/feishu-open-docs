---
title: "查询单个国家证件类型"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/national_id_type/get"
updateTime: "1730689770000"
---

# 查询单个国家证件类型

根据 ID 查询单个国家证件类型。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=national_id_type&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v1/national_id_types/:national_id_type_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >national_id_type</md-text>
	</md-dt-td>
	<md-dt-td>
	国家证件类型信息
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	国家 / 地区ID，可通过[查询国家/地区信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-country_region/search)获取对应的国家/地区信息
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >validation_rule</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >validation_rule_description</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >i18n\[\]</md-text>
	</md-dt-td>
