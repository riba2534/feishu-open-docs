---
title: "批量查询国家证件类型"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/national_id_type/list"
updateTime: "1730689770000"
---

# 批量查询国家证件类型

批量查询国家证件类型。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=national_id_type&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v1/national_id_types</md-td>
    </md-tr>
    <md-tr>
