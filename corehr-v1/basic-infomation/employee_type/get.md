...
根据 ID 查询单个人员类型。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=employee_type&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v1/employee_types/:employee_type_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >employee_type</md-text>
	</md-dt-td>
	<md-dt-td>
	雇员类型
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >default_employee_type</md-text>
	</md-dt-td>
	<md-dt-td>
