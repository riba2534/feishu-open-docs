---
title: "创建工时制度"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/working_hours_type/create"
updateTime: "1735280525000"
---

# 创建工时制度

创建工时制度。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=working_hours_type&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v1/working_hours_types</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >default_for_job</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >working_hours_type</md-text>
	</md-dt-td>
	<md-dt-td>
	工时制度
	</md-dt-td>
