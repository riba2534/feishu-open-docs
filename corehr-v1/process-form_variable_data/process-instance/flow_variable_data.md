...
根据流程实例 id（process_id）获取流程字段数据，包括业务字段和自定义字段，还有流程的数据（比如流程发起人、发起时间等），仅支持飞书人事、假勤相关业务流程。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=process&method=flow_variable_data)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/processes/:process_id/flow_variable_data</md-td>
    </md-tr>
    <md-tr>
...
<md-enum-item key="people_corehr_department_id" >以 department_id 来标识部门</md-enum-item>
</md-enum>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >variable_keys</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1160100</md-td>
  <md-td>Process is not found</md-td>
