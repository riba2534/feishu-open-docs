---
title: "获取流程表单数据"
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/process-form_variable_data/get"
updateTime: "1761048314000"
---
...
注：[旧版 API](https://open.larkoffice.com/document/server-docs/corehr-v1/process-form_variable_data/get) 文档已移动到【历史版本】目录。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v2&resource=process.form_variable_data&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v2/processes/:process_id/form_variable_data</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >field_variable_value\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	表单数据
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >field_variable_value_to</md-text>
	</md-dt-td>
	<md-dt-td>
	变量值
	</md-dt-td>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	日期值，单位：天。从 1970 年 1 月 1 日 (UTC/GMT的午夜) 开始经过的天数
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	时间值，单位：ms。从 1970 年 1 月 1 日 (UTC/GMT的午夜) 开始经过的毫秒数
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >user_value</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >record_values</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >field_variable_value_to_record\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	记录类型字段值
	</md-dt-td>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >sub_value_key</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	<md-text type="field-type" >field_variable_value_to_file</md-text>
	</md-dt-td>
	<md-dt-td>
	文件类型字段值，可通过主数据的[文件下载Open API](https://open.larkoffice.com/document/server-docs/corehr-v1/employee/person/get-2)下载
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="4">
	...
	<md-dt-td>
	用于主数据[文件下载Open API](https://open.larkoffice.com/document/server-docs/corehr-v1/employee/person/get-2)下载接口的入参id
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >field_variable_sub_vlaue\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	在 list_values 和 record_values 中引用的变量
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	用于关联 list 和 record 类型变量值中的 key
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="5">
	...
	<md-dt-td>
	用于主数据[文件下载Open API](https://open.larkoffice.com/document/server-docs/corehr-v1/employee/person/get-2)接口的id
	</md-dt-td>
</md-dt-tr>
...
<md-tr>
  ...
  <md-td>1160500</md-td>
  <md-td>服务端内部错误</md-td>
  <md-td>系统异常，请咨询[技术支持](https://applink.feishu.cn/TLJpeNdW)协助排查。</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>1160102</md-td>
  <md-td>系统内部异常</md-td>
  <md-td>系统内部异常，请咨询[技术支持](https://applink.feishu.cn/TLJpeNdW)协助排查。</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>1161003</md-td>
  <md-td>无权限</md-td>
  <md-td>请确认是否已申请所需权限：「获取流程数据」</md-td>
</md-tr>
