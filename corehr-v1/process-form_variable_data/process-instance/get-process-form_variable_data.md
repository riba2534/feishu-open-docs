...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| `process_id` | `string` | 流程实例id，是一个流程的唯一标识。<br>可通过[查询流程实例列表](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/process/list)接口返回的 process_ids 字段获取<br>**示例值**："7341373094948242956" |
