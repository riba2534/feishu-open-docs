---
title: "流程节点状态变更"
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/process-node/events/updated"
...
| 支持的应用类型 | custom,isv |
| 权限要求             订阅该事件所需的权限，开启其中任意一项权限即可订阅 | `corehr:process:read` 获取流程数据 |
| 推送方式 | `Webhook` |
...
| &nbsp;&nbsp;└ `node_type` | `int` | 节点类型<br>**可选值有**：<br>- `1`: 审批节点 - `2`: 抄送节点 - `5`: 表单节点 - `6`: 电子签 |
| &nbsp;&nbsp;└ `node_status` | `int` | 节点状态<br>**可选值有**：<br>- `1`: 进行中 - `2`: 已拒绝 - `3`: 已通过 - `4`: 已撤回 - `5`: 已回退 - `6`: 已跳过 - `7`: 已干预 |
| &nbsp;&nbsp;└ `biz_type` | `string` | 业务类型，详情请查看[接入指南](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/process-form_variable_data/access-guide)<br>**数据校验规则**：<br>- 长度范围：`1` ～ `200` 字符 |
