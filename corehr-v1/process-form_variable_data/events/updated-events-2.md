---
title: "审批任务状态变更"
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/process-approver/events/updated"
updateTime: "1762309048000"
---
...
:::html
<md-alert type="tip">
你需要在应用内配置事件订阅，并订阅该事件，这样才可以在事件触发时接收到事件数据。了解事件订阅可参见[事件概述](/ssl:ttdoc/ukTMukTMukTM/uUTNz4SN1MjL1UzM)。
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>corehr.process.approver.updated_v2</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >审批单</md-enum-item>
<md-enum-item key="5" >表单</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-enum-item key="4" >取消</md-enum-item>
<md-enum-item key="18" >已干预</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	业务类型，详情请查看[接入指南](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/process-form_variable_data/access-guide)
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >flow_definition_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >node_definition_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >node_id_str</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
