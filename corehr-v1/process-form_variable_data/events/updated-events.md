---
title: "流程实例信息变更"
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/process/events/updated"
updateTime: "1762309047000"
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>corehr.process.updated_v2</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >发起/进行中</md-enum-item>
<md-enum-item key="9" >完成</md-enum-item>
<md-enum-item key="2" >拒绝</md-enum-item>
<md-enum-item key="4" >撤回</md-enum-item>
<md-enum-item key="8" >撤销</md-enum-item>
<md-enum-item key="15" >撤销中</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	业务类型， 
详情请查看[接入指南](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/process-form_variable_data/access-guide)
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	流程定义id。流程定义是流程的模板，由流程定义可以创建流程实例。
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >普通流程</md-enum-item>
<md-enum-item key="2" >撤销流程</md-enum-item>
<md-enum-item key="3" >更正流程</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
