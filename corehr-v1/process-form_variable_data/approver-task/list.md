---
title: "获取指定人员审批任务列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/approver/list"
updateTime: "1765507228000"
---
...
| `approver_status` | `int` | 否 | 任务状态<br>**示例值**：1<br>**可选值有**：<br>- `-2`: 跳过（废弃，不支持这个状态） - `-1`: 发起 - `0`: 未开始（废弃，不支持这个状态） - `1`: 进行中 - `2`: 已拒绝 - `3`: 已通过 - `4`: 被撤回（废弃，不支持这个状态） - `5`: 抄送 - `6`: 表单提交（不建议使用，可通过状态3来查询） - `12`: 失败 - `14`: 已回退 - `16`: 发起撤销（废弃，不支持这个状态） |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `approver_status` | `int` | 任务状态<br>**可选值有**：<br>- `-2`: 跳过 - `-1`: 发起 - `0`: 未开始 - `1`: 进行中 - `2`: 已拒绝 - `3`: 已通过 - `4`: 被撤回 - `5`: 抄送 - `6`: 表单提交 - `12`: 失败 - `14`: 已回退 - `16`: 发起撤销 - `18`: 已干预 |
