...
| `approver_ids` | `string\[\]` | 是 | 待转交审批任务id列表<br>同一个审批节点如果有多个审批人，不同审批人的 approver_id 不同。<br>可通过 [获取单个流程详情](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/process/get)接口获取流程中各审批任务的 approver_id。<br>**示例值**：["7424452160928106028"]<br>**数据校验规则**：<br>- 长度范围：`1` ～ `20` |
