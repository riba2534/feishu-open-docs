---
title: "获取电子签文件列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/signature_file/list"
updateTime: "1764323959000"
---
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `signature_file_id` | `string` | 电子签文件ID，[【查询电子签文件详情】](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/signature_file/query) |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `names` | `i18n\[\]` | 名称 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `lang` | `string` | 语言 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `value` | `string` | 内容 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `create_time` | `string` | 创建时间，格式：YYYY-MM-DD 00:00:00 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `update_time` | `string` | 更新时间，格式：YYYY-MM-DD 00:00:00 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `employment_id` | `string` | 雇员 id，[【搜索员工信息】](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/search) |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `signature_file_state` | `enum` | 电子签文件状态，枚举值可通过文档[【飞书人事枚举常量】](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/feishu-people-enum-constant)电子签文件状态（signature_file_state）枚举定义部分获得 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `template_id` | `string` | 电子签模板ID，[【查询模板内容】](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/signature_template/search) |
