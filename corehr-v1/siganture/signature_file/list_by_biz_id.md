---
title: "根据流程获取电子签文件信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/signature_file/list_by_biz_id"
updateTime: "1764324021000"
---
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `employment_id` | `string` | 员工雇佣ID；可以通过[【搜索员工信息】](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/search)获取该员工详细信息 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `pre_hire_id` | `string` | 待入职ID，可以通过[【搜索待入职人员信息】](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/pre_hire/search)搜索该待入职人员详细信息 |
