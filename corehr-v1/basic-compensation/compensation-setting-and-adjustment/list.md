---
title: "批量查询定调薪原因"
fullPath: "/uAjLw4CM/ukTMukTMukTM/compensation-v1/change_reason/list"
updateTime: "1715671291000"
---
...
| 支持的应用类型 | custom |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 | `corehr:compensation_change_reason:read` 获取基础薪酬的调薪原因信息 |
