---
title: "批量更正经常性支付记录"
fullPath: "/uAjLw4CM/ukTMukTMukTM/compensation-v1/recurring_payment/batch_update"
updateTime: "1756369453000"
---

# 批量更正经常性支付记录

批量更正经常性支付记录{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=compensation&version=v1&resource=recurring_payment&method=batch_update)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/compensation/v1/recurring_payment/batch_update</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="corehr:compensation.recurring_payment:update" desc="经常性支付记录更新权限" support_app_types="custom" tags="">经常性支付记录更新权限</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	<md-text type="field-type" >recurring_payment_for_update\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	否
	</md-dt-td>
