...
通过筛选条件，批量查询经常性支付记录{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=compensation&version=v1&resource=recurring_payment&method=query)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/compensation/v1/recurring_payment/query</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="corehr:compensation.recurring_payment:read" desc="经常性支付记录读权限" support_app_types="custom" tags="">经常性支付记录读权限</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >start_date_gte</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >start_date_lte</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >end_date_gte</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >end_date_lte</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	合同主体id属于（可通过 [批量查询公司](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/company/list) 接口进行查询）
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	部门 id（通过[【查询部门】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/department/batch_get)接口进行查询）
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >recurring_payment\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	经常性支付授予记录
	</md-dt-td>
...
<md-enum-item key="day" >日</md-enum-item>
