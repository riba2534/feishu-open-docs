...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `record_ids` | `string\[\]` | 是 | 需要删除的记录ID（通过[【查询经常性支付记录】](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/compensation-v1/recurring_payment/query) 接口进行查询）<br>**示例值**：["7397033607132351532"]<br>**数据校验规则**：<br>- 长度范围：`0` ～ `500` |
