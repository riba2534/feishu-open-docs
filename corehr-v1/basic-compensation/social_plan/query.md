...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `plan_ids` | `string\[\]` | 是 | 参保方案ID列表，最少1个，最大200，可以通过[通过员工ID批量获取社保增减员记录 ](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/compensation-v1/social_archive_adjust_record/query)或[批量获取员工参保档案 ](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/compensation-v1/social_archive/query)接口获取<br>**示例值**：["10001"]<br>**数据校验规则**：<br>- 长度范围：`0` ～ `200` |
