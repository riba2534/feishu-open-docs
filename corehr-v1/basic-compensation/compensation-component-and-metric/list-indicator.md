...
批量查询薪资统计指标{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=compensation&version=v1&resource=indicator&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/compensation/v1/indicators</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="corehr:compensation_indicator:read" desc="获取基础薪酬的薪资指标信息" support_app_types="custom" tags="">获取基础薪酬的薪资指标信息</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
**可选值有**：
<md-enum>
<md-enum-item key="money" >金额</md-enum-item>
<md-enum-item key="number" >数值</md-enum-item>
<md-enum-item key="percent" >百分比</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
