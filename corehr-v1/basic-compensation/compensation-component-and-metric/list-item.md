...
批量查询薪资项{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=compensation&version=v1&resource=item&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/compensation/v1/items</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="corehr:compensation_item:read" desc="获取基础薪酬的薪资项信息" support_app_types="custom" tags="">获取基础薪酬的薪资项信息</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	薪资项分类ID，详细信息可以通过[批量获取薪资项分类信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/compensation-v1/item_category/list)接口查询获得
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >pay_off_frequency_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
