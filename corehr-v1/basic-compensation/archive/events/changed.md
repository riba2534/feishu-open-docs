...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>compensation.archive.changed_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
    ...
    <md-th>
      ...
      <md-td>
            <md-perm name="corehr:compensation_archive_detail:read" desc="获取基础薪酬的薪资档案信息" support_app_types="custom" tags="">获取基础薪酬的薪资档案信息</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>推送方式</md-th>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >operate_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="add" >新增薪酬档案</md-enum-item>
<md-enum-item key="modify" >更正薪酬档案</md-enum-item>
<md-enum-item key="delete" >删除薪酬档案</md-enum-item>
</md-enum>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	员工 ID。
- 调用[【批量查询员工薪资档案】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/compensation-v1/archive/query)接口返回员工薪资档案，需指定user_id_type为people_corehr_id来识别用户
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >before_tid</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
- 调用[【批量查询员工薪资档案】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/compensation-v1/archive/query)接口返回员工薪资档案
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >after_tid</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
