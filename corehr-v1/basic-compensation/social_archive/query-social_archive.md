---
title: "批量获取员工参保档案"
fullPath: "/uAjLw4CM/ukTMukTMukTM/compensation-v1/social_archive/query"
updateTime: "1755844202000"
---

# 批量获取员工参保档案

通过用户ID列表和生效日期查询{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=compensation&version=v1&resource=social_archive&method=query)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/compensation/v1/social_archive/query</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="corehr:compensation.social_archive:read" desc="获取员工参保档案信息" support_app_types="custom" tags="">获取员工参保档案信息</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >archives</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >social_archive\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	参保档案列表
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >social_archive_detail\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	员工参保档案，包含社保、公积金档案
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >insurance_status</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="contribution" >参保</md-enum-item>
<md-enum-item key="not_contribution" >不参保</md-enum-item>
<md-enum-item key="stopped_contribution" >停保</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	员工参保档案调整记录ID（根据档案生效时间查询对应年月的调整记录）
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	参保方案ID，详细信息可通过[查询参保方案](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/compensation-v1/social_plan/query)接口获取
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	参保城市ID，可通过[获取地点信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/location/list)接口查询详细信息
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	社保缴纳主体ID，可通过[获取公司主体](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/company/batch_get)接口查询详细信息
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >account_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >insurance_account</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >base_salary</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >insurance_details</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >social_archive_item\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	险种数据详情
	</md-dt-td>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >insurance_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >company_deduction</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >company_setting</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >personal_deduction</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >personal_setting</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >social_plan_item_setting</md-text>
	</md-dt-td>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>2290003</md-td>
  <md-td>plan or plan version not found</md-td>
  <md-td>接口404，联系技术支持</md-td>
</md-tr>
