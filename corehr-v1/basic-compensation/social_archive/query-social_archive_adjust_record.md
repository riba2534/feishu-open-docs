...
通过员工ID批量获取社保增减员记录
{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=compensation&version=v1&resource=social_archive_adjust_record&method=query)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/compensation/v1/social_archive_adjust_record/query</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="corehr:compensation.social_adjust_record:read" desc="获取员工增减员记录信息" support_app_types="custom" tags="">获取员工增减员记录信息</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	用户ID列表，与入参 user_id_type 类型一致。ID可通过接口[批量查询员工信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/batch_get)获取
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >record_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="increase" >增员</md-enum-item>
<md-enum-item key="attrition" >减员</md-enum-item>
</md-enum>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >social_archive_adjust_record\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	增/减员记录
	</md-dt-td>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	参保方案ID，详细信息可通过[查询参保方案](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/compensation-v1/social_plan/query)接口获取。当record_type为attrition时，不返回该数据
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	参保方案版本ID。当record_type为attrition时，不返回该数据
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	参保城市ID，可通过[获取地点信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/location/list)接口查询详细信息。当record_type为attrition时，不返回该数据
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	社保缴纳主体ID，可通过[获取公司主体](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/company/batch_get)接口查询详细信息。当record_type为attrition时，不返回该数据
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	社保账户类型。当record_type为attrition时，不返回该数据
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	社保账号。当record_type为attrition时，不返回该数据
	</md-dt-td>
</md-dt-tr>
