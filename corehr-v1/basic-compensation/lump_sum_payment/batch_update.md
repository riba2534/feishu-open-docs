...
通过传入的一次性支付记录数据，校验并更正一次性支付记录，并返回更正失败原因{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=compensation&version=v1&resource=lump_sum_payment&method=batch_update)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/compensation/v1/lump_sum_payment/batch_update</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	<md-text type="field-type" >lump_sum_payment_for_update\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	否
	</md-dt-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	一次性支付记录 id（通过[【查询一次性支付记录】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/compensation-v1/lump_sum_payment/query) 接口进行查询）
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >lump_sum_payment_detail_for_update\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	是
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	一次性支付记录明细id，若需要基于已有记录进行更正，请传入（通过[【查询一次性支付记录】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/compensation-v1/lump_sum_payment/query) 接口进行查询）
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >binding_period_decimal</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >operation_source</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-enum-item key="21270070" >"The binding period and the ownership period start and end dates do not match"       绑定期和所属期开始结束日期不匹配</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
