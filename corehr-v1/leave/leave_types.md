...
获取休假设置后台配置的假期类型列表（比如年假、事假、婚假等）。对应页面功能为设置-假勤设置-[假期类型](https://example.feishu.cn/people/workforce-management/setting/leave/leave_admin/leave_type){尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=leave&method=leave_types)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v1/leaves/leave_types</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >leave_type_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >leave_type\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	假期类型列表
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >leave_subtype_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >leave_subtype\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	假期子类列表
	</md-dt-td>
