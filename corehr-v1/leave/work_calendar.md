---
title: "获取工作日历"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/leave/work_calendar"
updateTime: "1764831919000"
---
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `sort_order` | `int` | 否 | 排序顺序<br>**示例值**：0<br>**可选值有**：<br>- `0`: 升序 - `1`: 降序<br>**数据校验规则**：<br>- 取值范围：`0` ～ `1` |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `sort_i18n` | `int` | 否 | 0=中文关键字;1=英文关键字;2=拼音<br>**示例值**：1<br>**可选值有**：<br>- `0`: 中文关键字 - `1`: 英文关键字 - `2`: 拼音<br>**数据校验规则**：<br>- 取值范围：`0` ～ `2` |
