...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>corehr.offboarding.updated_v2</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
    ...
    <md-th>
      ...
      <md-td>
            ...
            <md-perm name="corehr:offboarding.update_field_message:read" desc="订阅离职字段变更事件" support_app_types="custom,isv" tags="">订阅离职字段变更事件</md-perm>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >offboarding_info_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	离职流转流程的实例ID，可用于[查询流程相关信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/process/list)，例如：作为[获取单个流程详情](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/process/list)的process_id查询流程详情。
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >updated_fields</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
