---
title: "离职流转状态变更"
fullPath: "/uAjLw4CM/ukTMukTMukTM/corehr-v2/offboarding/events/checklist_updated"
updateTime: "1732773399000"
---
...
| 支持的应用类型 | custom,isv |
| 权限要求             订阅该事件所需的权限，开启其中任意一项权限即可订阅 开启任一权限即可 | `corehr:offboarding.checklist_status_message:read` 订阅离职流转状态变更事件 `corehr:offboarding:read` 获取员工离职信息 `corehr:employment` 更新雇佣信息 `corehr:employment:readonly` 获取雇佣信息 `corehr:offboarding:write` 读写员工离职信息 |
...
| &nbsp;&nbsp;└ `checklist_process_id` | `string` | 离职流转流程的实例 ID，可用于[查询流程相关信息](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/process/list)，例如：作为[获取单个流程详情](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/process/list)的process_id查询流程详情。 |
| &nbsp;&nbsp;└ `checklist_status` | `int` | 离职流转状态<br>**可选值有**：<br>- `1`: 未发起 - `2`: 进行中 - `3`: 已完成 - `4`: 已拒绝 - `5`: 已撤销 |
