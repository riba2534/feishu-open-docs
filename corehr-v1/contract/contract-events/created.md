---
title: "合同创建"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/contract/events/created"
updateTime: "1724639906000"
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>corehr.contract.created_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
    ...
    <md-th>
      ...
      <md-td>
            <md-perm name="corehr:contract:read" desc="查看合同信息" support_app_types="custom,isv" tags="">查看合同信息</md-perm>
            <md-perm name="corehr:corehr:readonly" desc="获取核心人事信息" support_app_types="custom,isv" tags="">获取核心人事信息</md-perm>
            <md-perm name="corehr:contract:write" desc="创建、更新、删除合同信息" support_app_types="custom" tags="">创建、更新、删除合同信息</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>推送方式</md-th>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	合同ID，该合同详细信息可通过[【合同信息查询接口】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/contract/get)获取
	</md-dt-td>
</md-dt-tr>
