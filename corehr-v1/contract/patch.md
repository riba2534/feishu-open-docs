...
通过该接口可以更新员工合同相关信息，没有修改的参数会保留原值{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=contract&method=patch)
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	甲方, 引用Company的ID，详细信息可通过[【查询单个公司】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/company/get)
接口查询获得
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	雇员 ID，详细信息可通过[【批量查询员工信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/batch_get)
接口查询获得
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	Person ID，详细信息可通过接口文档[【查询个人信息接口】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/person/get)接口查询获得
	</md-dt-td>
</md-dt-tr>
...
<md-tr>
  ...
  <md-td>该时间段已存在合同，请修改合同生效时间段</md-td>
</md-tr>
