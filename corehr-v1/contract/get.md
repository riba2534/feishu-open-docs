...
该接口用于根据合同 ID 查询单个合同详细信息，包括合同开始日期、结束日期、公司主体等信息{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=contract&method=get)
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	合同ID，该ID可以通过[【批量查询合同】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/contract/list)接口获取
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	雇佣 ID，详细信息可通过[【查询员工信息接口】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/search)获取
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	合同主体ID,  详细信息可通过[【查询公司详情接口】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/company/get)接口查询获得
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	Person ID，详细信息可通过接口文档[【批量查询员工信息接口】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/batch_get)接口查询获得
	</md-dt-td>
</md-dt-tr>
