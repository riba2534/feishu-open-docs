...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>payroll.payment_activity.status_changed_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
    ...
    <md-th>
      ...
      <md-td>
            <md-perm name="payroll:payment_activity:monitor" desc="订阅发薪活动状态变更事件" support_app_types="custom,isv" tags="">订阅发薪活动状态变更事件</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>推送方式</md-th>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	发薪活动ID，详情可查看[查询发薪活动列表](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/payroll-v1/payment_activity/list)
	</md-dt-td>
</md-dt-tr>
