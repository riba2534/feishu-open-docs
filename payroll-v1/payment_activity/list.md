---
title: "查询发薪活动列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/payroll-v1/payment_activity/list"
updateTime: "1741609549000"
---
...
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 | `payroll:payment_activity:read` 获取发薪活动列表数据 |
...
| `statuses` | `int\[\]` | 否 | 发薪活动审批状态列表，其中： 1. 100 - 待确认名单 2. 150 - 待提交审批 3. 200 - 审批中 4. 300 - 审批被拒绝 5. 350 - 审批被撤回 6. 360 - 审批被撤销 7. 375 - 审批通过 8. 400 - 已封存<br>**示例值**：100<br>**数据校验规则**：<br>- 长度范围：`0` ～ `100` |
