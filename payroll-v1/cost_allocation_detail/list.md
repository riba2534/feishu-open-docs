---
title: "查询成本分摊报表明细"
fullPath: "/uAjLw4CM/ukTMukTMukTM/payroll-v1/cost_allocation_detail/list"
updateTime: "1765505824000"
---

# 查询成本分摊报表明细

根据报表方案、期间、和报表类型获取成本分摊明细数据。调用接口前，需打开「财务过账」开关，并且完成发布成本分摊报表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=payroll&version=v1&resource=cost_allocation_detail&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/payroll/v1/cost_allocation_details</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="payroll:cost_allocation_details:read" desc="获取成本分摊报表明细数据" support_app_types="custom,isv" tags="">获取成本分摊报表明细数据</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
**可选值有**：
<md-enum>
<md-enum-item key="0" >默认</md-enum-item>
