...
根据期间分页批量查询成本分摊方案，仅返回期间内生效的方案列表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=payroll&version=v1&resource=cost_allocation_plan&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/payroll/v1/cost_allocation_plans</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="payroll:cost_allocation_plan:read" desc="获取成本分摊方案" support_app_types="custom,isv" tags="">获取成本分摊方案</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >cost_allocation_plan\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	方案
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >applicable_country_region</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
	<md-dt-td>
	适用国家ID，通过[查询国家/地区信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-country_region/search)获取
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >obj_api_name</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >cost_items</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >cost_item\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	成本分摊方案对应的成本项列表
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >enable_correct</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-tr>
  ...
  <md-td>内部服务调用异常，请联系[技术支持](https://applink.feishu.cn/TLJpeNdW)</md-td>
</md-tr>
