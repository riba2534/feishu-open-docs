...
- 本接口返回所有薪资组的基本信息，包括薪资组ID、薪资组名称、薪资组编码、薪资组状态等，不含薪资组下的员工信息{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=payroll&version=v1&resource=paygroup&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/payroll/v1/paygroups</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="payroll:pay_groups:read" desc="获取薪资组信息" support_app_types="custom,isv" tags="">获取薪资组信息</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >paygroup\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	薪资组列表
	</md-dt-td>
...
<md-tr>
  ...
  <md-td>请重试，如仍失败请咨询[技术支持](https://applink.feishu.cn/TLJpeNdW)</md-td>
</md-tr>
