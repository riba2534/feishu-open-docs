---
title: "获取薪资组基本信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/payroll-v1/paygroup/list"
updateTime: "1732781087000"
---
...
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 | `payroll:pay_groups:read` 获取薪资组信息 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `en_us` | `string` | 英文名称 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `code` | `string` | 薪资组编码 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `status` | `int` | 薪资组状态<br>**可选值有**：<br>- `1`: 启用 - `0`: 禁用 |
