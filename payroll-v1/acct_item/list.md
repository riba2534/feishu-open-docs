...
批量查询算薪项{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=payroll&version=v1&resource=acct_item&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/payroll/v1/acct_items</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="payroll:payroll_calculation_item:read" desc="获取算薪项信息" support_app_types="custom,isv" tags="">获取算薪项信息</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >acct_item\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	算薪项列表
	</md-dt-td>
