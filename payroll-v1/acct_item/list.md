---
title: "批量查询算薪项"
fullPath: "/uAjLw4CM/ukTMukTMukTM/payroll-v1/acct_item/list"
updateTime: "1734575043000"
---
...
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 | `payroll:payroll_calculation_item:read` 获取算薪项信息 |
