---
title: "获取技能信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/aily-v1/app-skill/get"
updateTime: "1752155059000"
---

# 获取技能信息

该 API 用于查询某个 Aily 应用的特定技能详情{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=aily&version=v1&resource=app.skill&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/aily/v1/apps/:app_id/skills/:skill_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >skill</md-text>
	</md-dt-td>
	<md-dt-td>
