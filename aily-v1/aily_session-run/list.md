...
该 API 用于列出某个飞书 Aily 应用的运行（Run）的详细信息；包括状态、结束时间等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=aily&version=v1&resource=aily_session.run&method=list)
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >runs</md-text>
	</md-dt-td>
	<md-dt-td>
