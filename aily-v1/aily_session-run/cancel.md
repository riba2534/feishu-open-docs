---
title: "取消运行"
fullPath: "/uAjLw4CM/ukTMukTMukTM/aily-v1/aily_session-run/cancel"
updateTime: "1752203091000"
---

# 中止一次运行

该 API 用于中止某个飞书 Aily 的一次运行。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=aily&version=v1&resource=aily_session.run&method=cancel)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/aily/v1/sessions/:aily_session_id/runs/:run_id/cancel</md-td>
    </md-tr>
    <md-tr>
