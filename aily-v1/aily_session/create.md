---
title: "创建会话"
fullPath: "/uAjLw4CM/ukTMukTMukTM/aily-v1/aily_session/create"
updateTime: "1752154881000"
---

# 创建会话

该 API 用于创建与某个飞书 Aily 应用的一次会话（Session）；当创建会话成功后，可以发送消息、创建运行。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=aily&version=v1&resource=aily_session&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/aily/v1/sessions</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="aily:session:write" desc="读写会话信息" support_app_types="custom" tags="">读写会话信息</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
