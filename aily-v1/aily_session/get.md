---
title: "获取会话"
fullPath: "/uAjLw4CM/ukTMukTMukTM/aily-v1/aily_session/get"
updateTime: "1752154904000"
---

# 获取会话

该 API 用于获取与某个飞书 Aily 应用的一次会话（Session）的详细信息，包括会话的状态、渠道上下文、创建时间等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=aily&version=v1&resource=aily_session&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/aily/v1/sessions/:aily_session_id</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="aily:session:read" desc="获取会话信息" support_app_types="custom" tags="">获取会话信息</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >session</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >aily_session</md-text>
	</md-dt-td>
	<md-dt-td>
	会话信息
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >modified_at</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >channel_context</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
