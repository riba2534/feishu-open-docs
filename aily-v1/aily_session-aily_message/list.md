---
title: "列出 Aily 消息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/aily-v1/aily_session-aily_message/list"
updateTime: "1752154952000"
---

# 列出 Aily 消息

该 API 用于列出某个飞书 Aily 应用的某个会话（Session）下消息（Message）的详细信息；包括消息的内容、发送人等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=aily&version=v1&resource=aily_session.aily_message&method=list)
...
<md-table>
  ...
  <md-tbody>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="aily:message:read" desc="获取消息" support_app_types="custom" tags="">获取消息</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >with_partial_message</md-text>
	</md-dt-td>
	<md-dt-td>
