---
title: "删除数据知识"
fullPath: "/uAjLw4CM/ukTMukTMukTM/aily-v1/app-data_asset/delete"
updateTime: "1752155012000"
---

# 删除数据知识

删除 Aily 的数据知识{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=aily&version=v1&resource=app.data_asset&method=delete)
...
<md-tr>
  <md-td>404</md-td>
  <md-td>2700404</md-td>
  <md-td>not found resources</md-td>
  <md-td>数据知识不存在</md-td>
</md-tr>
