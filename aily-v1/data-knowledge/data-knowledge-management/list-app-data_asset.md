---
title: "查询数据知识列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/aily-v1/app-data_asset/list"
updateTime: "1752155024000"
---

# 获取数据知识列表

获取 Aily 助手的数据知识列表{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=aily&version=v1&resource=app.data_asset&method=list)
...
<md-table>
  ...
  <md-tbody>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="aily:data_asset:read" desc="获取智能伙伴创建平台数据知识资产" support_app_types="custom" tags="">获取智能伙伴创建平台数据知识资产</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >with_data_asset_item</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >with_connect_status</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >boolean</md-text>
	</md-dt-td>
...
<md-enum-item key="larkbiz_doc" >飞书doc</md-enum-item>
<md-enum-item key="larkbiz_docs" >飞书docs</md-enum-item>
<md-enum-item key="larkbiz_docx" >飞书docx</md-enum-item>
<md-enum-item key="larkbiz_pdf" >飞书pdf</md-enum-item>
<md-enum-item key="larkbiz_word" >飞书word</md-enum-item>
<md-enum-item key="larkbiz_pptx" >飞书pptx</md-enum-item>
<md-enum-item key="larkbiz_sheets" >飞书文档</md-enum-item>
...
<md-tr>
  ...
  <md-td>无权限，请检查是否有开发者/云纹人员权限</md-td>
</md-tr>
