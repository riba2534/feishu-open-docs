...
获取 Aily 助手的数据知识分类列表{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=aily&version=v1&resource=app.data_asset_tag&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/aily/v1/apps/:app_id/data_asset_tags</md-td>
    </md-tr>
    <md-tr>
