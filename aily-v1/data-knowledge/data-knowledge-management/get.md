...
获取单个数据知识{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=aily&version=v1&resource=app.data_asset&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/aily/v1/apps/:app_id/data_assets/:data_asset_id</md-td>
    </md-tr>
    <md-tr>
...
<md-enum-item key="larkbiz_doc" >旧版飞书云文档，不支持</md-enum-item>
<md-enum-item key="larkbiz_docs" >飞书docs</md-enum-item>
<md-enum-item key="larkbiz_docx" >新版飞书云文档，目前线上新创建的云文档均属于此类型</md-enum-item>
<md-enum-item key="larkbiz_pdf" >云盘/wiki中的pdf</md-enum-item>
<md-enum-item key="larkbiz_word" >云盘/wiki中的.docx（Word文档）</md-enum-item>
<md-enum-item key="larkbiz_pptx" >云盘/wiki中的.pptx（Powerpoint），不包括飞书幻灯片</md-enum-item>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>2700404</md-td>
  <md-td>not found resource</md-td>
  <md-td>数据知识不存在</md-td>
</md-tr>
