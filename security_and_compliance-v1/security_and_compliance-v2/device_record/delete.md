---
title: "删除设备"
fullPath: "/uAjLw4CM/ukTMukTMukTM/security_and_compliance-v2/device_record/delete"
updateTime: "1761026673000"
---

# 删除设备

使用该接口在设备管理中删除一台设备{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=security_and_compliance&version=v2&resource=device_record&method=delete)
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1785008</md-td>
  <md-td>The device is not found. Please check the parameter device_record_id.</md-td>
  <md-td>检查参数中设备编码是否存在</md-td>
</md-tr>
