---
title: "设备信息变更事件"
fullPath: "/uAjLw4CM/ukTMukTMukTM/security_and_compliance-v2/device_record/events/device_change_event"
updateTime: "1762917891000"
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>security_and_compliance.device_record.device_change_event_v2</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >插入</md-enum-item>
<md-enum-item key="2" >更新</md-enum-item>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >before</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >device_change_event</md-text>
	</md-dt-td>
	<md-dt-td>
	变更前数据
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >is_managed</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >mdm_device_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >mdm_provider_name</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >after</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >device_change_event</md-text>
	</md-dt-td>
