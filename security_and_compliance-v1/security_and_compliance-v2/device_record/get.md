...
使用该接口在设备管理中获取设备的设备参数、设备归属、设备状态等信息{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=security_and_compliance&version=v2&resource=device_record&method=get)
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >device_record</md-text>
	</md-dt-td>
	<md-dt-td>
	设备记录
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >latest_user_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >dids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-tr>
  ...
  <md-td>内部接口处理失败。若无法解决请寻求客服帮：https://applink.larkoffice.com/TLJpeNdW</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>检查参数是否正确。若无法解决请寻求客服帮：https://applink.larkoffice.com/TLJpeNdW</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>联系服务提供方排查：https://applink.larkoffice.com/TLJpeNdW</md-td>
</md-tr>
