...
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 | `security_and_compliance:device_record:write` 新增、更新、删除设备 |
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `device_ownership` | `int` | 是 | 设备归属<br>**示例值**：0<br>**可选值有**：<br>- `0`: 未知设备 - `1`: 个人设备 - `2`: 企业设备 |
| `device_status` | `int` | 是 | 可信状态<br>**示例值**：0<br>**可选值有**：<br>- `0`: 未知状态 - `1`: 信任设备 - `2`: 非信任设备 |
