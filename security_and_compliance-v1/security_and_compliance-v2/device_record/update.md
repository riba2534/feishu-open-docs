---
title: "更新设备"
fullPath: "/uAjLw4CM/ukTMukTMukTM/security_and_compliance-v2/device_record/update"
updateTime: "1761026661000"
---

# 更新设备

使用该接口在设备管理中修改一台设备的设备归属、设备状态等信息{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=security_and_compliance&version=v2&resource=device_record&method=update)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/security_and_compliance/v2/device_records/:device_record_id</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1785008</md-td>
  <md-td>The device is not found. Please check the parameter device_record_id and version.</md-td>
  <md-td>检查参数中设备编码和版本号是否存在</md-td>
</md-tr>
