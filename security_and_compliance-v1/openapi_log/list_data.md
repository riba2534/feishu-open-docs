...
fullPath: "/uAjLw4CM/ukTMukTMukTM/security_and_compliance-v1/openapi_log/list_data"
updateTime: "1714121397000"
---
...
| 支持的应用类型 | custom |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 | `security_and_compliance:audit_log.openapi_log:readonly` 查看 OpenAPI 审计日志 |
