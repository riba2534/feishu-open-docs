---
title: "获取单位列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/unit/list"
updateTime: "1720167378000"
---

# 获取单位列表

调用该接口获取当前租户内的单位列表。列表内主要包含各单位的 ID、名字、类型信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=unit&method=list)
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >unitlist</md-text>
	</md-dt-td>
	<md-dt-td>
