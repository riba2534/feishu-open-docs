---
title: "解除部门与单位的绑定关系"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/unit/unbind_department"
updateTime: "1720167377000"
---

# 解除部门与单位的绑定关系

调用该接口解除部门与单位的绑定关系。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=unit&method=unbind_department)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/contact/v3/unit/unbind_department</md-td>
    </md-tr>
    <md-tr>
