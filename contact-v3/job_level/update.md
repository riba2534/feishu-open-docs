...
调用该接口更新指定职级的信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=job_level&method=update)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/contact/v3/job_levels/:job_level_id</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  ...
  <md-td>职级不存在。请确保传入的职级 ID 正确后重试。</md-td>
</md-tr>
