...
调用该接口通过用户组 ID 查询指定用户组的基本信息，包括用户组名称、成员数量和类型等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=group&method=get)
...
<md-tr>
  <md-td>400</md-td>
  <md-td>42029</md-td>
  <md-td>exist some field openapi not support, please  manage the group in admin platform</md-td>
  <md-td>部分字段在OpenAPI接口中未被支持，请在管理后台页面中调整对应的用户组设置。</md-td>
</md-tr>
