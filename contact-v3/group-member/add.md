...
调用该接口向指定的普通用户组内添加成员。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=group.member&method=add)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/contact/v3/group/:group_id/member/add</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  ...
  <md-td>用户组的部门数量达到上限。单租户单个普通用户组部门数量上限为 20。</md-td>
</md-tr>
