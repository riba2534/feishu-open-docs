...
待添加到角色的成员，需要包含在当前应用的通讯录权限范围内，否则将会操作失败。如何设置通讯录权限范围，可参见[权限范围资源介绍](https://open.larkoffice.com/document/ukTMukTMukTM/uETNz4SM1MjLxUzM/v3/guides/scope_authority)。
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `reason` | `int` | 添加成员的处理结果。<br>**可选值有**：<br>- `1`: 处理成功 - `2`: 用户 ID 无效 - `3`: 无权限操作该用户 ID - `4`: 用户已存在该角色中 - `5`: 用户不存在该角色中 - `6`: 无权限操作该角色成员旧的管理范围 |
