...
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/functional_role-member/get"
updateTime: "1720167459000"
---

# 查询角色下某个成员的管理范围

调用本接口查询指定角色内的指定成员的管理范围。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=functional_role.member&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/contact/v3/functional_roles/:role_id/members/:member_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >functional_role.member</md-text>
	</md-dt-td>
	<md-dt-td>
	成员的管理范围。
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="All" >全部</md-enum-item>
<md-enum-item key="Part" >部分部门</md-enum-item>
<md-enum-item key="None" >空，即未设置</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	部门 ID 列表，ID 类型与查询参数 department_id_type 的取值保持一致。后续你可以调用[获取单个部门信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/get)接口，根据部门 ID 获取部门详情。
...
<md-tr>
  <md-td>404</md-td>
  <md-td>41203</md-td>
  <md-td>member id is not exist</md-td>
  <md-td>成员 ID 不存在。你可以调用[查询角色下的所有成员信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/functional_role-member/list)接口，获取在当前角色内的成员 ID。</md-td>
</md-tr>
