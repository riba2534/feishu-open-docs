---
title: "成员字段变更"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/custom_attr_event/events/updated"
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>contact.custom_attr_event.updated_v3</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >custom_attr_event</md-text>
	</md-dt-td>
	<md-dt-td>
	变更后信息
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >contact_field_key</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >allow_open_query</md-text>
	</md-dt-td>
	<md-dt-td>
