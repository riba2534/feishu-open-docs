---
title: "搜索部门"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/search"
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `i18n_name` | `department_i18n_name` | 国际化的部门名称。<br>**字段权限要求（满足任一）**： `contact:department.base:readonly` 获取部门基础信息 `contact:contact:access_as_app` 以应用身份访问通讯录 `contact:contact:readonly` 读取通讯录 `contact:contact:readonly_as_app` 以应用身份读取通讯录 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `zh_cn` | `string` | 部门的中文名。 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `ja_jp` | `string` | 部门的日文名。 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `en_us` | `string` | 部门的英文名。 |
