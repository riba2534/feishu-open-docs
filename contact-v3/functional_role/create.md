...
调用该接口创建一个角色。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=functional_role&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/contact/v3/functional_roles</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>41201</md-td>
  <md-td>role name is exist</md-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>41208</md-td>
  <md-td>tenant role not more 500</md-td>
  <md-td>租户内角色数量超过 500，不能继续创建。你需要删除不再使用的角色后重试。</md-td>
</md-tr>
