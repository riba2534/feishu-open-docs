...
调用该接口获取指定部门直属的用户信息列表。用户信息包括用户 ID、名称、邮箱、手机号以及状态等信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=user&method=find_by_department)
...
关于用户组织架构可见范围和通讯录权限范围的更多信息，可参见[权限范围资源介绍](/ssl:ttdoc/ukTMukTMukTM/uETNz4SM1MjLxUzM/v3/guides/scope_authority)。
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/contact/v3/users/find_by_department</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	头像的文件 Key。该参数实际无返回值，请忽略，获取头像信息可使用 `avatar` 参数。
	</md-dt-td>
</md-dt-tr>
...
<md-tr>
  ...
  <md-td>无效的分页参数。page_size 的取值上限为 50。</md-td>
</md-tr>
