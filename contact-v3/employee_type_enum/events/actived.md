---
title: "启用人员类型"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/employee_type_enum/events/actived"
updateTime: "1720166960000"
---

# 启用人员类型

当应用订阅该事件后，如果将未激活的人员类型更新为激活状态，则会触发该事件。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=employee_type_enum&event=actived)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>contact.employee_type_enum.actived_v3</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >old_enum</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >new_enum</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >employee_type_enum</md-text>
	</md-dt-td>
