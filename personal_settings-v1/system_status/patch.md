...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| `system_status_id` | `string` | 系统状态ID<br>[获取系统状态ID](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/personal_settings-v1/system_status/list)<br>**示例值**："7101214603622940633" |
...
| `update_fields` | `string\[\]` | 是 | 需要更新的字段<br>**示例值**：["ICON"]<br>**可选值有**：<br>- `TITLE`: 系统状态名称 - `I18N_TITLE`: 系统状态国际化名称 - `ICON`: 图标 - `COLOR`: 颜色 - `PRIORITY`: 优先级 - `SYNC_SETTING`: 同步设置<br>**数据校验规则**：<br>- 最小长度：`1` |
