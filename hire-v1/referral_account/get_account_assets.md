---
title: "查询内推账户"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/referral_account/get_account_assets"
updateTime: "1733205985000"
---
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `referral_account_id` | `string` | 是 | 账户 ID，注册账户后获取：[注册内推账户](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/referral_account/create)<br>**示例值**：6942778198054125570 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `email` | `string` | 内推人邮箱<br>**字段权限要求**： `hire:employee.email:readonly` 查看员工邮箱 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `mobile` | `string` | 内推人手机<br>**字段权限要求**： `hire:employee.mobile:readonly` 查看员工手机号 |
