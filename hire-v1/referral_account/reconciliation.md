...
| &nbsp;&nbsp;└ `account_id` | `string` | 是 | 内推账户ID，通过[注册内推账户](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/referral_account/create)生成<br>**示例值**："6930815272790114324" |
