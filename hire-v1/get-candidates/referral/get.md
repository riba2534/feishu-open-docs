...
根据职位广告 ID 获取内推官网下的职位广告详情，包含职位广告 ID 以及职位信息等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=referral_website.job_post&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/referral_websites/job_posts/:job_post_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	职位广告 ID，可通过[获取内推官网下职位广告列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/referral_website-job_post/list)获取
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	项目ID，详情可参考：[获取项目列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/subject/list)
	</md-dt-td>
</md-dt-tr>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1002509</md-td>
  <md-td>职位广告未发布至官网</md-td>
  <md-td>检查参数`job_post_id`对应的职位广告是否发布到官网上</md-td>
</md-tr>
