---
title: "获取内推官网下职位广告列表"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/referral_website-job_post/list"
updateTime: "1724813286000"
---

# 获取内推官网下职位广告列表

获取内推官网下的职位列表，包含职位广告ID、职位广告名称、职位信息等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=referral_website.job_post&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/referral_websites/job_posts</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="hire:referral_website:readonly" desc="获取内推官网信息" support_app_types="custom" tags="">获取内推官网信息</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >portal_job_post\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	职位广告列表
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	雇佣类型，请参考[枚举常量介绍](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/enum)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	部门ID，与`department_id_type`类型一致
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	职位类别ID，详情请参考：[获取职位类别列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job_type/list)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	最低职级 ID，与入参`job_level_id_type` 类型一致
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	最高职级 ID，与入参`job_level_id_type` 类型一致
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	职位地址ID，详情请参考：[获取地址列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/location/list)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	职位亮点列表，详情请参考：[枚举常量介绍](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/enum)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	自定义字段列表，详情可参考：[获取职位模板](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job_schema/list)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	职能分类 ID，详情请查看：[获取职能分类列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job_function/list)
	</md-dt-td>
</md-dt-tr>
