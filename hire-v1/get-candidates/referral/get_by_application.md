...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `application_id` | `string` | 是 | 投递 ID，可通过[获取投递列表](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/application/list)获取<br>**示例值**：6134134355464633 |
