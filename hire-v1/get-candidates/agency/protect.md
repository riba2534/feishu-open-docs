...
设置指定人才的猎头保护期，当「飞书招聘」内置的保护期功能不满足需求时，客户可通过此接口自定义人才的保护期。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=agency&method=protect)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/agencies/protect</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	人才ID，可通过[通过手机号或邮箱获取人才 ID](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/talent/batch_get_id)、[获取人才列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/talent/list)接口获取
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >supplier_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >consultant_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >protect_create_time</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >protect_expire_time</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >current_salary</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >expected_salary</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
