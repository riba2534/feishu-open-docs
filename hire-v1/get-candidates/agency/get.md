---
title: "获取猎头供应商信息"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/agency/get"
updateTime: "1723000940000"
---

# 获取猎头供应商信息

根据猎头供应商 ID 获取有合作关系的猎头供应商信息，包含猎头供应商ID、名称、联系人等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=agency&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/agencies/:agency_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >agency_id</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1002409</md-td>
  <md-td>猎头合作关系不存在</md-td>
  <md-td>仅支持查询有合作关系的猎头供应商信息</md-td>
</md-tr>
