...
根据官网 ID 获取推广渠道列表，支持分页查询。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=website.channel&method=list)
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >website_channel_list</md-text>
	</md-dt-td>
	<md-dt-td>
