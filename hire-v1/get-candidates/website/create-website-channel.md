---
title: "新建招聘官网推广渠道"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/website-channel/create"
updateTime: "1722568751000"
---

# 新建招聘官网推广渠道

新建指定官网的推广渠道。每个官网可以新建多个推广渠道，每个推广渠道具有不同的推广链接和推广码。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=website.channel&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/websites/:website_id/channels</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	<md-text type="field-type" >website_channel_info</md-text>
	</md-dt-td>
	<md-dt-td>
	\-
	</md-dt-td>
