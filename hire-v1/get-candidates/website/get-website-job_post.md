...
> **Tip**: **提示**
> 
> 官网上创建的投递，都是通过 `job_post_id`（职位广告 ID）而不是 `job_id`（职位 ID）创建的。例如：[新建招聘官网投递](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/website-delivery/create_by_resume)，[根据简历附件创建招聘官网投递任务](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/website-delivery/create_by_attachment)等。
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| `website_id` | `string` | 官网 ID，可通过[获取招聘官网列表](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/website/list)获取<br>**示例值**："7047318856652261676" |
| `job_post_id` | `string` | 职位广告 ID，可通过[获取招聘官网下的职位广告列表](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/website-job_post/list)或[搜索招聘官网下的职位广告列表](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/website-job_post/search)获取<br>**示例值**："7392894182636144946" |
