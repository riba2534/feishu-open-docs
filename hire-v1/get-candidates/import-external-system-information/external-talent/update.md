---
title: "更新人才外部信息"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/talent-external_info/update"
updateTime: "1725853462000"
---

# 更新人才外部信息

更新人才外部信息，包含外部系统创建时间。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=talent.external_info&method=update)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/talents/:talent_id/external_info</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >external_create_time</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >external_info</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >talent_external_info</md-text>
	</md-dt-td>
	<md-dt-td>
	人才外部信息
	</md-dt-td>
