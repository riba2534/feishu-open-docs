---
title: "创建外部面试"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/external_interview/create"
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `external_id` | `string` | 否 | 外部系统面试主键 （仅用于幂等） - 若不传此值，则不进行幂等校验 - 若传此值，则用于幂等校验，同一`external_id` 24小时内仅可创建一次<br>**示例值**："7396034232747641133" |
...
| &nbsp;&nbsp;└ `conclusion` | `int` | 否 | 面试结论<br>**示例值**：1<br>**可选值有**：<br>- `1`: 不通过 - `2`: 通过 - `3`: 待定 |
