...
> **Warning**: * 该接口仅支持修改已有试卷信息（通过试卷 ID标识），不支持新增或删除试卷。
...
| &nbsp;&nbsp;└ `id` | `string` | 是 | 试卷 ID，为通过[创建试卷列表](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/eco_exam_paper/create)传入的 ID<br>**示例值**："7147998241542539527"<br>**数据校验规则**：<br>- 最小长度：`1` 字符 |
