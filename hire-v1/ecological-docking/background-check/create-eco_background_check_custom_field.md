---
title: "创建背调自定义字段"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/eco_background_check_custom_field/create"
updateTime: "1725535721000"
---
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `account_id` | `string` | 是 | 背调账号 ID，可在[账号绑定](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/eco_account/events/created)事件中获取<br>**示例值**："6995842370159937061" |
