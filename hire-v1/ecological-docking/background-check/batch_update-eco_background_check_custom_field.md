---
title: "更新背调自定义字段"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/eco_background_check_custom_field/batch_update"
updateTime: "1723460586000"
---
...
| `custom_field_list` | `eco_background_check_custom_field_data\[\]` | 是 | 自定义字段列表。 **注意**：列表长度须与[创建背调自定义字段](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/eco_background_check_custom_field/create)时传入的一致 |
| &nbsp;&nbsp;└ `type` | `string` | 是 | 自定义字段类型<br>**示例值**："select"<br>**可选值有**：<br>- `text`: 单行文本，最多100个汉字 - `textarea`: 多行文本，最多200个汉字 - `number`: 数字 - `boolean`: 布尔 - `select`: 单选 - `multiselect`: 多选 - `date`: 日期 - `file`: 附件 - `resume`: 候选人简历 |
