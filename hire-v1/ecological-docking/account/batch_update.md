---
title: "更新账号自定义字段"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/eco_account_custom_field/batch_update"
updateTime: "1724825358000"
---

# 更新账号自定义字段

飞书招聘的背调或笔试服务商，可通过此接口更新账号自定义字段（比如客户在服务商处的租户 ID、账号 ID等）的名称和描述。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=eco_account_custom_field&method=batch_update)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/eco_account_custom_fields/batch_update</md-td>
    </md-tr>
    <md-tr>
