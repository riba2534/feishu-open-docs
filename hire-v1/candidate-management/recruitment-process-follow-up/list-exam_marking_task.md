...
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 | `hire:exam:readonly` 获取笔试信息 |
...
| `activity_status` | `int` | 否 | 任务状态，不传则查询全部记录<br>**示例值**：1<br>**可选值有**：<br>- `1`: 待阅卷 - `2`: 已阅卷 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `activity_status` | `int` | 任务状态<br>**可选值有**：<br>- `1`: 待阅卷 - `2`: 已阅卷 |
