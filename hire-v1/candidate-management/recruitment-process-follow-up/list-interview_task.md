---
title: "获取面试任务列表"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/interview_task/list"
updateTime: "1722394744000"
---
...
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 | `hire:interview:readonly` 获取面试信息 |
...
| `activity_status` | `int` | 否 | 任务状态<br>**示例值**：1<br>**可选值有**：<br>- `1`: 未开始 - `2`: 未评价 - `3`: 已评价 - `5`: 已终止 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `activity_status` | `int` | 任务状态<br>**可选值有**：<br>- `1`: 未开始 - `2`: 未评价 - `3`: 已评价 - `5`: 已终止 |
