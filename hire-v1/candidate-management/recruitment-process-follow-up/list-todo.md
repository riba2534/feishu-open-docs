---
title: "批量获取待办事项"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/todo/list"
updateTime: "1724999547000"
---
...
| 支持的应用类型 | custom |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 | `hire:todo:readonly` 获取招聘待办信息 |
...
| `type` | `string` | 是 | 待办类型<br>**示例值**：interview<br>**可选值有**：<br>- `evaluation`: 评估待办 - `offer`: Offer 待办 - `exam`: 笔试待办 - `interview`: 面试待办 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `talent_id` | `string` | 人才 ID，详情可查看：[获取人才信息](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/hire-v2/talent/get) |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `job_id` | `string` | 职位 ID，详情可查看：[获取职位信息](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job/get) |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `id` | `string` | 评估 ID，详情可查看：[批量获取简历评估信息](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/evaluation/list) |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `job_id` | `string` | 职位 ID，详情可查看：[获取职位信息](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job/get) |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `application_id` | `string` | 投递 ID，详情可查看：[获取投递信息](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/application/get) |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `id` | `string` | 面试 ID，详情可查看：[获取面试信息](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/interview/list) |
