---
title: "获取简历评估任务列表"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/evaluation_task/list"
updateTime: "1722311401000"
---
...
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 | `hire:evaluation:readonly` 获取简历评估信息 |
...
| `activity_status` | `int` | 否 | 任务状态，不传则查询全部记录<br>**示例值**：1<br>**可选值有**：<br>- `1`: 待评估 - `2`: 已评估 - `3`: 无需评估 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `id` | `string` | 评估 ID，详情请查看：[获取简历评估信息](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/evaluation/list) |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `job_id` | `string` | 职位 ID，详情请查看：[获取职位信息](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job/get) |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `talent_id` | `string` | 人才 ID，详情请查看：[获取人才信息](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/hire-v2/talent/get) |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `activity_status` | `int` | 任务状态<br>**可选值有**：<br>- `1`: 待评估 - `2`: 已评估 - `3`: 无需评估 |
