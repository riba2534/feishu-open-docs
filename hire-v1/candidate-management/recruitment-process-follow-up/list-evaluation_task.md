...
根据评估人ID查询评估任务列表，可以查询到的信息包括：评估ID、投递ID、任务状态等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=evaluation_task&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/evaluation_tasks</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >activity_status</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >待评估</md-enum-item>
<md-enum-item key="2" >已评估</md-enum-item>
<md-enum-item key="3" >无需评估</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >evaluation_task\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	评估任务列表
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	评估 ID，详情请查看：[获取简历评估信息](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/evaluation/list)
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	人才 ID，详情请查看：[获取人才信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/hire-v2/talent/get)
	</md-dt-td>
</md-dt-tr>
