...
根据投递 ID 获取 Offer 信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=application&method=offer)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/applications/:application_id/offer</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	投递ID，可通过[获取投递列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/application/list)获取
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >application_offer</md-text>
	</md-dt-td>
	<md-dt-td>
	Offer数据
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >社招offer</md-enum-item>
<md-enum-item key="2" >校招offer</md-enum-item>
<md-enum-item key="3" >实习offer</md-enum-item>
<md-enum-item key="4" >实习生转正offer</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	自定义字段的 value 信息，详情可参考：[获取 Offer 申请表信息](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/offer_application_form/get) 中的自定义字段
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	当前 Offer 使用的 schema ID，详情可参考：[获取 Offer 申请表信息](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/offer_application_form/get)
	</md-dt-td>
</md-dt-tr>
...
**可选值有**：
<md-enum>
<md-enum-item key="0" >所有</md-enum-item>
...
<md-dt-tr level="4">
	...
	<md-dt-td>
	自定义字段Value（值为人员ID的自定义字段 value 暂不支持ID转换，会以 people_admin_id 类型返回）
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	offer 发送记录列表（灰度中，如需使用请联系客户经理申请灰度）
	</md-dt-td>
</md-dt-tr>
