...
根据投递 ID 添加该投递下的笔试结果。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=exam&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/exams</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >exam_resource_name</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	报告附件 ID，可通过[创建附件](/ssl:ttdoc/ukTMukTMukTM/uIDN1YjLyQTN24iM0UjN/create_attachment)上传报告附件，生成对应附件 ID。
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	添加人用户 id，与入参`user_id_type` 保持一致
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	投递 ID，如何获取投递信息请参考[获取投递信息](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/application/get)
	</md-dt-td>
</md-dt-tr>
