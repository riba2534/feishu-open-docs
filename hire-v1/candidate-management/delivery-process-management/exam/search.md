---
title: "获取笔试列表"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/test/search"
updateTime: "1735216886000"
---
...
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 开启任一权限即可 | `hire:exam` 更新笔试信息 `hire:exam:readonly` 获取笔试信息 |
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `application_id_list` | `string\[\]` | 否 | 投递 ID 列表，可通过[获取投递信息](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/application/get)接口获取<br>**示例值**：["7230753910687080000"]<br>**数据校验规则**：<br>- 最大长度：`100` |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `talent_id` | `string` | 人才 ID，详情请参考[获取人才详情](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/hire-v2/talent/get) |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `job_id` | `string` | 职位 ID，详情请参考[获取职位详情](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job/get_detail) |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `reply_status` | `int` | 笔试答复状态<br>**可选值有**：<br>- `1`: 已接受 - `2`: 已拒绝 - `3`: 未反馈 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `test_status` | `int` | 笔试状态<br>**可选值有**：<br>- `1`: 未安排 - `2`: 未作答 - `3`: 已作答 - `4`: 待阅卷 - `5`: 通过 - `6`: 不通过 - `7`: 安排失败 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `result_upload_time` | `string` | 笔试结果上传时间（毫秒时间戳）<br>**注意**： 只有手动录入的笔试成绩才有 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `score` | `string` | 阅卷得分 |
