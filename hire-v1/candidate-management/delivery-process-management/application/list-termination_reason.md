...
获取系统中默认的投递终止原因以及用户配置的自定义投递终止原因。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=termination_reason&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/termination_reasons</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >termination_reason\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	列表
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >referral_name</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >i18n</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >is_used_as_evaluation</md-text>
	</md-dt-td>
	<md-dt-td>
