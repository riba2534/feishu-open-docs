...
获取候选人的申请表附加信息。支持通过投递 ID 或者人才 ID 进行查询。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=diversity_inclusion&method=search)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/applications/diversity_inclusions/search</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >talent_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	...
	<md-dt-td>
	人才 ID 列表，如何获取人才 ID 请参考[获取人才列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/talent/list)
<br>
**特殊说明：**
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	投递 ID 列表，如何获取投递 ID 请参考[获取投递列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/application/list)
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >di_info\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	申请表附加信息列表
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >官网</md-enum-item>
<md-enum-item key="2" >详情页</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >di_data</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >di_data\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	附加信息
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >object_attribute</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >object_attribute</md-text>
	</md-dt-td>
	<md-dt-td>
	字段属性
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >单选</md-enum-item>
<md-enum-item key="2" >多选</md-enum-item>
<md-enum-item key="3" >月份选择</md-enum-item>
<md-enum-item key="4" >年份选择</md-enum-item>
<md-enum-item key="5" >数字</md-enum-item>
<md-enum-item key="6" >文本</md-enum-item>
<md-enum-item key="7" >多行文本</md-enum-item>
<md-enum-item key="8" >日期范围</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >is_fcf_data</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >is_di_data</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >boolean</md-text>
	</md-dt-td>
