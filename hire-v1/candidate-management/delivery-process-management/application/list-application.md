...
获取投递列表信息。可根据「招聘流程 ID」、「招聘阶段 ID」、「人才 ID」、「职位 ID」、「投递活跃状态」以及「投递更新时间」进行条件筛选。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=application&method=list)
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	招聘流程 ID，可通过[获取招聘流程信息](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job_process/list)接口中的「流程 ID」获取
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	招聘阶段 ID，可通过[获取招聘流程信息](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job_process/list)接口每个流程下的「阶段列表」获取
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	投递 ID 列表，详情请参考：[获取投递信息](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/application/get)
	</md-dt-td>
</md-dt-tr>
