---
title: "转移投递阶段"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/application/transfer_stage"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| `application_id` | `string` | 投递 ID，可通过[获取投递列表](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/application/list)接口获取<br>**示例值**："6960663240925956401" |
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `stage_id` | `string` | 是 | 要转移到的阶段 ID，可通过[获取招聘流程信息](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job_process/list)接口获取<br>**示例值**："6960663240925956402" |
