---
title: "获取简历评估信息列表"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/evaluation/list"
updateTime: "1725443497000"
---
...
| `application_id` | `string` | 否 | 投递 ID，可通过[获取投递列表](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/application/list)接口获取<br>**示例值**：6875569957036738823 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `stage_id` | `string` | 投递阶段 ID，详情请查看：[获取招聘流程信息](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job_process/list)接口返回结果中 `data.items.stage_list` 字段 |
