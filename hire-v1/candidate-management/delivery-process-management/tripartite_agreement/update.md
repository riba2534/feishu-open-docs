---
title: "更新三方协议"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/tripartite_agreement/update"
updateTime: "1745502615000"
---

# 更新三方协议

更新三方协议的状态及修改时间信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=tripartite_agreement&method=update)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/tripartite_agreements/:tripartite_agreement_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >tripartite_agreement_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
	<md-dt-td>
	三方协议 ID，可通过[获取三方协议](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/tripartite_agreement/list)获取
...
<md-tr>
  ...
  <md-td>1002075</md-td>
  <md-td>三方协议不存在</md-td>
  <md-td>tripartite_agreement_id 不合法，请检查入参 `tripartite_agreement_id` 是否正确</md-td>
</md-tr>
