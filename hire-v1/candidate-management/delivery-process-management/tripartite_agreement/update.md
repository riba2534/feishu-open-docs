...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| `tripartite_agreement_id` | `string` | 三方协议 ID，可通过[获取三方协议](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/tripartite_agreement/list)获取<br>**示例值**："7084008015948283905" |
