---
title: "获取三方协议"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/tripartite_agreement/list"
updateTime: "1724834814000"
---
...
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 开启任一权限即可 | `hire:tripartite_agreement` 更新三方协议 `hire:tripartite_agreement:readonly` 查看三方协议信息 |
...
| `application_id` | `string` | 否 | 投递 ID，可通过[获取投递列表](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/application/list)接口获取<br>**示例值**：6930815272790114324 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `state` | `int` | 三方协议状态<br>**可选值有**：<br>- `1`: 未开始 - `2`: 已申请 - `3`: 学生处理中 - `4`: 公司处理中 - `5`: 学校处理中 - `6`: 已终止 - `7`: 已完成 - `8`: 解约处理中 - `9`: 已解约 |
