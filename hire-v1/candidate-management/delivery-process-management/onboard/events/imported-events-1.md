...
> 
> 
> - 可以使用`offer_id ` [更新实习 Offer 入/离职状态](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/offer/intern_offer_status)
...
| &nbsp;&nbsp;└ `offer_id` | `string` | Offer ID，详情请参考[获取 Offer 详情](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/offer/get) |
