...
通过投递 ID 获取员工入职信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=employee&method=get_by_application)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/employees/get_by_application</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >external_employment_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1002903</md-td>
  <md-td>Employee does not exist</md-td>
