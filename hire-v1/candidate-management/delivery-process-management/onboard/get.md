...
通过员工 ID 获取入职信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=employee&method=get)
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	员工ID，可通过[通过投递 ID 获取入职信息](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/employee/get_by_application)接口获取
...
<md-enum-item key="people_admin_department_id" >以 people_admin_department_id 来标识部门，该 ID 类型即将下线，不推荐使用</md-enum-item>
</md-enum>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	办公地点 Code 码，详情请查看[「查询地点列表」](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/location/query)接口
	</md-dt-td>
</md-dt-tr>
