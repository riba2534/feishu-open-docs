...
根据投递 ID 或背调更新时间批量获取背调订单信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=background_check_order&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/background_check_orders</md-td>
    </md-tr>
    <md-tr>
...
<md-enum-item key="2" >i背调</md-enum-item>
