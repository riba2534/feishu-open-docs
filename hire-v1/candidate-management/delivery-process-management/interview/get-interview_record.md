---
title: "获取面试评价详细信息"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/interview_record/get"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| `interview_record_id` | `string` | 面试评价 ID，可通过[获取面试信息](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/interview/list)接口获取<br>**示例值**："1618209327096" |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `id` | `string` | 图片附件 ID，详情请参考[获取附件信息](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/attachment/get) |
