...
获取面试评价详细信息，如面试结论、面试得分和面试官等信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=interview_record&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/interview_records/:interview_record_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	图片附件 ID，详情请参考[获取附件信息](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/attachment/get)
	</md-dt-td>
</md-dt-tr>
