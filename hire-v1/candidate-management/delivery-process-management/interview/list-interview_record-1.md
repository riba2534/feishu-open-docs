...
批量获取面试评价详细信息，如面试结论、面试得分和面试官等信息（含模块评价）。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v2&resource=interview_record&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v2/interview_records</md-td>
    </md-tr>
    <md-tr>
