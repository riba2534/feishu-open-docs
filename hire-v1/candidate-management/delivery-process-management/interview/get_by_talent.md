...
获取人才下所有面试信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=interview&method=get_by_talent)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/interviews/get_by_talent</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >talent_interview\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	投递面试列表
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >interview_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >interview_extend\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	面试列表
	</md-dt-td>
...
<md-dt-tr level="4">
	...
	<md-dt-td>
	面试评价 ID，详情可参考：[获取面试评价详细信息（新版）](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/hire-v2/interview_record/get)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="4">
	...
	<md-dt-td>
	系统预设题目内容，来自「飞书招聘」-「设置」-「面试设置」-「面试评价表设置」的面试评价表中预设字段「记录」，详情参考[获取面试评价表列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/interview_feedback_form/list)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="5">
	...
	<md-dt-td>
	面试评分 ID，对应[获取面试评价表列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/interview_feedback_form/list)接口返回数据中的 `data.items.modules.dimensions.option_items.id` 字段
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	面试关联的投递阶段，详情请查看：[获取招聘流程信息](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job_process/list)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	投递 ID，详情参考[获取投递信息](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/external_application/create)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >biz_create_time</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >biz_modify_time</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	<md-text type="field-type" >interview_address</md-text>
	</md-dt-td>
	<md-dt-td>
	面试地址
	</md-dt-td>
...
<md-dt-tr level="4">
	...
	<md-dt-td>
	地址 ID，可通过[获取地址列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/location/list)获取
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="4">
	...
	<md-dt-td>
	会议室 ID，详情可查看：[查询会议室列表](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/room/list)
...
<md-tr>
  ...
  <md-td>1002001</md-td>
  <md-td>系统错误</md-td>
  <md-td>根据实际报错信息定位或咨询[技术支持](https://applink.feishu.cn/TLJpeNdW)。</md-td>
</md-tr>
