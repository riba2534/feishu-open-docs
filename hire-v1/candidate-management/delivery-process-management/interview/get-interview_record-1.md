...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| `interview_record_id` | `string` | 面试评价 ID，可通过[获取面试信息](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/interview/list)接口获取<br>**示例值**："7171693733661327361" |
