---
title: "获取面试评价详细信息（新版）"
fullPath: "/uAjLw4CM/ukTMukTMukTM/hire-v2/interview_record/get"
updateTime: "1765445656000"
---

# 获取面试评价信息（新版）

获取面试评价详细信息，如面试结论、面试得分和面试官等信息（含模块评价）。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v2&resource=interview_record&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v2/interview_records/:interview_record_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >interview_record_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
	<md-dt-td>
	面试评价 ID，可通过[获取面试信息](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/interview/list)接口获取
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >interview_record</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	面试评价表 ID，详情可查看：[获取面试评价表列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/interview_feedback_form/list)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	面试评价表模块 ID，详情可查看：[获取面试评价表列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/interview_feedback_form/list)返回结果中 `data.items.modules` 字段
...
<md-enum-item key="2" >自定义模块</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="5">
	...
	<md-dt-td>
	选项 ID，详情可查看：[获取面试评价表列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/interview_feedback_form/list)返回结果中 `data.items.modules.dimensions.option_items` 字段
	</md-dt-td>
</md-dt-tr>
