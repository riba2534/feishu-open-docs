...
获取面试信息。可通过「投递 ID」、「面试 ID」以及「面试开始时间」进行条件筛选，筛选条件不能同时为空。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=interview&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/interviews</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	投递 ID，可通过[获取投递列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/application/list)接口获取（不允许 application_id、interview_id、start_time、end_time 同时为空）
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	系统预设题目内容，来自面试评价表中预设字段「记录」，详情参考[获取面试评价表列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/interview_feedback_form/list)
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	面试轮次类型，详情可查看：[获取面试轮次类型列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/interview_round_type/list)
	</md-dt-td>
</md-dt-tr>
