...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| `note_id` | `string` | 备注 ID，可通过[获取备注列表](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/note/list)获取<br>**示例值**："6949805467799537964" |
...
| &nbsp;&nbsp;└ `note` | `note` | 人才备注信息 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `id` | `string` | 备注 ID |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `talent_id` | `string` | 人才 ID，详情请参考：[获取人才信息 ](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/talent/get) |
