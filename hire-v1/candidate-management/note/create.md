---
title: "创建备注"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/note/create"
updateTime: "1720621988000"
---

# 创建备注

为人才创建备注信息，支持在备注中@其他用户。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=note&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/notes</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	创建人ID，请传入与`user_id_type`相匹配的ID
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >notify_mentioned_user</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >mention_entity_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >mention_entity\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	否
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >note</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >note</md-text>
	</md-dt-td>
	<md-dt-td>
	备注信息
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >is_private</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >boolean</md-text>
	</md-dt-td>
