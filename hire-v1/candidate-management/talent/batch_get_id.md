---
title: "批量获取人才ID"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/talent/batch_get_id"
updateTime: "1725615241000"
---
...
| `identification_type` | `int` | 否 | 证件类型，枚举定义详见文档：[枚举常量介绍](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/enum) 的 IdentificationType。传入证件号的情况下必须传入该参数<br>**示例值**：1 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `identification_type` | `int` | 证件类型，枚举定义详见文档：[枚举常量介绍](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/enum) 的 IdentificationType，仅当入参传入`identification_number_list `时返回 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `identification_number` | `string` | 证件号，仅当入参传入`identification_number_list `时返回 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `is_onboarded` | `boolean` | 是否已入职<br>**可选值有**：<br>- `false`: 未入职 - `true`: 已入职<br>**字段权限要求**： `hire:talent_onboard_status:readonly` 获取人才入职状态 |
