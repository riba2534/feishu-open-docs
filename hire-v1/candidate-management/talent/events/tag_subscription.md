...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>hire.talent.tag_subscription_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	人才 ID，详情可参考[获取人才详情](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/hire-v2/talent/get)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	投递 ID，详情可参考[获取投递信息](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/application/get)
	</md-dt-td>
</md-dt-tr>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >阶段变更</md-enum-item>
<md-enum-item key="2" >锁定</md-enum-item>
<md-enum-item key="3" >解锁</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	标签 ID，可通过以下接口
获取人才标签信息[
获取人才标签信息列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/talent_tag/list)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >lock_status</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >未锁定</md-enum-item>
<md-enum-item key="2" >锁定在其他职位</md-enum-item>
<md-enum-item key="3" >锁定在当前职位</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >application_stage</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	阶段 ID，可通过以下接口获取投递阶段信息[获取招聘流程信息](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job_process/list)
	</md-dt-td>
</md-dt-tr>
