...
根据人才 ID 将人才加入或移除屏蔽名单。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=talent_blocklist&method=change_talent_block)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/talent_blocklist/change_talent_block</md-td>
    </md-tr>
    <md-tr>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >加入屏蔽名单</md-enum-item>
<md-enum-item key="2" >从屏蔽名单中移除</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
