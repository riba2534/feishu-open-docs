...
获取全部招聘流程信息。如「流程名称」、「流程类型」及流程下的「阶段名称」、「阶段类型」等信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=job_process&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/job_processes</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="hire:job_process:readonly" desc="获取招聘流程信息" support_app_types="custom,isv" tags="">获取招聘流程信息</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >job_processes\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	流程列表
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >stage_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >job_processes_stage\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	阶段列表
	</md-dt-td>
