...
关闭职位后，职位所有的职位广告将同步从官网、内推、猎头渠道下线。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=job&method=close)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/jobs/:job_id/close</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  ...
  <md-td>1002609</md-td>
  <md-td>职位已关闭</md-td>
  <md-td>职位已关闭，请通过[获取职位信息](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job/get)接口排查</md-td>
</md-tr>
