---
title: "获取职位上的招聘人员信息"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job/recruiter"
updateTime: "1725597272000"
---

# 获取职位上的招聘人员信息

根据职位 ID 获取职位上的招聘人员信息，如招聘负责人、用人经理等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=job&method=recruiter)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/jobs/:job_id/recruiter</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >info</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >job_recruiter2</md-text>
	</md-dt-td>
	<md-dt-td>
	职位招聘人员信息
	</md-dt-td>
...
<md-tr>
  ...
  <md-td>1002601</md-td>
  <md-td>职位不存在</md-td>
  <md-td>检查入参`job_id `填写是否正确</md-td>
</md-tr>
