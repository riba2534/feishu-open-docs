...
根据职位 ID 获取职位信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=job&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/jobs/:job_id</md-td>
    </md-tr>
    <md-tr>
...
**可选值有**：
<md-enum>
<md-enum-item key="open_department_id" >开放平台部门ID</md-enum-item>
<md-enum-item key="department_id" >内部部门ID</md-enum-item>
</md-enum>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >JuniorMiddleSchoolEducation</md-enum-item>
