---
title: "更新职位相关人员"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job-manager/batch_update"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| `job_id` | `string` | 职位 ID，可通过[获取职位列表](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job/list)接口获取<br>**示例值**："7096318853365369132" |
...
| `update_option_list` | `int\[\]` | 是 | 更新的人员类型<br>**示例值**：[1]<br>**可选值有**：<br>- `1`: 招聘负责人 - `2`: 招聘协助人 - `3`: 用人经理 |
