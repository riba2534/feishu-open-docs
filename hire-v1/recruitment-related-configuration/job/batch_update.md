...
更新职位相关人员，包含招聘负责人、招聘协助人、用人经理。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=job.manager&method=batch_update)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/jobs/:job_id/managers/batch_update</md-td>
    </md-tr>
    <md-tr>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >招聘负责人</md-enum-item>
<md-enum-item key="2" >招聘协助人</md-enum-item>
<md-enum-item key="3" >用人经理</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	招聘协助人 ID 列表，与入参`user_id_type`类型一致
	</md-dt-td>
</md-dt-tr>
