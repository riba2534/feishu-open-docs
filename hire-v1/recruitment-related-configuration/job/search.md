---
title: "获取职位广告发布记录"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job_publish_record/search"
updateTime: "1725955133000"
---

# 获取职位广告发布记录

根据招聘渠道 ID 获取当前渠道下曾发布过的职位广告信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=job_publish_record&method=search)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/job_publish_records/search</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >job_channel_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
	...
	<md-dt-td>
	招聘渠道 ID
- 官网 ID：可通过[获取招聘官网列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/website/list)接口获取
- 三方渠道 ID：可通过[枚举常量介绍](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/enum)中「三方渠道 ID」枚举定义
- 猎头渠道 ID ： "2"
- 内推渠道 ID ： "3"
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	职位广告 ID，详情请查看：[获取招聘官网下职位广告详情](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/website-job_post/get)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	职位雇佣类型 ID，详情请查看：[枚举常量介绍](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/enum)中职位性质/雇佣类型（recruitment_type）枚举定义
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	工作地址 ID，详情可查看：[获取地址列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/location/list)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	职位亮点 ID，详情请查看：[枚举常量介绍](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/enum)中「职位亮点枚举定义」
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	自定义字段 ID，详情请查看：[获取职位模板](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job_schema/list)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="4">
	...
	<md-dt-td>
	当字段类型为`单行文本`、`多行文本`、`默认字段`时，从此字段取值
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="4">
	...
	<md-dt-td>
	当字段类型为`日期选择`、`月份选择`、`年份选择`时，从此字段取值，该字段是毫秒级时间戳
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >job_sequence_info</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >id_name_object</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	币种，详情请参考：[枚举常量介绍](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/enum)中币种（currency）枚举定义」
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	目标专业 ID，「0」 为不限专业，其他情况可通过[「根据主数据编码批量获取专业」](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/mdm-v3/batch_major/get)获取专业详情
	</md-dt-td>
</md-dt-tr>
