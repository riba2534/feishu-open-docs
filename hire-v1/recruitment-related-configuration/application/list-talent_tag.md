---
title: "获取人才标签信息列表"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/talent_tag/list"
...
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 开启任一权限即可 | `hire:talent_tag` 更新人才标签 `hire:talent_tag:readonly` 获取人才标签 |
...
| `type` | `int` | 否 | 标签类型<br>**示例值**：1<br>**可选值有**：<br>- `1`: 手动标签 - `2`: 自动标签 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `active_status` | `int` | 启停用状态<br>**可选值有**：<br>- `1`: 启用 - `2`: 停用 |
