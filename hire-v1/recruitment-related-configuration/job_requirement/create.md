...
创建招聘需求，可指定招聘需求部门、招聘人数、需求描述等，具体可参考「飞书招聘」-「设置」-「招聘需求字段管理」，或者参考[获取招聘需求模板](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job_requirement_schema/list)。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=job_requirement&method=create)
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	工作地址 ID，可通过[获取地址列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/location/list)获取
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	自定义字段，可通过[获取招聘需求模板](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job_requirement_schema/list)获取自定义字段列表、类型等
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >job_requirement</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	职位性质 ，可在[枚举常量介绍](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/enum)文档中查看枚举值，建议使用`employee_type`字段
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	人员类型 ID，与`employee_type_id_type`类型一致
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	最高职级 ID，与`job_level_id_type`类型一致
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	最低职级 ID，与`job_level_id_type`类型一致
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	职位序列 ID，与`job_family_id_type`类型一致
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	需求部门 ID，与`department_id_type`类型一致
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	工作地址 ID，详情请参考：[获取地址列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/location/list)获取
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	自定义字段 ID，详情请参考：[获取招聘需求模板](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job_requirement_schema/list)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	岗位ID，详情请查看：[查询岗位信息](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/position/query)
	</md-dt-td>
</md-dt-tr>
...
<md-tr>
  <md-td>500</md-td>
  <md-td>1002701</md-td>
  <md-td>不允许通过OpenAPI进行新建、编辑、删除招聘需求</md-td>
  <md-td>若要通过OpenAPI管理招聘需求，请通过「飞书招聘」-「设置」-「招聘需求管理」-「招聘需求设置」开启「通过API新建、编辑、删除招聘需求」</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1002702</md-td>
  <md-td>招需需求编号重复</md-td>
  <md-td>请检查`short_code`参数</md-td>
</md-tr>
