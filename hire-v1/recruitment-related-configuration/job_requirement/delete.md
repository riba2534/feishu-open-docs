...
删除指定的招聘需求，请注意：若该招聘需求已经关联到职位上，则需先接触关联后，才能删除招聘需求。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=job_requirement&method=delete)
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1002704</md-td>
  <md-td>招聘需求不可被删除</md-td>
  <md-td>请检查该招聘需求是否有关联的职位，可通过[获取招聘需求信息](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job_requirement/list_by_id)接口排查</md-td>
</md-tr>
