---
title: "获取用户角色列表"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/user_role/list"
updateTime: "1724985067000"
---
...
| `role_id` | `string` | 否 | 角色 ID，可通过接口 [获取角色列表](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/role/list) 获取<br>**示例值**：101 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `role_id` | `string` | 角色 ID，可通过接口 [获取角色列表](https://open.larkoffice.com/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/role/list) 获取 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `rule_type` | `int` | 规则类型<br>**可选值有**：<br>- `0`: 无数据权限 - `1`: 全部数据权限 - `2`: 按规则制定范围 |
