---
title: "获取角色列表"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/role/list"
updateTime: "1720602031000"
---
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `zh_cn` | `string` | 中文 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `en_us` | `string` | 英文 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `scope_of_application` | `int` | 适用范围<br>**可选值有**：<br>- `1`: 社招 - `2`: 校招 - `3`: 都包含（适用于新版权限） |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `modify_time` | `string` | 更新时间，单位ms的Unix时间戳 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `role_status` | `int` | 停启用状态<br>**可选值有**：<br>- `1`: 启用 - `2`: 停用 |
