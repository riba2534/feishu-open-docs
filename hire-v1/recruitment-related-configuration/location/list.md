---
title: "获取地址列表"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/location/list"
updateTime: "1724999548000"
---
...
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 | `hire:location:readonly` 获取招聘相关位置信息 |
...
| `usage` | `string` | 是 | 地址类型<br>**示例值**：interview_location<br>**可选值有**：<br>- `position_location`: 职位地址 - `interview_location`: 面试地址 - `store_location`: 门店地址。当前仅支持未接入飞书人事的租户使用 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `zh_cn` | `string` | 国家中文名称 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `en_us` | `string` | 国家英文名称 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `active_status` | `int` | 地址启用状态<br>**可选值有**：<br>- `1`: 已启用 - `2`: 已禁用 |
