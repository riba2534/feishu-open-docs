---
title: "查询地点列表"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/location/query"
updateTime: "1720776337000"
---
...
| `location_type` | `int` | 是 | 地点类型<br>**示例值**：1<br>**可选值有**：<br>- `1`: 国家类型 - `2`: 省份/州类型 - `3`: 市类型 - `4`: 区类型 |
