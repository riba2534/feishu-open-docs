...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>application.bot.menu_v6</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
    ...
    <md-tr>
      ...
      <md-td>
        ...
        <md-perm name="application:application.bot.operator_name:readonly" desc="获取机器人自定义菜单操作人名称" support_app_types="custom,isv" tags="">获取机器人自定义菜单操作人名称</md-perm>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >operator_name</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >event_key</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >int64</md-text>
	</md-dt-td>
	<md-dt-td>
	用户点击菜单时间
