---
title: "录入身份信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/human_authentication-v1/identity/create"
updateTime: "1730444380000"
---
...
> **Tip**: 实名认证接口会有计费管理，接入前请联系飞书开放平台工作人员，邮箱：open-platform@bytedance.com。
> 
...
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 | `human_authentication:identity` 创建和编辑实名认证主体 |
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `user_id` | `string` | 是 | 用户的唯一标识（使用的ID类型见下一参数描述，不同ID类型的区别和获取，参考文档：[如何获得 User ID、Open ID 和 Union ID？](https://open.larkoffice.com/document/home/user-identity-introduction/how-to-get)）<br>**示例值**：ou_2eb5483cb377daa5054bc6f86e2089a5 |
