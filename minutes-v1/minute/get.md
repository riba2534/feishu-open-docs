...
通过这个接口，可以得到一篇妙记的基础概述信息，包含 `owner_id`、`create_time`、标题、封面、时长和 URL。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=minutes&version=v1&resource=minute&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/minutes/v1/minutes/:minute_token</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            ...
            <md-perm name="minutes:minutes.basic:read" desc="获取妙记的基本信息" support_app_types="custom,isv" tags="">获取妙记的基本信息</md-perm>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >minute</md-text>
	</md-dt-td>
	<md-dt-td>
	妙记基本信息
	</md-dt-td>
