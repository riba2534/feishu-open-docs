...
词典管理员审核通过后，草稿将变为新的词条或覆盖已有词条。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=baike&version=v1&resource=draft&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/baike/v1/drafts</md-td>
    </md-tr>
    <md-tr>
