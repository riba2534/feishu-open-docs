...
> **Error**: 为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/lingo-v1/entity/match)
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `type` | `int` | 命中的字段<br>**可选值有**：<br>- `0`: 词条名 - `1`: 全称 - `2`: 别名 |
