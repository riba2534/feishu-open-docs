---
title: "更新免审词条"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/baike-v1/entity/update"
...
因此，调用该接口时应当慎重操作。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=baike&version=v1&resource=entity&method=update)
