---
title: "获取词条列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/baike-v1/entity/list"
updateTime: "1697163789000"
---

# 获取词条列表

分页拉取词条列表数据，支持拉取租户内的全部词条。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=baike&version=v1&resource=entity&method=list)
