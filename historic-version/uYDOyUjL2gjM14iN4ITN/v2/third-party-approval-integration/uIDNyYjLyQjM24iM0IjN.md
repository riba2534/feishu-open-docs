...
> **Error**: 为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/external_approval/create)
...
| ∟ `       action_callback_token` | 回调时带的 token， 用于业务系统验证请求来自审批,具体参考 [开放平台文档](https://open.larkoffice.com/document/ukTMukTMukTM/uUTNz4SN1MjL1UzM) | sdjkljkx9lsadf110 |  |
| ∟ `       action_callback_key` | 请求参数加密密钥，如果配置了该参数，则会对请求参数进行加密，业务需要对请求进行解密，加解密算法参考[关联外部选项说明](https://open.larkoffice.com/document/ukTMukTMukTM/uADM4QjLwADO04CMwgDN) | gfdqedvsadfgfsd |  |
