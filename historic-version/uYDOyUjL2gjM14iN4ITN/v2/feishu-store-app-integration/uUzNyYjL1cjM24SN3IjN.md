---
title: "创建审批定义"
fullPath: "/ukTMukTMukTM/uUzNyYjL1cjM24SN3IjN"
updateTime: "1698893404000"
---

# 创建审批定义
:::html
<md-alert type="error">
为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/approval/create)
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://www.feishu.cn/approval/openapi/v2/approval/create</md-td>
    </md-tr>
    <md-tr>
...
case2: 联动外部数据源单选/多选：[【关联外部选项说明】](/ssl:ttdoc/ukTMukTMukTM/uADM4QjLwADO04CMwgDN)
```
{
    "id":"",
    "name":"",
