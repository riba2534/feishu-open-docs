...
> **Error**: 为了更好地提升接口文档的的易理解性，我们对文档进行了升级，请尽快迁移至[新版本>>](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/approval/create)
...
case2: 联动外部数据源单选/多选：[【关联外部选项说明】](https://open.larkoffice.com/document/ukTMukTMukTM/uADM4QjLwADO04CMwgDN)
```
{
    "id":"",
    "name":"",
