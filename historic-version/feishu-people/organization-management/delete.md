...
可以通过该接口通过部门ID删除一个部门记录{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=department&method=delete)
...
:::html
<md-alert type="tip">
该接口不再推荐使用，请使用[【删除部门】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/department/delete)接口。
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	需要删除的部门 ID，可通过[【搜索部门信息】](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/department/search)接口查询获得
