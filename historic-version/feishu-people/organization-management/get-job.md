---
title: "查询单个职务"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/job/get"
updateTime: "1726231094000"
---
...
> **Error**: 本接口不再推荐使用，请使用[查询单个职务V2](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/job/get)接口。
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `job_family_id_list` | `string\[\]` | 职务序列 ID 列表，枚举值及详细信息可通过[【批量查询序列】](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/job_family/list)接口查询获得 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `job_level_id_list` | `string\[\]` | 职务级别 ID 列表，枚举值及详细信息可通过[【批量查询职级】](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/job_level/list)接口查询获得 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `effective_time` | `string` | 生效时间 - 返回格式：YYYY-MM-DD 00:00:00（最小单位到日） - 日期范围:1900-01-01 00:00:00～9999-12-31 23:59:59 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `expiration_time` | `string` | 失效时间 - 返回格式：YYYY-MM-DD 00:00:00（最小单位到日） - 日期范围:1900-01-01 00:00:00～9999-12-31 23:59:59 |
