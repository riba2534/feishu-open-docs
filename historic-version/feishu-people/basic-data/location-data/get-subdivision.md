...
查询单条省份/行政区信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=subdivision&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v1/subdivisions/:subdivision_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >subdivision</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >subdivision</md-text>
	</md-dt-td>
	<md-dt-td>
	国家/地址信息
	</md-dt-td>
