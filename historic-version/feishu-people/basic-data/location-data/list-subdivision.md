---
title: "批量查询省份/行政区信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/subdivision/list"
updateTime: "1689316827000"
---

# 批量查询省份/行政区信息

批量查询省份/行政区信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=corehr&version=v1&resource=subdivision&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/corehr/v1/subdivisions</md-td>
    </md-tr>
    <md-tr>
