...
:::html
<md-alert type="warn">
注意：该事件缺少数据范围控制和直接离职消息，不推荐使用该事件。优先使用[离职申请状态变更（新）](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/offboarding/events/status_updated)
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>corehr.offboarding.updated_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
<md-enum-item key="5" >已生效（生效日期后自动生效）</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
