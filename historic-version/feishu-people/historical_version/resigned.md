...
:::html
<md-alert type="warn">
注意：监听到该消息不一定能立刻通过[搜索离职信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/offboarding/search)搜索到对应的离职信息，这中间存在数据延时。推荐监听[离职申请状态变更（新）
](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/corehr-v2/offboarding/events/status_updated)
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>corehr.employment.resigned_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
