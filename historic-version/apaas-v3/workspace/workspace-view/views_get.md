---
title: "查询视图数据记录"
fullPath: "/uAjLw4CM/ukTMukTMukTM/apaas-v1/workspace-view/views_get"
updateTime: "1764571080000"
---
...
| 支持的应用类型 | custom |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 | `app_engine:workspace.table.record:read` 读取数据表数据记录 |
