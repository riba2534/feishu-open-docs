---
title: "执行SQL"
fullPath: "/uAjLw4CM/ukTMukTMukTM/apaas-v1/workspace/sql_commands"
updateTime: "1764571100000"
---
...
| 支持的应用类型 | custom |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 | `app_engine:workspace.sql_commands:write` 在工作空间下执行 SQL 语句 |
