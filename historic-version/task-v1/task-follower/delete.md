---
title: "删除指定关注人"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/task-v1/task-follower/delete"
updateTime: "1689215606000"
---

# 删除指定关注人

该接口用于删除任务关注人。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v1&resource=task.follower&method=delete)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/task/v1/tasks/:task_id/followers/:follower_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >follower_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1470710</md-td>
  <md-td>no task followers found</md-td>
  <md-td>任务关注者没有找到，请检查提供的关注人 ID 是否有效</md-td>
</md-tr>
...
<md-tr>
  <md-td>500</md-td>
  <md-td>1470712</md-td>
  <md-td>failed to delete task followers</md-td>
  <md-td>移除任务关注人失败，请结合返回的具体错误进行排查。如果无法解决，请提供 request id 并联系飞书技术人员协助排查</md-td>
</md-tr>
