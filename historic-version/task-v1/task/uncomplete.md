---
title: "取消完成任务"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/task-v1/task/uncomplete"
updateTime: "1689215604000"
---

# 取消完成任务

该接口用于取消任务的已完成状态。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v1&resource=task&method=uncomplete)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/task/v1/tasks/:task_id/uncomplete</md-td>
    </md-tr>
    <md-tr>
