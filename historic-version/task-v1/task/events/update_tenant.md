---
title: "任务信息变更（租户维度）"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/task-v1/task/events/update_tenant"
updateTime: "1671785840000"
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>task.task.update_tenant_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
    ...
    <md-th>
      ...
      <md-td>
            <md-perm name="task:task.event_update_tenant:readonly" desc="租户维度下任务变更事件订阅" support_app_types="custom,isv" tags="">租户维度下任务变更事件订阅</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>推送方式</md-th>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >user_id_list</md-text>
	</md-dt-td>
	<md-dt-td>
	用户 ID 列表
	</md-dt-td>
