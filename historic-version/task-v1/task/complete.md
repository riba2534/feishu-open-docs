...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| `task_id` | `string` | 任务 ID，可通过[创建任务](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/task-v1/task/create)时响应体中的id字段获取<br>**示例值**："bb54ab99-d360-434f-bcaa-a4cc4c05840e" |
