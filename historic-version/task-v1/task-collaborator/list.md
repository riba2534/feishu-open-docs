---
title: "获取执行者列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/task-v1/task-collaborator/list"
updateTime: "1713178781000"
---

# 获取执行者列表

该接口用于查询任务执行者列表，支持分页，最大值为50。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v1&resource=task.collaborator&method=list)
