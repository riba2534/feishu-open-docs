...
该接口用于通过评论ID获取评论详情。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v1&resource=task.comment&method=get)
  ...
  <md-tbody>
    ...
    <md-tr>
      ...
      <md-td>
            ...
            <md-perm name="task:comment:readonly" desc="查看任务评论（历史版本）" support_app_types="custom,isv" tags="">查看任务评论（历史版本）</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
