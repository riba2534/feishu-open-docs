...
该接口用于更新评论内容。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v1&resource=task.comment&method=update)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/task/v1/tasks/:task_id/comments/:comment_id</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  <md-td>500</md-td>
  <md-td>1470732</md-td>
  <md-td>failed to patch comment</md-td>
  <md-td>一般是更新评论时系统内部逻辑处理出现问题，可根据具体错误进行分析，无法解决时请找相关服务的同学处理</md-td>
</md-tr>
