---
title: "更新评论"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/task-v1/task-comment/update"
...
| `rich_content` | `string` | 否 | 新的富文本评论内容（优先使用）<br>**示例值**："飞流直下三千尺，疑是银河落九天"<br>**数据校验规则**：<br>- 长度范围：`0` ～ `65536` 字符 |
