...
| 项目 | 值 |
| --- | --- |
| HTTP URL | https://open.feishu.cn/open-apis/meeting_room/room/list?building_id=omb_8ec170b937536a5d87c23b418b83f9bb&page_size=1&page_token=0ℴ_by=name-asc&fields=* |
| HTTP Method | GET |
| 支持的应用类型 | custom,isv |
