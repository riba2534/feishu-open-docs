---
title: "查询会议室配置"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/room_config/query"
updateTime: "1721719963000"
---

# 查询会议室配置

查询一个范围内的会议室配置。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=room_config&method=query)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/vc/v1/room_configs/query</md-td>
    </md-tr>
    <md-tr>
