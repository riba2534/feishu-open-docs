...
| HTTP Method | GET |
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 | `vc:room:readonly` 获取视频会议室信息 |
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `scope` | `int` | 是 | 查询节点范围<br>**示例值**：5<br>**可选值有**：<br>- `1`: 租户 - `2`: 国家/地区 - `3`: 城市 - `4`: 建筑 - `5`: 楼层 - `6`: 会议室 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `name` | `string` | 素材名称 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `material_type` | `int` | 素材类型<br>**可选值有**：<br>- `1`: 图片 - `2`: 视频 - `3`: GIF |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `url` | `string` | 素材url |
