---
title: "更新下拉列表设置"
fullPath: "/uAjLw4CM/ukTMukTMukTM/historic-version/docs/sheets/datavalidation/update-datavalidation"
updateTime: "1755251560000"
---

# ~~更新下拉列表设置~~

**注意：该接口于 2025 年 9 月 20 号起不可用，请使用最新接口[更新下拉列表设置](https://open.larkoffice.com/document/ukTMukTMukTM/uATMzUjLwEzM14CMxMTN/datavalidation/update-datavalidation)，更多详情可查看[表格数据校验下拉列表相关接口变更](https://open.larkoffice.com/document/uAjLw4CM/ugTN1YjL4UTN24CO1UjN/breaking-change/datavalidation-dropdown-udpate)**。
...
| sheetId | string | 电子表格工作表的 ID。调用[获取工作表](https://open.larkoffice.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet/query)获取 ID。 |
| dataValidationId | int | 电子表格工作表中下拉列表的 ID。调用[查询下拉列表](https://open.larkoffice.com/document/ukTMukTMukTM/uATMzUjLwEzM14CMxMTN/datavalidation/query-datavalidation)获取 ID。 |
