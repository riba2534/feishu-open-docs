...
**注意：该接口于 2025 年 9 月 20 号起不可用，请使用最新接口[更新下拉列表设置](/ssl:ttdoc/ukTMukTMukTM/uATMzUjLwEzM14CMxMTN/datavalidation/update-datavalidation)，更多详情可查看[表格数据校验下拉列表相关接口变更](/ssl:ttdoc/uAjLw4CM/ugTN1YjL4UTN24CO1UjN/breaking-change/datavalidation-dropdown-udpate)**。
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/sheets/v2/spreadsheets/:spreadsheetToken/dataValidation/:sheetId/:dataValidationId</md-td>
    </md-tr>
    <md-tr>
...
**示例值**："BzY8T5"
    ...
    <md-tr>
<md-td>dataValidationId</md-td>
  <md-td>int</md-td>
  <md-td>电子表格工作表中下拉列表的 ID。调用[查询下拉列表](/ssl:ttdoc/ukTMukTMukTM/uATMzUjLwEzM14CMxMTN/datavalidation/query-datavalidation)获取 ID。
</md-td>
