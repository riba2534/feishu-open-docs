...
**注意：该接口于 2025 年 9 月 20 号起不可用，请使用最新接口[查询下拉列表设置](/ssl:ttdoc/ukTMukTMukTM/uATMzUjLwEzM14CMxMTN/datavalidation/query-datavalidation)，更多详情可查看[表格数据校验下拉列表相关接口变更](/ssl:ttdoc/uAjLw4CM/ugTN1YjL4UTN24CO1UjN/breaking-change/datavalidation-dropdown-udpate)**。
...
<md-dt-tr level="2">
<md-dt-td>
<md-text type="field-name">dataValidationId</md-text>
</md-dt-td>
<md-dt-td>
<md-text type="field-type">int</md-text>
</md-dt-td>
