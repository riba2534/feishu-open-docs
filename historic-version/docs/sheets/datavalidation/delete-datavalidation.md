...
**注意：该接口于 2025 年 9 月 20 号起不可用，请使用最新接口[删除下拉列表设置](https://open.larkoffice.com/document/ukTMukTMukTM/uATMzUjLwEzM14CMxMTN/datavalidation/delete-datavalidation)，更多详情可查看[表格数据校验下拉列表相关接口变更](https://open.larkoffice.com/document/uAjLw4CM/ugTN1YjL4UTN24CO1UjN/breaking-change/datavalidation-dropdown-udpate)**。
