...
# 导入表格
>  为了更好地提升该接口的安全性，我们对其进行了升级，请尽快迁移至[新版本](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/import_task/import-user-guide)
...
| 参数   |类型| 说明                                             |
| ------ |-----| ------------------------------------------------ |
| ticket |string| 与导入文件一一对应的凭证，用于查询文件导入的进度，详见[查询导入结果的接口](https://open.larkoffice.com/document/ukTMukTMukTM/uETO2YjLxkjN24SM5YjN)  |
### 响应体示例
