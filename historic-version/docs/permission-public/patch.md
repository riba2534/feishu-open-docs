...
{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=permission.public&method=patch)
...
:::html
<md-alert type="warn">
本接口为历史版本接口。推荐使用新版接口[更新云文档权限设置](/ssl:ttdoc/ukTMukTMukTM/uIzNzUjLyczM14iM3MTN/drive-v2/permission-public/patch)。
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/drive/v1/permissions/:token/public</md-td>
    </md-tr>
    <md-tr>
...
<md-enum-item key="wiki" >知识库节点。该枚举值不支持以下设置：
    ...
    - `link_share_entity`: 链接分享设置
      ...
      - `anyone_editable`: 互联网上获得链接的人可编辑</md-enum-item>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	是否允许内容被分享到组织外。当云文档类型为 wiki 时，不支持传入该参数。
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	谁可以查看、添加、移除协作者。当云文档类型为 wiki 时，不支持传入该参数。
...
<md-enum-item key="anyone_readable" >互联网上获得链接的任何人可阅读。当云文档类型为 wiki 时，不支持传入该值</md-enum-item>
<md-enum-item key="anyone_editable" >互联网上获得链接的任何人可编辑。当云文档类型为 wiki 时，不支持传入该值</md-enum-item>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	是否允许非「可管理权限」的人分享到组织外。当云文档类型为 wiki 时，不支持该参数。
...
<md-enum-item key="tenant_readable" >组织内获得链接的人可阅读</md-enum-item>
<md-enum-item key="tenant_editable" >组织内获得链接的人可编辑</md-enum-item>
<md-enum-item key="anyone_readable" >互联网上获得链接的任何人可阅读</md-enum-item>
<md-enum-item key="anyone_editable" >互联网上获得链接的任何人可编辑</md-enum-item>
<md-enum-item key="closed" >关闭链接分享</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
