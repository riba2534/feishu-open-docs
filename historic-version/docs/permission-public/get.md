...
获取指定云文档的权限设置，包括是否允许内容被分享到组织外、谁可以查看、添加、移除协作者等设置。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=permission.public&method=get)
...
:::html
<md-alert type="warn">
本接口为历史版本接口。推荐使用新版接口[获取云文档权限设置](/ssl:ttdoc/ukTMukTMukTM/uIzNzUjLyczM14iM3MTN/drive-v2/permission-public/get)。
</md-alert>
:::
