---
title: "获取旧版文档富文本内容"
fullPath: "/ukTMukTMukTM/uUDM2YjL1AjN24SNwYjN"
updateTime: "1753863911000"
---
...
- [获取文档所有块](/ssl:ttdoc/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block/list)
- [获取指定块](/ssl:ttdoc/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block/get)
- [获取指定块下所有子块](/ssl:ttdoc/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block-children/get)
:::
该接口用于获取结构化的文档内容。
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/doc/v2/:docToken/content</md-td>
    </md-tr>
    <md-tr>
...
| 参数          | 类型   | 必须 | 说明 | 
| ------------- | ------ | ---- | --------- | 
| docToken      | string | 是   | 获取方式详见[如何获取云文档资源相关 token](/ssl:ttdoc/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6) | 
...
| 参数     | 说明                              |
| -------- | --------------------------------- |
| content  | 详情参考[文档数据结构](/ssl:ttdoc/ukTMukTMukTM/ukDM2YjL5AjN24SOwYjN) |
| revision | 文档当前版本号                    |
### 响应体示例
