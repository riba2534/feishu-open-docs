...
- 通过 [Folder API](/ssl:ttdoc/ukTMukTMukTM/uEjNzUjLxYzM14SM2MTN) 的返回值获取文档的 docToken

对于 content 和 batch_update 方法，需要传入 docToken 来指定要操作的文档，create 方法在成功创建一篇文档后，也会返回对应的 docToken。

### 文档数据结构

我们定义了 OpenAPI 专用的文档数据结构，便于开发者对文档内容进行解析或编辑。在开始使用 Docs API 前，建议先查看[文档数据结构概述](/ssl:ttdoc/ukTMukTMukTM/uAzM5YjLwMTO24CMzkjN)了解更多。  
...
**结构说明**：参考[文档数据结构概述](/ssl:ttdoc/ukTMukTMukTM/uAzM5YjLwMTO24CMzkjN) 和 [文档数据结构参考](/ssl:ttdoc/ukTMukTMukTM/ukDM2YjL5AjN24SOwYjN)
...
<md-text type="field-name" >[创建文档](/ssl:ttdoc/ukTMukTMukTM/ugDM2YjL4AjN24COwYjN)
...
<md-text type="field-name" >[获取文档富文本内容](/ssl:ttdoc/ukTMukTMukTM/uUDM2YjL1AjN24SNwYjN)</md-text>
...
<md-text type="field-name" >[获取文档文本内容](/ssl:ttdoc/ukTMukTMukTM/ukzNzUjL5czM14SO3MTN)</md-text>
...
<md-text type="field-name" >[编辑文档内容](/ssl:ttdoc/ukTMukTMukTM/uYDM2YjL2AjN24iNwYjN)</md-text>
