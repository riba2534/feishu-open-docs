---
title: "获取职位上的招聘人员信息"
fullPath: "/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job-manager/get"
updateTime: "1689057769000"
---

# 获取职位上的招聘人员信息

根据职位 ID 获取职位上的招聘人员信息，如招聘负责人、用人经理。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=job.manager&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/jobs/:job_id/managers/:manager_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >manager_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
