...
根据操作人和操作类型查询人才的操作记录。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=talent_operation_log&method=search)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/hire/v1/talent_operation_logs/search</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	职位 ID 列表，可通过[获取职位列表](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job/list)接口获取
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >operation_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int\[\]</md-text>
	</md-dt-td>
	...
	<md-dt-td>
	操作类型 ID 列表，操作类型枚举可查看[枚举常量介绍](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/enum)
中 `操作类型枚举定义`
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >talent_operation_log\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	操作记录列表
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	操作类型，操作类型枚举可查看[枚举常量介绍](/ssl:ttdoc/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/enum)
中 `操作类型枚举定义`
	</md-dt-td>
</md-dt-tr>
