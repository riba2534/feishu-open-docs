...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/authen/v1/oidc/refresh_access_token</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  ...
  <md-td>无效refresh_token，请检查是否过期或已经消费</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>过期refresh_token，请传有效参数</md-td>
</md-tr>
...
<md-tr>
  <md-td>200</md-td>
  <md-td>20038</md-td>
  <md-td>The refresh token passed is not found. Please check the value</md-td>
  <md-td>查询不到 refresh_token。
...
你可以调用[获取 user_access_token](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/authen-v1/oidc-access_token/create)重新获取 user_access_token 和 refresh_token。</md-td>
</md-tr>
