---
title: "获取企业安装的应用"
fullPath: "/ukTMukTMukTM/uYDN3UjL2QzN14iN0cTN"
updateTime: "1731902072000"
---
...
:::note
该接口为旧版获取企业安装应用接口。推荐使用新版接口[获取企业安装的应用](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/application-v6/application/list)。
:::
## 请求
:::html
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/application/v3/app/list</md-td>
    </md-tr>
    <md-tr>
