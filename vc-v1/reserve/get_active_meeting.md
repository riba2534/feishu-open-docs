...
获取一个预约的当前活跃会议。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=reserve&method=get_active_meeting)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/vc/v1/reserves/:reserve_id/get_active_meeting</md-td>
    </md-tr>
    <md-tr>
