---
title: "预约会议"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/reserve/apply"
updateTime: "1725888874000"
---

# 预约会议

创建一个会议预约。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=reserve&method=apply)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/vc/v1/reserves/apply</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="vc:reserve" desc="更新会议预约信息" support_app_types="custom,isv" tags="">更新会议预约信息</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-enum-item key="2" >1v1呼叫(仅支持预约PSTN用户)</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >reserve_correction_check_info</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >reserve_correction_check_info</md-text>
	</md-dt-td>
	<md-dt-td>
	预约参数检查信息
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >invalid_host_id_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>123002</md-td>
  <md-td>record param error</md-td>
  <md-td>录制参数错误，1v1呼叫暂不支持自动录制</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>123003</md-td>
  <md-td>assign host exceed max limit 10</md-td>
  <md-td>指定主持人数量超过最大限制，上限10</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>123004</md-td>
  <md-td>assign host error</md-td>
  <md-td>指定主持人错误，检查id是否合法</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>password 无效，请检查 password 是否为 4～9 位数字</md-td>
</md-tr>
