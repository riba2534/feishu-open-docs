...
查询参会人明细，具体权限要求请参考[资源介绍](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting-room-data/resource-introduction)
...
| `meeting_status` | `int` | 否 | 会议状态（不传默认为已结束会议）<br>**示例值**：2<br>**可选值有**：<br>- `1`: 进行中 - `2`: 已结束 - `3`: 待召开 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `accept_status` | `int` | 日程响应状态<br>**可选值有**：<br>- `1`: 接受 - `2`: 拒绝 - `3`: 待确认 - `4`: 未响应 |
