---
title: "离开会议"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting/events/leave_meeting"
updateTime: "1679916446000"
---

# 离开会议

发生在有人离开会议时【仅通过Open API预约的会议会产生此类事件】{使用示例}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=meeting&event=leave_meeting)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>vc.meeting.leave_meeting_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >主动离会</md-enum-item>
<md-enum-item key="2" >会议结束</md-enum-item>
<md-enum-item key="3" >被踢出</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
