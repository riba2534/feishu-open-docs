...
发生在会议开始时，包含企业内所有会议开始事件。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=meeting&event=all_meeting_started)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>vc.meeting.all_meeting_started_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
    ...
    <md-th>
      ...
      <md-td>
            <md-perm name="vc:meeting.all_meeting:readonly" desc="获取所有视频会议信息" support_app_types="custom,isv" tags="">获取所有视频会议信息</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >meeting</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >meeting_event_meeting</md-text>
	</md-dt-td>
	<md-dt-td>
	会议数据
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >meeting_source</md-text>
	</md-dt-td>
	<md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >日程会议</md-enum-item>
<md-enum-item key="2" >即时会议</md-enum-item>
<md-enum-item key="3" >面试会议</md-enum-item>
<md-enum-item key="4" >开放平台会议</md-enum-item>
<md-enum-item key="100" >其他会议类型</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >meeting_event_user</md-text>
	</md-dt-td>
	<md-dt-td>
	会议主持人
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >user_role</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-enum-item key="8" >sharebox用户</md-enum-item>
<md-enum-item key="9" >开放平台应用</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >meeting_sub_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >会前投屏</md-enum-item>
<md-enum-item key="2" >有线共享</md-enum-item>
<md-enum-item key="3" >会前妙享</md-enum-item>
<md-enum-item key="4" >企业办公电话</md-enum-item>
<md-enum-item key="5" >IP Phone</md-enum-item>
<md-enum-item key="6" >网络研讨会</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >meeting_security_setting</md-text>
	</md-dt-td>
	<md-dt-td>
	会议安全设置
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >所有人可加入</md-enum-item>
<md-enum-item key="2" >仅企业内用户可加入</md-enum-item>
<md-enum-item key="3" >仅指定联系人和群可加入</md-enum-item>
<md-enum-item key="4" >仅主持人可参会（锁定会议）</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >has_set_security_contacts_and_group</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >webinar_setting</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >meeting_webinar_setting</md-text>
	</md-dt-td>
	<md-dt-td>
	研讨会相关设置
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >webinar_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >普通网络研讨会</md-enum-item>
<md-enum-item key="2" >直播网络研讨会</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
