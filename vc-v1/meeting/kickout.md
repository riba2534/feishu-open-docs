...
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 | `vc:meeting` 更新会议信息 |
...
| &nbsp;&nbsp;└ `user_type` | `int` | 否 | 用户类型<br>**示例值**：1<br>**可选值有**：<br>- `1`: 飞书用户 - `2`: rooms用户 - `3`: 文档用户 - `4`: neo单品用户 - `5`: neo单品游客用户 - `6`: pstn用户 - `7`: sip用户 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `id` | `string` | 用户ID |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `user_type` | `int` | 用户类型<br>**可选值有**：<br>- `1`: lark用户 - `2`: rooms用户 - `3`: 文档用户 - `4`: neo单品用户 - `5`: neo单品游客用户 - `6`: pstn用户 - `7`: sip用户 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `result` | `int` | 移除结果<br>**可选值有**：<br>- `1`: 移除成功 - `2`: 移除失败 |
