---
title: "移除参会人"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting/kickout"
updateTime: "1692770962000"
---

# 移除参会人

将参会人从会议中移除。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=meeting&method=kickout)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/vc/v1/meetings/:meeting_id/kickout</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >kickout_users</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >kickout_results</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >meeting_participant_result\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	移除结果
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >lark用户</md-enum-item>
<md-enum-item key="2" >rooms用户</md-enum-item>
<md-enum-item key="3" >文档用户</md-enum-item>
<md-enum-item key="4" >neo单品用户</md-enum-item>
<md-enum-item key="5" >neo单品游客用户</md-enum-item>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >移除成功</md-enum-item>
<md-enum-item key="2" >移除失败</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
