---
title: "批量查询会议室详情"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/room/mget"
updateTime: "1721719979000"
---

# 批量查询会议室详情

该接口可以使用会议室 ID 批量查询会议室详情。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=room&method=mget)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/vc/v1/rooms/mget</md-td>
    </md-tr>
    <md-tr>
