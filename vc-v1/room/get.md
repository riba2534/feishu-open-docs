---
title: "查询会议室详情"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/room/get"
updateTime: "1721719979000"
---

# 查询会议室详情

该接口可以使用会议室 ID 查询会议室详情。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=room&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/vc/v1/rooms/:room_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >room</md-text>
	</md-dt-td>
	<md-dt-td>
