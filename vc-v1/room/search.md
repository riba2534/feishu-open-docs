---
title: "搜索会议室"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/room/search"
updateTime: "1721719979000"
---

# 搜索会议室

该接口可以用来搜索会议室，支持使用关键词进行搜索，也支持使用自定义会议室 ID 进行查询。该接口只会返回用户有预定权限的会议室列表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=room&method=search)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/vc/v1/rooms/search</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >custom_room_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >search_level_name</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >rooms</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >room\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	会议室列表
	</md-dt-td>
