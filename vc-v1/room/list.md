---
title: "查询会议室列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/room/list"
updateTime: "1721719979000"
---

# 查询会议室列表

该接口可以用来查询某个会议室层级下会议室列表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=room&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/vc/v1/rooms</md-td>
    </md-tr>
    <md-tr>
