---
title: "删除会议室"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/room/events/deleted"
updateTime: "1673520299000"
---

# 删除会议室

当删除会议室时，会触发该事件。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=room&event=deleted)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>vc.room.deleted_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >room_event</md-text>
	</md-dt-td>
	<md-dt-td>
	会议室信息
	</md-dt-td>
