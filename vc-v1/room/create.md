...
该接口用于创建会议室。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=room&method=create)
...
<md-tr>
  <md-td>404</md-td>
  <md-td>125001</md-td>
  <md-td>cannot create/update room at this level</md-td>
