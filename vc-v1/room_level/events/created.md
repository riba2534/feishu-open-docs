---
title: "创建会议室层级"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/room_level/events/created"
updateTime: "1675171181000"
---

# 创建会议室层级

当创建会议室层级时，会触发该事件。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=room_level&event=created)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>vc.room_level.created_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
