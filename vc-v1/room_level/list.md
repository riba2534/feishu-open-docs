---
title: "查询会议室层级列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/room_level/list"
updateTime: "1721719978000"
---

# 查询会议室层级列表

该接口用来查询某个会议室层级下的子层级列表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=room_level&method=list)
