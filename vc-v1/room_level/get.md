---
title: "查询会议室层级详情"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/room_level/get"
updateTime: "1721719977000"
---

# 查询会议室层级详情

该接口可以使用会议室层级 ID 查询会议室层级详情。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=room_level&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/vc/v1/room_levels/:room_level_id</md-td>
    </md-tr>
    <md-tr>
