---
title: "查询会议室预定限制"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/reserve_config/reserve_scope"
updateTime: "1721719980000"
---

# 查询会议室预定限制

查询会议室预定限制。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=reserve_config&method=reserve_scope)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/vc/v1/reserve_configs/reserve_scope</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >approve_config</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >approval_switch</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >approval_condition</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >approvers</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >subscribe_user\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >time_config</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >time_config</md-text>
	</md-dt-td>
	<md-dt-td>
	预定时间设置
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >if_cover_child_scope</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >time_switch</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >days_in_advance</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >opening_hour</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >max_duration</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >reserve_scope_config</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >reserve_scope_config</md-text>
	</md-dt-td>
	<md-dt-td>
	预定范围设置
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >allow_all_users</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >allow_users</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >subscribe_user\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >allow_depts</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >subscribe_department\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	可预定部门列表
	</md-dt-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>126001</md-td>
  <md-td>invalid room or level id, check itself or whether the scope_type corresponds to it</md-td>
