---
title: "查询会议室配置"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/scope_config/get"
updateTime: "1721719979000"
---

# 查询会议室配置

该接口可以用来查询某个会议层级范围下或者某个会议室的配置。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=scope_config&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/vc/v1/scope_config</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >current_config</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >scope_config</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >origin_configs</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >scope_config\[\]</md-text>
	</md-dt-td>
