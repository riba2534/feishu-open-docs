---
title: "更新会议室预定限制"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/reserve_config/patch"
updateTime: "1721719980000"
---

# 更新会议室预定限制

更新会议室预定限制。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=reserve_config&method=patch)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/vc/v1/reserve_configs/:reserve_config_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >reserve_config_id</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >approval_config</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>126014</md-td>
  <md-td>some deptIDs you put is invalid</md-td>
  <md-td>存在无效的部门ID</md-td>
</md-tr>
