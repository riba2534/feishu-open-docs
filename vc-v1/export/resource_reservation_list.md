---
title: "导出会议室预定数据"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/export/resource_reservation_list"
updateTime: "1721719977000"
---

# 导出会议室预定数据

导出会议室预定数据，具体权限要求请参考「资源介绍」。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=export&method=resource_reservation_list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/vc/v1/exports/resource_reservation_list</md-td>
    </md-tr>
    <md-tr>
