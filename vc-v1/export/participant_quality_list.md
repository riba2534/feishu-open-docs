---
title: "导出参会人会议质量数据"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/export/participant_quality_list"
...
（仅支持已结束会议），具体权限要求请参考「资源介绍」。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=export&method=participant_quality_list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/vc/v1/exports/participant_quality_list</md-td>
    </md-tr>
    <md-tr>
