---
title: "查询导出任务结果"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/export/get"
updateTime: "1721719977000"
---

# 查询导出任务结果

查看异步导出的进度。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=export&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/vc/v1/exports/:task_id</md-td>
    </md-tr>
    <md-tr>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >处理中</md-enum-item>
<md-enum-item key="2" >失败</md-enum-item>
<md-enum-item key="3" >完成</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >fail_msg</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
