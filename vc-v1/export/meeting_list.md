---
title: "导出会议明细"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/export/meeting_list"
updateTime: "1721719976000"
---

# 导出会议明细

导出会议明细，具体权限要求请参考资源介绍。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=export&method=meeting_list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/vc/v1/exports/meeting_list</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="vc:export" desc="导出视频会议信息" support_app_types="custom,isv" tags="">导出视频会议信息</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
