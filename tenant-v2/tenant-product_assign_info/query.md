...
即增购的未来席位不在本接口返回的待分配席位列表范围内。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=tenant&version=v2&resource=tenant.product_assign_info&method=query)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/tenant/v2/tenant/assign_info_list/query</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="tenant:tenant.product_assign_info:read" desc="查询租户下的席位信息" support_app_types="custom,isv" tags="">查询租户下的席位信息</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >assign_info_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >tenant_assign_info\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	租户待分配席位列表
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >total_seats</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >assigned_seats</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
