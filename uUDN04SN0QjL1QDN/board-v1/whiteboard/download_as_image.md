...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| `whiteboard_id` | `string` | 画板唯一标识。可通过文档接口 [获取文档所有块](https://open.larkoffice.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block/list) 获取，`block_type` 为 43 的 block 即为画板，对应的 block.token 就是画板的whiteboard_id。<br>**示例值**："Ru8nwrWFOhEmaFbEU2VbPRsHcxb" |
