...
<md-enum-item key="1" >超链接</md-enum-item>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	文字颜色类型，0=系统颜色（取theme_text_color_code），1=自定义颜色（取text_color）
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	文字背景颜色类型，0=系统颜色（取theme_text_background_color_code），1=自定义颜色（取text_background_color）
