...
获取画板内所有的节点，节点以数组方式返回，可通过 parent_id（父节点）、children（子节点） 关系组装成画板内容。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=board&version=v1&resource=whiteboard.node&method=list)
...
**可选值有**：
<md-enum>
<md-enum-item key="image" >图片属性</md-enum-item>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	<md-text type="field-type" >rich_text</md-text>
	</md-dt-td>
	<md-dt-td>
	富文本
	</md-dt-td>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >paragraphs</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >rich_text_paragraph\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	段落列表
	</md-dt-td>
...
<md-dt-tr level="5">
	<md-dt-td>
	<md-text type="field-name" >paragraph_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="0" >普通段落</md-enum-item>
<md-enum-item key="1" >无序列表</md-enum-item>
<md-enum-item key="2" >有序列表</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="5">
	...
	<md-dt-td>
	<md-text type="field-type" >rich_text_element\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	元素列表
	</md-dt-td>
...
<md-dt-tr level="6">
	<md-dt-td>
	<md-text type="field-name" >element_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="0" >文本</md-enum-item>
<md-enum-item key="1" >链接</md-enum-item>
<md-enum-item key="2" >@用户</md-enum-item>
<md-enum-item key="3" >文档</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="6">
	<md-dt-td>
	<md-text type="field-name" >text_element</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >rich_text_element_text</md-text>
	</md-dt-td>
	<md-dt-td>
	文本类别信息，如果元素类别为文本时需要设置
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="7">
	<md-dt-td>
	<md-text type="field-name" >text_style</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >rich_text_element_text_style</md-text>
	</md-dt-td>
	<md-dt-td>
	文字样式
	</md-dt-td>
...
<md-dt-tr level="6">
	<md-dt-td>
	<md-text type="field-name" >link_element</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >rich_text_element_link</md-text>
	</md-dt-td>
	<md-dt-td>
	超链接类别信息，元素类别为链接时需要设置
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="7">
	<md-dt-td>
	<md-text type="field-name" >herf</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="6">
	<md-dt-td>
	<md-text type="field-name" >mention_user_element</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >rich_text_element_mention_user</md-text>
	</md-dt-td>
	<md-dt-td>
	@用户类别信息，元素类别是@用户时候需要设置
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="7">
	...
	<md-dt-td>
	用户openID，可通过 [获取指定用户的 Open ID](/ssl:ttdoc/uAjLw4CM/ugTN1YjL4UTN24CO1UjN/trouble-shooting/how-to-obtain-openid) 获取 
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="6">
	<md-dt-td>
	<md-text type="field-name" >mention_doc_element</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >rich_text_element_mention_doc</md-text>
	</md-dt-td>
	<md-dt-td>
	文档类别信息，元素类别是文档时候需要设置
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="5">
	<md-dt-td>
	<md-text type="field-name" >indent</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="5">
	<md-dt-td>
	<md-text type="field-name" >list_begin_index</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
	<md-dt-td>
	有序列表开始序号(第一个有序列表的序号为list_begin_index+1)
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >text_color_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="0" >系统颜色</md-enum-item>
<md-enum-item key="1" >自定义颜色</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >text_background_color_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >fill_color_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >border_color_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >circular_ring</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >pie</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	开始连接节点信息（兼容线上数据，只读，写操作使用 start 字段，start_object 设置也不会生效）
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	结束连接点信息（兼容线上数据， 只读，写操作使用 end 字段，写入时设置字段也不会生效）
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >caption_auto_direction</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >boolean</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >caption_position</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >number(float)</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >collapsed</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >boolean</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >mind_map</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >mind_map</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-tr>
  ...
  <md-td>找不到记录。whiteboard_id 不存在，可能是 whiteboard_id 不存在或拼写错误。请检查传入的 whiteboard_id 是否正确，可通过云文档下的文档接口[获取文档所有块](https://open.feishu.cn/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block/list)获取正确的 whiteboard_id（block_type 为 43 的 block 对应的 block.token 即为 whiteboard_id）</md-td>
</md-tr>
