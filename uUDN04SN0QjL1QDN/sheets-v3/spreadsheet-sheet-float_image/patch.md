...
更新已有的浮动图片位置和宽高。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=sheets&version=v3&resource=spreadsheet.sheet.float_image&method=patch)
...
<md-tr>
  ...
  <md-td>浮动图片 ID 错误，请检查 `float_image_id` 参数是否填写正确</md-td>
</md-tr>
