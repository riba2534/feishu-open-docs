...
| `sheet_id` | `string` | 工作表的 ID。调用[获取工作表](https://open.larkoffice.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet/query)获取 ID<br>**示例值**："2jm6f6" |
...
| &nbsp;&nbsp;└ `major_dimension` | `string` | 否 | 移动的维度。可选值： - `ROWS`：行 - `COLUMNS`：列<br>**示例值**："ROWS" |
