...
删除电子表格中指定工作表的所有筛选。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=sheets&version=v3&resource=spreadsheet.sheet.filter&method=delete)
...
<md-tr>
  ...
  <md-td>工作表未找到。请填写工作表的 ID。获取方式见[获取工作表](/ssl:ttdoc/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet/query)</md-td>
</md-tr>
