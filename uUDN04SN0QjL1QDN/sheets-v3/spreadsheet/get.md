...
根据电子表格 token 获取电子表格的基础信息，包括电子表格的所有者、URL 链接等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=sheets&version=v3&resource=spreadsheet&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/sheets/v3/spreadsheets/:spreadsheet_token</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >get_spreadsheet</md-text>
	</md-dt-td>
	<md-dt-td>
	电子表格的基础信息
	</md-dt-td>
...
<md-tr>
  ...
  <md-td>当前电子表格已删除。请恢复表格后重试</md-td>
</md-tr>
