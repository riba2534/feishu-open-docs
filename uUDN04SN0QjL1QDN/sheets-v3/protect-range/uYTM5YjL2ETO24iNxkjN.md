...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `protectIds` | `array<string>` | 是 | 要删除的保护范围 ID，可通过[获取表格元数据](https://open.larkoffice.com/document/ukTMukTMukTM/uETMzUjLxEzM14SMxMTN) 获取。最多支持传入 10 个保护范围 ID。 |
