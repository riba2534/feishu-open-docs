...
| &nbsp;&nbsp;└ `sheet_id ` | `string ` | 电子表格工作表的 ID。调用[获取工作表](https://open.larkoffice.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet/query)获取 ID。 |
| &nbsp;&nbsp;└ `cf_id ` | `string ` | 条件格式的 ID。调用[获取条件格式](https://open.larkoffice.com/document/ukTMukTMukTM/uATMzUjLwEzM14CMxMTN/conditionformat/condition-format-get)获取 ID。 |
