...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/sheets/v2/spreadsheets/:spreadsheet_token/condition_formats/batch_create    </md-td>
    </md-tr>
    <md-tr>
...
<md-table> 
  <md-thead> 
    <md-tr> 
      <md-th style="width: 15%;">res_code</md-th>  
      <md-th style="width: 30%;">res_msg</md-th>  
      <md-th>排查建议</md-th> 
    </md-tr> 
  </md-thead>  
  <md-tbody> 
...
90230
      ...
      <md-td>unknown rule_type</md-td>  
      <md-td>
`rule_type` 参数填写错误。电子表格支持以下规则类型：
- containsBlanks：为空
- notContainsBlanks：不为空
- duplicateValues：重复值
- uniqueValues：唯一值
...
参考[规则类型 rule_type 与属性 attrs](/ssl:ttdoc/ukTMukTMukTM/uATMzUjLwEzM14CMxMTN/conditionformat/condition-format-guide#6de1dc32) 了解如何选择与填写 `rule_type`。  
      </md-td> 
    </md-tr>  
