---
title: "批量创建条件格式"
fullPath: "/ukTMukTMukTM/uATMzUjLwEzM14CMxMTN/conditionformat/condition-format-set"
updateTime: "1729687295000"
---
...
| 参数 | 类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| `sheet_condition_formats` | `array<interface>` | 是 | 要创建的条件格式的信息。最多可创建 10 个条件格式。    **注意**：<br>响应体中将返回每个条件格式的设置结果，包括成功或具体的失败信息。 |
...
| --- | --- | --- |
| 90230 | unknown rule_type | `rule_type` 参数填写错误。电子表格支持以下规则类型： - containsBlanks：为空 - notContainsBlanks：不为空 - duplicateValues：重复值 - uniqueValues：唯一值 - cellIs：限定值范围 - containsText：包含内容 - timePeriod：日期 参考[规则类型 rule_type 与属性 attrs](https://open.larkoffice.com/document/ukTMukTMukTM/uATMzUjLwEzM14CMxMTN/conditionformat/condition-format-guide#6de1dc32) 了解如何选择与填写 `rule_type`。 |
