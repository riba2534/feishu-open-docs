...
在筛选视图的指定列创建筛选条件，包括筛选的类型、比较类型、筛选参数等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=sheets&version=v3&resource=spreadsheet.sheet.filter_view.condition&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/sheets/v3/spreadsheets/:spreadsheet_token/sheets/:sheet_id/filter_views/:filter_view_id/conditions</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	筛选类型。枚举值如下所示。了解更多，参考[筛选条件指南](/ssl:ttdoc/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet-filter_view-condition/filter-view-condition-user-guide)。
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	比较类型。了解更多，参考[筛选条件指南](/ssl:ttdoc/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet-filter_view-condition/filter-view-condition-user-guide)。
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	筛选参数。了解更多，参考[筛选条件指南](/ssl:ttdoc/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet-filter_view-condition/filter-view-condition-user-guide)。
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >filter_view_condition</md-text>
	</md-dt-td>
	<md-dt-td>
	创建的筛选条件
	</md-dt-td>
...
<md-tr>
  ...
  <md-td>工作表 ID 错误。检查工作表的 ID 是否正确。获取方式见[获取工作表](/ssl:ttdoc/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet/query)</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>筛选视图 ID 错误。获取方式参考[查询筛选视图](/ssl:ttdoc/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet-filter_view/query)</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>请求体参数错误。参考响应体中的错误提示</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1310223</md-td>
  <md-td>Col Id Not Found</md-td>
  <md-td>列 ID 没有找到。请检查 ID 填写是否正确、该列是否超过表格的列范围</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1310232</md-td>
  <md-td>Wrong Style</md-td>
  <md-td>样式错误，包括颜色、字体等。请修改</md-td>
</md-tr>
