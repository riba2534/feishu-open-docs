...
更新筛选视图的名称或筛选范围。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=sheets&version=v3&resource=spreadsheet.sheet.filter_view&method=patch)
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	筛选视图名称。长度不得超过 100 个字符，且在工作表内必须唯一。
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	筛选视图的筛选范围。支持以下五种写法，了解更多，参考[筛选指南](/ssl:ttdoc/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet-filter/filter-user-guide)。
...
<md-tr>
  ...
  <md-td>请求体参数错误。请参考响应体中的错误提示</md-td>
</md-tr>
