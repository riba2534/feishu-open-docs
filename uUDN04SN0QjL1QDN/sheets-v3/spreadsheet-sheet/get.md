---
title: "查询工作表"
fullPath: "/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet/get"
...
| `sheet_id` | `string` | 工作表的 ID。调用[获取工作表](https://open.larkoffice.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet/query)获取 ID。<br>**示例值**："giDk9k" |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `resource_type` | `string` | 工作表类型 - `sheet`：工作表 - `bitable`：多维表格。详情参考[多维表格概述](https://open.larkoffice.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/bitable-overview) - `#UNSUPPORTED_TYPE`：不支持的类型 |
