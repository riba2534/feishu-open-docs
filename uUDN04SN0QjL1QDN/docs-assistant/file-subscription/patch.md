---
title: "更新订阅状态"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-subscription/patch"
updateTime: "1703835069000"
---

# 更新订阅状态

根据订阅ID更新订阅状态{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=file.subscription&method=patch)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/drive/v1/files/:file_token/subscriptions/:subscription_id</md-td>
    </md-tr>
    <md-tr>
