---
title: "创建文件快捷方式"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file/create_shortcut"
updateTime: "1716972268000"
---

# 创建文件快捷方式

创建指定文件的快捷方式到云空间的其它文件夹中。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=file&method=create_shortcut)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/drive/v1/files/create_shortcut</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	目标父文件夹的 token，获取方式见[文件夹概述](/ssl:ttdoc/ukTMukTMukTM/ugTNzUjL4UzM14CO1MTN/folder-overview)
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >refer_entity</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >refer_entity</md-text>
	</md-dt-td>
	<md-dt-td>
	是
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >refer_token</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
	...
	<md-dt-td>
	源文件的 token。获取方式见[文件概述](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file/file-overview)
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >refer_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >succ_shortcut_node</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-tr>
  ...
  <md-td>请确认当前身份是否有对应上传节点的的权限，如用户是否有docx的阅读和文件夹的编辑权限。</md-td>
</md-tr>
