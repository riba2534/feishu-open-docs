...
此接口用于获取各类文件的流量统计信息和互动信息，包括阅读人数、阅读次数和点赞数。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=file.statistics&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/drive/v1/files/:file_token/statistics</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	文件 token。了解如何获取文件 token，参考[文件概述](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file/file-overview)。
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >file_statistics</md-text>
	</md-dt-td>
	<md-dt-td>
	文档统计信息
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >uv_today</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >pv_today</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >like_count_today</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-tr>
  ...
  <md-td>1069601</md-td>
  <md-td>fail</md-td>
  <md-td>重试，若稳定失败请联系相关业务方 oncall 人员</md-td>
</md-tr>
