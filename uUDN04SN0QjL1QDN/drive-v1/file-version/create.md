...
创建文档版本。文档支持在线文档或电子表格。该接口为异步接口。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=file.version&method=create)
...
<md-enum-item key="1" >该版本已被删除</md-enum-item>
...
<md-tr>
  ...
  <md-td>请求失败，请重试或联系[技术支持](https://applink.feishu.cn/TLJpeNdW)。</md-td>
</md-tr>
