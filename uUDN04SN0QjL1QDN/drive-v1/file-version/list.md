---
title: "获取文档版本列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-version/list"
updateTime: "1721027092000"
---

# 获取文档版本列表

获取文档或电子表格的版本列表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=file.version&method=list)
...
<md-tr>
  ...
  <md-td>标题审核不通过，含非法内容，请重新命名。</md-td>
</md-tr>
