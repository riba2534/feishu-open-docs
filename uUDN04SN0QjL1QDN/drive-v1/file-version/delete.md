...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| `file_token` | `string` | 当前版本对应的源文档的 token。获取方式参考[如何获取云文档相关 token](https://open.larkoffice.com/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)。<br>**示例值**："doxbcyvqZlSc9WlHvQMlSJabcef" |
