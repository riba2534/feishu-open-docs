---
title: "获取文档版本信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-version/get"
updateTime: "1721027092000"
---

# 获取文档版本信息

该接口用于获取文档或电子表格指定版本的信息，包括标题、标识、创建者、创建时间等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=file.version&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/drive/v1/files/:file_token/versions/:version_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	源文档的 token。获取方式参考 [如何获取云文档相关 token](/ssl:ttdoc/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)。
...
**可选值有**：
<md-enum>
<md-enum-item key="0" >正常状态</md-enum-item>
<md-enum-item key="1" >删除状态</md-enum-item>
<md-enum-item key="2" >回收站状态</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-tr>
  ...
  <md-td>无阅读或编辑权限，请申请源文档的阅读或编辑权限。</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>`file_token` 请求参数错误，请检查参数。</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>`obj_type` 请求参数错误，请检查参数。</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1068412</md-td>
  <md-td>Params error, param [version_id] is wrong.</md-td>
  <md-td>`version_id` 请求参数错误，请检查参数。</md-td>
</md-tr>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1068403</md-td>
  <md-td>File  does not exist, please check the file status.</md-td>
  <md-td>文档版本不存在，请检查版本文档是否已被删除。</md-td>
</md-tr>
