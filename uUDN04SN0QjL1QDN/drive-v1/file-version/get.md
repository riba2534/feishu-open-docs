...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| `file_token` | `string` | 源文档的 token。获取方式参考 [如何获取云文档相关 token](https://open.larkoffice.com/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)。<br>**示例值**："shtbcqqoXZJaKYrfN5IHQgabcef" |
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `obj_type` | `string` | 是 | 源文档的类型<br>**示例值**：docx<br>**可选值有**：<br>- `docx`: 新版文档 - `sheet`: 电子表格 |
...
| &nbsp;&nbsp;└ `status` | `string` | 版本文档的状态<br>**可选值有**：<br>- `0`: 正常状态 - `1`: 删除状态 - `2`: 回收站状态 |
