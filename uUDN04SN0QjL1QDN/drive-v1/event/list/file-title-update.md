---
title: "文件标题变更"
fullPath: "/ukTMukTMukTM/uUDN04SN0QjL1QDN/event/file-title-update"
updateTime: "1744103541000"
---
...
| `event` | `\-` | \- |
| &nbsp;&nbsp;└ `file_type` | `string` | 云文档类型，支持以下枚举： - doc：旧版文档。已不推荐使用 - docx：文档 - sheet：电子表格 - bitable：多维表格 - slides：幻灯片 - file：文件 |
