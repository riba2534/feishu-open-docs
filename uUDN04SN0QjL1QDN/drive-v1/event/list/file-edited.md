...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>drive.file.edit_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
    ...
    <md-th>
      ...
      <md-td>
        	...
        	<md-perm name="docs:event.document_edited:read" desc="接收云文档编辑事件" support_app_types="custom,isv" tags="">接收云文档编辑事件</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-dt-tr level="1">
<md-dt-td>
<md-text type="field-name" >operator_id_list</md-text>
</md-dt-td>
<md-dt-td>
