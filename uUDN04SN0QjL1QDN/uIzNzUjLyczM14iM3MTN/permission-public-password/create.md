...
启用指定云文档的密码。密码启用后，组织外用户需要密码访问，组织内用户无需密码可直接访问。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=permission.public.password&method=create)
...
要启用密码，必须先确保云文档权限中的 **链接分享** 设置为“互联网获得链接的人可编辑/可阅读”。你可通过[更新云文档权限设置](/ssl:ttdoc/ukTMukTMukTM/uIzNzUjLyczM14iM3MTN/drive-v2/permission-public/patch)接口设置。
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/drive/v1/permissions/:token/public/password</md-td>
    </md-tr>
    <md-tr>
...
<md-enum-item key="minutes" >妙计（暂不支持）</md-enum-item>
