...
刷新指定云文档的密码。密码刷新后，旧密码将失效，并生成新密码。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=permission.public.password&method=update)
...
要刷新密码，必须先确保指定云文档已有密码。你可通过[启用云文档密码](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/permission-public-password/create)接口启用密码。
