...
转移指定云文档的所有者。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=permission.member&method=transfer_owner)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/drive/v1/permissions/:token/members/transfer_owner</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            ...
            <md-perm name="docs:permission.member:transfer" desc="转移云文档的所有权" support_app_types="custom,isv" tags="">转移云文档的所有权</md-perm>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	是否需要通知新的文件所有者。仅当使用 <md-tag mode="inline" type="token-user">user_access_token</md-tag> 调用时有效。可选值：
- `true`：通知对方
- `false`：不通知
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >remove_old_owner</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >boolean</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >stay_put</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >boolean</md-text>
	</md-dt-td>
	...
	<md-dt-td>
	在个人文件夹下的云文档是否仍留在原所有者个人文件夹下。可选值：
- `true`：云文档留在原位置不变
- `false`：系统会将该内容移至新所有者的空间下

**注意**：仅当云文档在个人文件夹下时参数生效。
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >old_owner_perm</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
**注意**：仅当 `remove_old_owner` 为 `false` 时，此参数才会生效。
...
<md-enum-item key="openid" >开放平台 Open ID。参考[如何获取不同的用户 ID](/ssl:ttdoc/home/user-identity-introduction/open-id)</md-enum-item>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	文件所有者的 ID，与文件所有者的 ID 类型需要对应。

**示例值**："ou_67e5ecb64ce1c0bd94612c17999abcef"
	</md-dt-td>
</md-dt-tr>
