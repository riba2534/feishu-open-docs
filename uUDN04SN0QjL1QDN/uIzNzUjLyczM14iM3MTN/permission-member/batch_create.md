...
为指定云文档批量添加多个协作者，协作者可以是用户、群组、部门、用户组等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=permission.member&method=batch_create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/drive/v1/permissions/:token/members/batch_create</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="docs:permission.member" desc="查看、新增、更新、删除云文档协作者" support_app_types="custom,isv" tags="">查看、新增、更新、删除云文档协作者</md-perm>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	云文档的 token，需要与 type 参数指定的云文档类型相匹配。可参考 [如何获取云文档相关 token](/ssl:ttdoc/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)。
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	协作者 ID 类型，与协作者 ID （member_id）的类型需要保持一致。
...
<md-enum-item key="unionid" >开放平台UnionID</md-enum-item>
...
<md-enum-item key="wikispaceid" >知识空间的唯一标识</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-tr>
  ...
  <md-td>服务内部限流，与接口本身设置的限流为不同维度的限流，请稍后重试。</md-td>
</md-tr>
