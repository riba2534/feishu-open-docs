...
通过云文档 token 和协作者 ID 移除指定云文档协作者的权限。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=permission.member&method=delete)
  ...
  <md-tbody>
    ...
    <md-tr>
      ...
      <md-td>
            ...
            <md-perm name="docs:permission.member:delete" desc="移除云文档协作者" support_app_types="custom,isv" tags="">移除云文档协作者</md-perm>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	协作者 ID，与协作者 ID 类型（member_type）需要对应。
