---
title: "获取知识空间子节点列表"
fullPath: "/ukTMukTMukTM/uUDN04SN0QjL1QDN/wiki-v2/space-node/list"
...
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 开启任一权限即可 | `wiki:node:retrieve` 查看知识空间节点列表 `wiki:wiki` 查看、编辑和管理知识库 `wiki:wiki:readonly` 查看知识库 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| `space_id` | `string` | [知识空间id](https://open.larkoffice.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/wiki-overview)，如果查询**我的文档库**可替换为`my_library`<br>**示例值**："6946843325487906839" |
