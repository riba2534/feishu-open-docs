...
<md-table>
  ...
  <md-tbody>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="wiki:node:retrieve" desc="查看知识空间节点列表" support_app_types="custom,isv" tags="">查看知识空间节点列表</md-perm>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	[知识空间id](/ssl:ttdoc/ukTMukTMukTM/uUDN04SN0QjL1QDN/wiki-overview)，如果查询**我的文档库**可替换为`my_library`
