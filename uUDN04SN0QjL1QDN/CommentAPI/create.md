...
在文档中添加一条全局评论，不支持局部评论。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=file.comment&method=create)
  ...
  <md-tbody>
    ...
    <md-tr>
      ...
      <md-td>
            ...
            <md-perm name="docs:document.comment:create" desc="添加、回复云文档中的评论" support_app_types="custom,isv" tags="">添加、回复云文档中的评论</md-perm>
...
<md-enum-item key="docs_link" >云文档链接</md-enum-item>
