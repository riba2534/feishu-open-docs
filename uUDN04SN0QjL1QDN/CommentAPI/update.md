---
title: "更新回复的内容"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/update"
updateTime: "1744103613000"
---

# 更新回复的内容

更新云文档中的某条回复的内容。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=file.comment.reply&method=update)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/drive/v1/files/:file_token/comments/:comment_id/replies/:reply_id</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            ...
            <md-perm name="docs:document.comment:update" desc="修改云文档中的评论" support_app_types="custom,isv" tags="">修改云文档中的评论</md-perm>
            <md-perm name="docs:document.comment:write_only" desc="回复、修改、删除云文档中的评论" support_app_types="custom,isv" tags="">回复、修改、删除云文档中的评论</md-perm>
