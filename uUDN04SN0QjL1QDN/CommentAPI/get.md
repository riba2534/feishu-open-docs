...
updateTime: "1748241642000"
---

# 获取全文评论

获取云文档中的某条全文评论，不支持局部评论。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=drive&version=v1&resource=file.comment&method=get)
