...
`document` 的基础元数据结构如下所示。你可通过调用[获取文档基本信息](https://open.larkoffice.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document/get)接口获取。要了解文档内块的结构，参考[块的数据结构](https://open.larkoffice.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/data-structure/block)。
