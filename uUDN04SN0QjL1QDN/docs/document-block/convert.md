...
fullPath: "/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document/convert"
updateTime: "1756439436000"
---

# Markdown/HTML 内容转换为文档块

将 Markdown/HTML 格式的内容转换为文档块，以便于将 Markdown/HTML 格式的内容插入到文档中。目前支持转换为的块类型包含文本、一到九级标题、无序列表、有序列表、代码块、引用、待办事项、图片、表格、表格单元格。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=docx&version=v1&resource=document&method=convert)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/docx/v1/documents/blocks/convert</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="docx:document.block:convert" desc="文本内容转换为云文档块" support_app_types="custom,isv" tags="">文本内容转换为云文档块</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-enum-item key="html" >HTML 格式</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >first_level_block_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >block_id_to_image_urls</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >block_id_to_image_url\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
