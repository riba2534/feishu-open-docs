---
title: "更新块的内容"
fullPath: "/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block/patch"
updateTime: "1758100535000"
---

# 更新块的内容

更新指定块的内容。如果操作成功，接口将返回更新后的块的富文本内容。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=docx&version=v1&resource=document.block&method=patch)
