...
更新表单中的问题项。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=bitable&version=v1&resource=app.table.form.field&method=patch)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/bitable/v1/apps/:app_token/tables/:table_id/forms/:form_id/fields/:field_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	表单问题的唯一标识。表单中的问题本质上是表单视图中的字段，因此你可通过[列出字段](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-field/list)接口获取表单问题的唯一标识。
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >pre_field_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	该问题是否可见。当值为 false 时，不允许更新其他字段。可选值：
- true：可见
- false：不可见
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	<md-text type="field-type" >app_rich_description_segment\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	否
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >segment_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="text" >纯文本</md-enum-item>
<md-enum-item key="url" >链接</md-enum-item>
</md-enum>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >app_table_form_patched_field</md-text>
	</md-dt-td>
	<md-dt-td>
	更新后的field值
	</md-dt-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1254012</md-td>
  <md-td>The field type is not supported.</md-td>
  <md-td>字段类型不支持</md-td>
</md-tr>
