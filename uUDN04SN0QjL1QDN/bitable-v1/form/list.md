---
title: "列出表单问题"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-form-field/list"
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `required` | `boolean` | 该问题是否必填。可选值： - true：必填 - false：非必填 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `visible` | `boolean` | 该问题是否可见。可选值： - true：可见 - false：不可见 |
