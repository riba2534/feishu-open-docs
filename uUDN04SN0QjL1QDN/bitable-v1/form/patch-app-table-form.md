...
更新表单视图中的元数据，包括表单名称、描述、是否共享等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=bitable&version=v1&resource=app.table.form&method=patch)
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	分享表单范围限制。当 shared 参数为 true 时支持传入该字段
...
<md-tr>
  ...
  <md-td>本次操作受到限制，例如租户私密等级限制、wiki空间权限限制等</md-td>
</md-tr>
