...
获取表单的所有元数据，包括表单名称、描述、是否共享等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=bitable&version=v1&resource=app.table.form&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/bitable/v1/apps/:app_token/tables/:table_id/forms/:form_id</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="base:form:read" desc="获取表单数据" support_app_types="custom,isv" tags="">获取表单数据</md-perm>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >app.table.form</md-text>
	</md-dt-td>
	<md-dt-td>
	表单元数据信息
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >shared</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >boolean</md-text>
	</md-dt-td>
	<md-dt-td>
	是否开启表单分享，使表单支持填写。可选值：
- true：支持填写
- false：不支持填写
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >shared_limit</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="off" >仅邀请的人可填写</md-enum-item>
<md-enum-item key="tenant_editable" >组织内获得链接的人可填写</md-enum-item>
<md-enum-item key="anyone_editable" >互联网上获得链接的人可填写</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >submit_limit_once</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >boolean</md-text>
	</md-dt-td>
