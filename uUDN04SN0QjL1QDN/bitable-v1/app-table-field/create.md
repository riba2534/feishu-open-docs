...
<md-table>
  ...
  <md-tbody>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="base:field:create" desc="新增字段" support_app_types="custom,isv" tags="">新增字段</md-perm>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	数字和公式字段的显示格式。详情参考[字段编辑指南](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-field/guide)。
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	进度和评分字段的数据范围最小值。不同字段类型中，该参数的必填属性和取值范围不同，详情参考[字段编辑指南](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-field/guide)。
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	进度和评分字段的数据范围最大值。不同字段类型中，该参数的必填属性和取值范围不同，详情参考[字段编辑指南](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-field/guide)。
