---
title: "删除字段"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-field/delete"
updateTime: "1736314231000"
---
...
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 开启任一权限即可 | `base:field:delete` 删除字段 `bitable:app` 查看、评论、编辑和管理多维表格 |
