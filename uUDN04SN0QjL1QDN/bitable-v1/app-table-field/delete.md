...
删除多维表格数据表中的一个字段。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=bitable&version=v1&resource=app.table.field&method=delete)
...
<md-table>
  ...
  <md-tbody>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="base:field:delete" desc="删除字段" support_app_types="custom,isv" tags="">删除字段</md-perm>
...
<md-tr>
  <md-td>200</md-td>
  <md-td>1254046</md-td>
  <md-td>The Primary Field cannot be deleted.</md-td>
  <md-td>索引列不能被删除</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>重复提交请求，确认本次请求的请求参数和上一次是否完全相同。</md-td>
</md-tr>
