...
删除多维表格高级权限中自定义角色的协作者。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=bitable&version=v1&resource=app.role.member&method=batch_delete)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/bitable/v1/apps/:app_token/roles/:role_id/members/batch_delete</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="base:collaborator:delete" desc="删除协作者" support_app_types="custom,isv" tags="">删除协作者</md-perm>
