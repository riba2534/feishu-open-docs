...
批量新增多维表格高级权限中自定义角色的协作者。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=bitable&version=v1&resource=app.role.member&method=batch_create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/bitable/v1/apps/:app_token/roles/:role_id/members/batch_create</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="base:collaborator:create" desc="新增协作者" support_app_types="custom,isv" tags="">新增协作者</md-perm>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >member_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >app.role.member_id\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	是
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="open_id" >以 open_id 来识别协作者。获取方式参考[如何获取不同的用户 ID](/ssl:ttdoc/home/user-identity-introduction/open-id)。</md-enum-item>
<md-enum-item key="union_id" >以 union_id 来识别协作者。获取方式参考[如何获取不同的用户 ID](/ssl:ttdoc/home/user-identity-introduction/open-id)</md-enum-item>
<md-enum-item key="user_id" >以 user_id 来识别协作者。获取方式参考[如何获取不同的用户 ID](/ssl:ttdoc/home/user-identity-introduction/open-id)</md-enum-item>
<md-enum-item key="chat_id" >以 chat_id 来识别协作者。获取方式参考[群 ID 说明](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-id-description)</md-enum-item>
<md-enum-item key="department_id" >以 department_id 来识别协作者。调用前，请确保应用有部门的可见性，参考[配置应用可用范围](/ssl:ttdoc/home/introduction-to-scope-and-authorization/availability)。获取 department_id 方式参考[部门资源介绍](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/field-overview)</md-enum-item>
<md-enum-item key="open_department_id" >以 open_department_id 来识别协作者。调用前，请确保应用有部门的可见性，参考[配置应用可用范围](/ssl:ttdoc/home/introduction-to-scope-and-authorization/availability)。获取 open_department_id 方式参考[部门资源介绍](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/field-overview)</md-enum-item>
</md-enum>
