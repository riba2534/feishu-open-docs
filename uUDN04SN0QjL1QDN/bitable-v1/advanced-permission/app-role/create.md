...
新增多维表格高级权限中自定义的角色。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=base&version=v2&resource=app.role&method=create)
...
<md-table>
  ...
  <md-tbody>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="base:role:create" desc="新增自定义角色" support_app_types="custom,isv" tags="">新增自定义角色</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	多维表格数据表的唯一标识。（与上方 table_name 至少填写一项）。获取方式：
