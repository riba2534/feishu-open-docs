...
<md-table>
  ...
  <md-tbody>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="base:role:read" desc="查询自定义角色" support_app_types="custom,isv" tags="">查询自定义角色</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >condition_groups</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >condition_group\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	条件组
	</md-dt-td>
...
<md-dt-tr level="5">
	<md-dt-td>
	<md-text type="field-name" >condition_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >单个条件</md-enum-item>
<md-enum-item key="2" >条件组</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
**可选值有**：
<md-enum>
<md-enum-item key="and" >满足所有条件</md-enum-item>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >display_rec_rule_version</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="0" >仅支持条件</md-enum-item>
<md-enum-item key="1" >支持条件组</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
