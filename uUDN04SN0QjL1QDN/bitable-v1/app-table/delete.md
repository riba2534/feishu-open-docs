---
title: "删除一个数据表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table/delete"
updateTime: "1753076696000"
---

# 删除一个数据表

通过 app_token 和 table_id 删除指定的多维表格数据表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=bitable&version=v1&resource=app.table&method=delete)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/bitable/v1/apps/:app_token/tables/:table_id</md-td>
    </md-tr>
    <md-tr>
