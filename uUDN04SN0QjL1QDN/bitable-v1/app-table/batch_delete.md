---
title: "删除多个数据表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table/batch_delete"
updateTime: "1753076696000"
---

# 删除多个数据表

通过 app_token 和 table_id 删除多个数据表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=bitable&version=v1&resource=app.table&method=batch_delete)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/bitable/v1/apps/:app_token/tables/batch_delete</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="base:table:delete" desc="删除数据表" support_app_types="custom,isv" tags="">删除数据表</md-perm>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	待删除的数据表的 ID。当前一次操作最多支持 50 个数据表。
...
<md-tr>
  <md-td>403</md-td>
  <md-td>1254034</md-td>
  <md-td>The last table cannot be deleted.</md-td>
  <md-td>不能删除最后一张数据表</md-td>
</md-tr>
...
<md-tr>
  <md-td>403</md-td>
  <md-td>1254302</md-td>
  <md-td>Base role permission is missing.</md-td>
