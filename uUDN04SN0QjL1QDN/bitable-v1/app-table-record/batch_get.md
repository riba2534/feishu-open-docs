...
通过多个记录 ID 查询记录信息。该接口最多支持查询 100 条记录。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=bitable&version=v1&resource=app.table.record&method=batch_get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/bitable/v1/apps/:app_token/tables/:table_id/records/batch_get</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	记录 ID 列表。调用[查询记录](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-record/search)获取。
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	创建人 ID。ID 类型与请求体中的 `user_id_type` 指定的类型一致。
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	修改人 ID。ID 类型与请求体中的 `user_id_type` 指定的类型一致。
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >forbidden_record_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	禁止访问的记录列表（针对开启了高级权限的多维表格）
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >absent_record_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-tr>
  ...
  <md-td>Filter长度超限, 限制 2,000 个字符</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>Sort 长度超限, 限制 1,000 个字符</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1254291</md-td>
  <md-td>LockNotObtainedError</md-td>
