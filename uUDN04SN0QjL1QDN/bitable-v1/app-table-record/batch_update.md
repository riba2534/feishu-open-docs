...
更新数据表中的多条记录，单次调用最多更新 1,000 条记录。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=bitable&version=v1&resource=app.table.record&method=batch_update)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/bitable/v1/apps/:app_token/tables/:table_id/records/batch_update</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="base:record:update" desc="更新记录" support_app_types="custom,isv" tags="">更新记录</md-perm>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	数据表中一条记录的唯一标识。通过[查询记录](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-record/search)接口获取。该参数必填，请忽略左侧必填列的“否”
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	用户 ID，ID 类型与 `user_id_type` 所指定的类型一致
	</md-dt-td>
</md-dt-tr>
