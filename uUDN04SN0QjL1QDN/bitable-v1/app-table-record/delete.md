...
| `record_id` | `string` | 数据表中一条记录的唯一标识。通过[查询记录](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-record/search)接口获取。<br>**示例值**："recpCsf4ME" |
