...
获取多维表格数据表中的所有视图。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=bitable&version=v1&resource=app.table.view&method=list)
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >view_public_level</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="Public" >公共视图</md-enum-item>
<md-enum-item key="Locked" >锁定视图</md-enum-item>
<md-enum-item key="Private" >个人视图</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >view_private_owner_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
	<md-dt-td>
	个人视图的所有者的 ID，ID 类型和查询参数 user_id_type 保持一致
	</md-dt-td>
</md-dt-tr>
