---
title: "列出视图"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-view/list"
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `view_public_level` | `string` | 视图公共等级<br>**可选值有**：<br>- `Public`: 公共视图 - `Locked`: 锁定视图 - `Private`: 个人视图 |
