...
获取多维表格中的所有仪表盘。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=bitable&version=v1&resource=app.dashboard&method=list)
...
调用此接口前，请确保当前调用身份（tenant_access_token 或 user_access_token）已有多维表格的阅读等文档权限，否则接口将返回 HTTP 403 或 400 状态码。了解更多，参考[如何为应用或用户开通文档权限](/ssl:ttdoc/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#16c6475a)。
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/bitable/v1/apps/:app_token/dashboards</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >dashboards</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >app.dashboard\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	仪表盘信息
	</md-dt-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1254011</md-td>
  <md-td>The page_size must be between 0 and 100.</md-td>
