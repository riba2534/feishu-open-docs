...
调用此接口前，请确保当前调用身份（tenant_access_token 或 user_access_token）已有原多维表格的阅读权限，否则接口将返回 HTTP 403 或 400 状态码。了解更多，参考[如何为应用或用户开通文档权限](/ssl:ttdoc/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#16c6475a)。
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/bitable/v1/apps/:app_token/dashboards/:block_id/copy</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  ...
  <md-td>1254002</md-td>
  <md-td>Fail</md-td>
  <md-td>导致报 1254002 错误码的场景较多，请参考以下排查建议排查：
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1254032</md-td>
  <md-td>Invalid role name, make sure that it complies with the specification.</md-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1254033</md-td>
  <md-td>Duplicated role name, use another name instead.</md-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1254038</md-td>
  <md-td>Invalid name, make sure that it complies with the specification.</md-td>
  <md-td>名称不规范，名称中不能包含 "[]"，并且不能超过 100 个字符</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1254039</md-td>
  <md-td>Duplicated name, use another name instead.</md-td>
  <md-td>名称与现有仪表盘名称重复，更换名称后重试</md-td>
</md-tr>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1254047</md-td>
  <md-td>Role id is not found.</md-td>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1254049</md-td>
  <md-td>Form field is not found.</md-td>
  <md-td>form_field_id 不存在</md-td>
</md-tr>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1254050</md-td>
  <md-td>Source block is not found.</md-td>
  <md-td>传入了不存在的仪表盘 block_id</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1254110</md-td>
  <md-td>Role exceeds limit</md-td>
