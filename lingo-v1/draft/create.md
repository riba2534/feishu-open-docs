---
title: "创建草稿"
fullPath: "/uAjLw4CM/ukTMukTMukTM/lingo-v1/draft/create"
updateTime: "1698222305000"
---
...
| 支持的应用类型 | custom |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 开启任一权限即可 | `baike:entity` 查看、创建、编辑、删除词典词条 `baike:entity:exempt_review` 创建、更新词典免审词条 |
