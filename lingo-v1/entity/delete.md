---
title: "删除免审词条"
fullPath: "/uAjLw4CM/ukTMukTMukTM/lingo-v1/entity/delete"
updateTime: "1709868771000"
---

# 删除免审词条

通过 entity_id 删除已有的词条，无需经过词典管理员审核。因此，调用该接口时应当慎重操作。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=lingo&version=v1&resource=entity&method=delete)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/lingo/v1/entities/:entity_id</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="baike:entity:exempt_delete" desc="免审删除词典词条" support_app_types="custom" tags="">免审删除词典词条</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
