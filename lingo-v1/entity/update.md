...
通过此接口更新已有的词条，无需经过词典管理员审核，直接写入词库。因此，调用该接口时应当慎重操作。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=lingo&version=v1&resource=entity&method=update)
