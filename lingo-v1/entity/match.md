...
将关键词与词条名、别名精准匹配，并返回对应的 词条 ID。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=lingo&version=v1&resource=entity&method=match)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/lingo/v1/entities/match</md-td>
    </md-tr>
    <md-tr>
