---
title: "获取词条详情"
fullPath: "/uAjLw4CM/ukTMukTMukTM/lingo-v1/entity/get"
updateTime: "1698222353000"
---

# 获取词条详情

通过词条 id 拉取对应的词条详情信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=lingo&version=v1&resource=entity&method=get)
...
<md-dt-tr level="4">
	...
	<md-dt-td>
	通过文件接口上通过文件接口上传图片后，获得的图片 token后的图片 token
	</md-dt-td>
</md-dt-tr>
