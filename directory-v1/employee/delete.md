...
<md-table>
  ...
  <md-tbody>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="directory:employee.resign:write" desc="操作员工离职" support_app_types="custom" tags="">操作员工离职</md-perm>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	飞书问卷接收者。ID值与查询参数中的employee_id_type 对应。
...
<md-tr>
  <md-td>400</md-td>
  <md-td>2221183</md-td>
  <md-td>Unable to delete tenant founder</md-td>
  <md-td>无法删除租户创建人</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>2221185</md-td>
  <md-td>Frequent deletion. User recovered less than an hour ago</md-td>
  <md-td>频繁删除。 用户不到一小时前恢复，请一小时后重试</md-td>
</md-tr>
