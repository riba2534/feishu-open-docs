...
| &nbsp;&nbsp;└ `custom_department_id` | `string` | 否 | 自定义部门ID。注意： 1. 除需要满足正则规则外，同时不能以od-开头 2. 正则校验：^[a-zA-Z0-9][a-zA-Z0-9_\-@.]{0,63}$<br>**数据校验规则**： 长度范围：1-64字符<br>**示例值**："eedasqwA" |
