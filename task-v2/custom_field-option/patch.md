---
title: "更新自定义字段选项"
fullPath: "/uAjLw4CM/ukTMukTMukTM/task-v2/custom_field-option/patch"
updateTime: "1694412819000"
---
...
* `insert_after`: 将当前option放到同字段某个option之后的那个option_guid。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=custom_field.option&method=patch)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/task/v2/custom_fields/:custom_field_guid/options/:option_guid</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="task:tasklist:write" desc="查看、创建、更新、删除协作清单" support_app_types="custom,isv" tags="">查看、创建、更新、删除协作清单</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >option_guid</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	<md-text type="field-type" >input_option</md-text>
	</md-dt-td>
	<md-dt-td>
	否
	</md-dt-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1470400</md-td>
  <md-td>请求参数错误，如提供的`update_fields`中填写不支持更新的名称。</md-td>
  <md-td>根据返回的msg确定错误的实际原因。</md-td>
</md-tr>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1470404</md-td>
  <md-td>要更新的自定义字段或者选项不存在。</md-td>
  <md-td>确认要更新的自定义字段或者选项是否存在。</md-td>
</md-tr>
