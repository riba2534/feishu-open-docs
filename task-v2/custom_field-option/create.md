---
title: "创建自定义任务选项"
fullPath: "/uAjLw4CM/ukTMukTMukTM/task-v2/custom_field-option/create"
updateTime: "1694412798000"
---
...
新添加的选项如果不隐藏，其名字不能和已存在的不隐藏选项的名字重复。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=custom_field.option&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/task/v2/custom_fields/:custom_field_guid/options</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="task:tasklist:read" desc="查看任务协作清单" support_app_types="custom,isv" tags="">查看任务协作清单</md-perm>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1470400</md-td>
  <md-td>参数错误，如`name`超长或字段不是单选/多选类型。</md-td>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1470404</md-td>
  <md-td>要添加选项的自定义字段不存在。</md-td>
  <md-td>确定要添加选项的自定义字段不存在。</md-td>
</md-tr>
