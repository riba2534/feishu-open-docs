...
<md-dt-tr level="0">
	...
	<md-dt-td>
	要删除附件的GUID。可以通过创建[上传附件](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/attachment/upload)接口创建, 或者通过[列取附件](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/attachment/list)接口查询得到。
...
<md-tr>
  <md-td>403</md-td>
  <md-td>1470403</md-td>
  <md-td>缺少删除附件的权限。</md-td>
  <md-td>确认调用身份拥有删除附件的权限。</md-td>
</md-tr>
