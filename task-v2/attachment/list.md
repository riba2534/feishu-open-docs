...
每个附件会返回一个可供下载的临时url，有效期为3分钟，最多可以支持3次下载。如果超过使用限制，需要通过本接口获取新的临时url。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=attachment&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/task/v2/attachments</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="task:attachment:read" desc="查看任务附件" support_app_types="custom,isv" tags="">查看任务附件</md-perm>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	附件归属资源的id，配合resource_type使用。例如希望获取任务的附件，需要设置 resource_type为task， resource_id为任务GUID。任务GUID的获取方式可以参考[任务功能概述](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)。
...
<md-tr>
  ...
  <md-td>1470400</md-td>
  <md-td>请求参数有误</md-td>
  <md-td>查看返回的请求体中的`msg`确定具体原因。</md-td>
</md-tr>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1470404</md-td>
  <md-td>要查询附件的资源不存在或已删除。</md-td>
  <md-td>确认要查询资源是否还存在。</md-td>
</md-tr>
...
<md-tr>
  <md-td>403</md-td>
  <md-td>1470403</md-td>
  <md-td>缺少列取附件的权限。</md-td>
  <md-td>确认调用身份拥有列取附件列表的权限。</md-td>
</md-tr>
