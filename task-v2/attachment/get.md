...
提供一个附件GUID，返回附件的详细信息，包括GUID，名称，大小，上传时间，临时可下载链接等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=attachment&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/task/v2/attachments/:attachment_guid</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	获取详情的附件GUID。可以通过创建[上传附件](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/attachment/upload)接口创建, 或者通过[列取附件](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/attachment/list)接口查询得到。
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1470404</md-td>
  <md-td>附件不存在或已删除。</md-td>
  <md-td>确认附件是否还存在。</md-td>
</md-tr>
...
<md-tr>
  <md-td>403</md-td>
  <md-td>1470403</md-td>
  <md-td>缺少获取附件的权限。</md-td>
  <md-td>确认调用身份拥有获取附件的权限。</md-td>
</md-tr>
