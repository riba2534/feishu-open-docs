...
> **Tip**: 需要父任务的读取权限。详见[任务是如何鉴权的？](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/faq)
...
| 403 | 1470403 | 缺少父任务的读取权限。 | 检查调用身份是否有父任务的读取权限。详见：[任务是如何鉴权的？](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/faq) |
