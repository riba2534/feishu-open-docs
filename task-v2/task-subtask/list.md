---
title: "获取任务的子任务列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/task-v2/task-subtask/list"
updateTime: "1689824569000"
---
...
支持分页，数据按照子任务在界面上的顺序返回。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=task.subtask&method=list)
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1470400</md-td>
  <md-td>请求参数是错误，如父任务GUID不合法，或page_size设为负数等。</md-td>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1470404</md-td>
  <md-td>父任务不存在或者已删除。</md-td>
  <md-td>确认要访问的父任务是否存在或已删除。</md-td>
</md-tr>
...
<md-tr>
  <md-td>403</md-td>
  <md-td>1470403</md-td>
  <md-td>缺少父任务的读取权限。</md-td>
  <md-td>检查调用身份是否有父任务的读取权限。详见：[任务是如何鉴权的？](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/faq)</md-td>
</md-tr>
