...
接口功能除了额外需要输入父任务的GUID之外，和[创建任务](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/task/create)接口功能完全一致。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=task.subtask&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/task/v2/tasks/:task_guid/subtasks</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	任务关联的第三方平台来源信息。详见[如何使用Origin?](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	如果设置，则该任务为“重复任务”。该字段表示了重复任务的重复规则。详见[功能概述](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/overview)中的“如何使用重复任务？”章节。
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	任务自定义完成规则。详见[功能概述](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/overview)中的“如何使用自定义完成？”章节。
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	任务所在清单的信息。如果设置，则表示创建的任务要直接加入到指定清单。
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >subtask</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	开始时间/日期的时间戳，距1970-01-01 00:00:00 UTC的毫秒数。如果开始时间是一个日期，需要把日期转换成时间戳，并设置 is_all_day=true。
	</md-dt-td>
</md-dt-tr>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1470404</md-td>
  <md-td>父任务数据不存在或者已删除。</md-td>
  <md-td>确认父任务数据是否存在或已删除。</md-td>
</md-tr>
...
<md-tr>
  <md-td>403</md-td>
  <md-td>1470403</md-td>
  <md-td>缺少父任务的编辑权限。</md-td>
  <md-td>检查调用身份是否有父任务的可编辑权限。详情见[任务功能概述](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节。</md-td>
</md-tr>
...
<md-tr>
  <md-td>500</md-td>
  <md-td>1470422</md-td>
  <md-td>使用相同的client_token并发调用接口。</md-td>
  <md-td>不要使用相同的client_token并发调用接口。</md-td>
</md-tr>
