...
获取一个清单的详细信息，包括清单名，所有者，清单成员等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=tasklist&method=get)

:::html
<md-alert type="tip">
需要清单的读取权限。详情见[清单功能概述](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/overview)中的“清单是如何鉴权的？“章节。
</md-alert>
:::
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1470400</md-td>
  <md-td>请求参数错误，例如提供的清单GUID不合法。</md-td>
...
<md-tr>
  <md-td>403</md-td>
  <md-td>1470403</md-td>
  <md-td>缺少清单读取权限。</md-td>
  <md-td>检查调用身份是否有清单的读取权限。详情见[清单功能概述](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/overview)中的“清单是如何鉴权的？“章节。</md-td>
</md-tr>
