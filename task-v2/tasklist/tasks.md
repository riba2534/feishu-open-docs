---
title: "获取清单任务列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/tasks"
updateTime: "1761276990000"
---
...
分页参数说明：是否还有分页数据的判断依据是has_more=true，并非items个数，由于历史原因可能出现当前分页items为空情况。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=tasklist&method=tasks)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/task/v2/tasklists/:tasklist_guid/tasks</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="task:tasklist:read" desc="查看任务清单" support_app_types="custom,isv" tags="">查看任务清单</md-perm>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >completed</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >created_from</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >created_to</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >task_summary\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	任务摘要数据
	</md-dt-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1470400</md-td>
  <md-td>The request parameter is incorrect, such as the tasklist GUID is invalid, or the page_size is a negative number, etc.</md-td>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1470404</md-td>
  <md-td>The tasklist does not exist or has been deleted.</md-td>
  <md-td>确认要获取任务列表的清单是否存在或已删除。</md-td>
</md-tr>
...
<md-tr>
  <md-td>403</md-td>
  <md-td>1470403</md-td>
  <md-td>Missing read permission for tasklist.</md-td>
  <md-td>检查调用身份是否有清单的读取权限。详见[清单是如何鉴权的？](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/faq)</md-td>
</md-tr>
