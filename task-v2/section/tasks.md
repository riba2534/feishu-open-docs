---
title: "获取自定义分组任务列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/task-v2/section/tasks"
updateTime: "1691405538000"
---

# 列取自定义分组中的任务

列取一个自定义分组里的所有任务。支持分页。任务按照自定义排序的顺序返回。本接口支持简单的过滤。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=section&method=tasks)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/task/v2/sections/:section_guid/tasks</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="task:section:read" desc="查看自定义分组" support_app_types="custom,isv" tags="">查看自定义分组</md-perm>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1470400</md-td>
  <md-td>请求参数错误，如提供的`section_guid`不合法。</md-td>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1470404</md-td>
  <md-td>要访问的自定义分组不存在或已删除。</md-td>
  <md-td>确定要访问的自定义分组不存在或已删除。</md-td>
</md-tr>
...
<md-tr>
  <md-td>403</md-td>
  <md-td>1470403</md-td>
  <md-td>缺少获取自定义分组下任务列表的权限。</md-td>
  <md-td>确认调用身份拥有获取自定义分组归属资源的读取权限。</md-td>
</md-tr>
