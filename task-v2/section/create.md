---
title: "创建自定义分组"
fullPath: "/uAjLw4CM/ukTMukTMukTM/task-v2/section/create"
updateTime: "1691405478000"
---
...
当为我负责任务列表中创建自定义分组时，需要设置`resource_type`为"my_tasks"，不需要设置`resource_id`。调用身份只能为自己的我负责的任务列表创建自定义分组。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=section&method=create)
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1470400</md-td>
  <md-td>请求参数有误，比如同时设置`insert_before`和`insert_after`。</md-td>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1470404</md-td>
  <md-td>要创建自定义分组的归属资源不存在或已删除。</md-td>
  <md-td>确认资源数据是否存在或已删除。</md-td>
</md-tr>
...
<md-tr>
  <md-td>403</md-td>
  <md-td>1470403</md-td>
  <md-td>缺少创建自定义分组的权限。</md-td>
  <md-td>确认调用身份是否有创建自定义分组的权限。</md-td>
</md-tr>
