---
title: "获取自定义分组详情"
fullPath: "/uAjLw4CM/ukTMukTMukTM/task-v2/section/get"
updateTime: "1691461226000"
---

# 获取自定义分组详情

获取一个自定义分组详情，包括名称，创建人等信息。如果该自定义分组归属于一个清单，还会返回清单的摘要信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=section&method=get)
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1470400</md-td>
  <md-td>请求参数有误，如传入的`section_guid`不合法。</md-td>
  <md-td>具体错误原因参考返回的msg提示的错误信息。</md-td>
</md-tr>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1470404</md-td>
  <md-td>要获取的自定义分组不存在或已删除。</md-td>
  <md-td>确认自定义分组不存在或已删除。</md-td>
</md-tr>
...
<md-tr>
  <md-td>403</md-td>
  <md-td>1470403</md-td>
  <md-td>缺少访问自定义分组的权限。</md-td>
  <md-td>确认调用身份拥有访问自定义分组的权限。</md-td>
</md-tr>
