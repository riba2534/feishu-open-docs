...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| `tasklist_guid` | `string` | 清单GUID。可以通过[创建清单](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/create)，或者通过[获取清单列表](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/list)接口查询得到。<br>**示例值**："d19e3a2a-edc0-4e4e-b7cc-950e162b53ae" |
