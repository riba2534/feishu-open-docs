---
title: "列取动态订阅"
fullPath: "/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist-activity_subscription/list"
updateTime: "1699521015000"
---

# 列取动态订阅

给定一个清单的GUID，获取其所有的订阅信息。结果按照订阅的创建时间排序。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=tasklist.activity_subscription&method=list)
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1470400</md-td>
  <md-td>请求有误，如输入的清单GUID不合法。</md-td>
  <md-td>查看返回的msg以确定原因。</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>1470500</md-td>
  <md-td>服务器错误。</md-td>
  <md-td>尝试用同样参数重复调用接口。如果错误持续，请联系技术支持人员协助。</md-td>
</md-tr>
