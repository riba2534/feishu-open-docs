---
title: "任务移出清单"
fullPath: "/uAjLw4CM/ukTMukTMukTM/task-v2/task/remove_tasklist"
updateTime: "1689824522000"
---
...
如果任务不在清单中，接口将返回成功。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=task&method=remove_tasklist)

:::html
<md-alert type="tip">
需要清单的可编辑权限。详情见[清单功能概述](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/overview)中的“清单是如何鉴权的？“章节。
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/task/v2/tasks/:task_guid/remove_tasklist</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1470400</md-td>
  <md-td>请求参数错误，如传入的清单GUID不合法。</md-td>
...
<md-tr>
  <md-td>403</md-td>
  <md-td>1470403</md-td>
  <md-td>缺少任务移出清单的权限。</md-td>
  <md-td>检查调用身份是否有清单的可编辑权限。详情见[清单功能概述](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/overview)中的“清单是如何鉴权的？“章节。</md-td>
</md-tr>
