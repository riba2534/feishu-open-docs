---
title: "列取任务所在清单"
fullPath: "/uAjLw4CM/ukTMukTMukTM/task-v2/task/tasklists"
updateTime: "1689824499000"
---
...
只有调用身份有权限访问的清单信息会被返回。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=task&method=tasklists)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/task/v2/tasks/:task_guid/tasklists</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1470400</md-td>
  <md-td>请求参数错误，例如填写的任务GUID非法。</md-td>
...
<md-tr>
  <md-td>403</md-td>
  <md-td>1470403</md-td>
  <md-td>缺少任务读取权限。</md-td>
  <md-td>检查调用身份是否有任务的读取权限。详情见[任务功能概述](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节。</md-td>
</md-tr>
