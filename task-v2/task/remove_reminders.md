---
title: "移除任务提醒"
fullPath: "/uAjLw4CM/ukTMukTMukTM/task-v2/task/remove_reminders"
updateTime: "1689824545000"
---
...
如果要移除的提醒本来就不存在，本接口将直接返回成功。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=task&method=remove_reminders)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/task/v2/tasks/:task_guid/remove_reminders</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >reminder_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1470400</md-td>
  <md-td>请求参数错误，如传入的`reminder_id`值不合法。</md-td>
...
<md-tr>
  ...
  <md-td>检查调用身份是否有任务的编辑权限。详情见[任务功能概述](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节。</md-td>
</md-tr>
