---
title: "移除任务成员"
fullPath: "/uAjLw4CM/ukTMukTMukTM/task-v2/task/remove_members"
updateTime: "1691401913000"
---

# 移除任务成员

移除任务成员。一次性可以移除多个成员。可以移除任务的负责人或者关注人。移除时，如果要移除的成员不是任务成员，会被自动忽略。本接口返回移除成员后的任务数据，包含移除后的任务成员列表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=task&method=remove_members)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/task/v2/tasks/:task_guid/remove_members</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1470400</md-td>
  <md-td>请求参数是错误，如任务GUID不合法，成员角色不是"assignee"和"follower"等。</md-td>
...
<md-tr>
  ...
  <md-td>确认要移除成员的任务是否存在或已删除。</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>确认调用身份拥有任务的编辑权限。详情见[任务功能概述](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节。</md-td>
</md-tr>
