---
title: "移除依赖"
fullPath: "/uAjLw4CM/ukTMukTMukTM/task-v2/task/remove_dependencies"
updateTime: "1694419149000"
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/task/v2/tasks/:task_guid/remove_dependencies</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1470400</md-td>
  <md-td>请求参数错误，如输入的`task_guid`非法。</md-td>
...
<md-tr>
  <md-td>403</md-td>
  <md-td>1470403</md-td>
  <md-td>缺少任务的可编辑权限。</md-td>
  <md-td>移除依赖需要当前任务的编辑权限。</md-td>
</md-tr>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1470404</md-td>
  <md-td>要移除依赖的任务不存在或已删除。</md-td>
  <md-td>确认当前任务是否存在或被删除。</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>1470500</md-td>
  <md-td>服务器错误。</md-td>
  <md-td>服务器内部错误。若多次重试调用后持续出错可以联系支持。</md-td>
</md-tr>
