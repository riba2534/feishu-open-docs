...
根据一个自定义字段的GUID，获取其详细的设置信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=custom_field&method=get)
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	自定义字段GUID。可以通过[创建自定义字段](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/custom_field/create)接口创建, 或者通过[列取自定义字段](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/custom_field/list)接口查询得到。
...
**可选值有**：
<md-enum>
<md-enum-item key="normal" >常规数字格式</md-enum-item>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1470400</md-td>
  <md-td>请求参数有误，如传入的custom_field_guid不合法。</md-td>
  <md-td>查看返回的msg确定具体错误原因。</md-td>
</md-tr>
...
<md-tr>
  <md-td>403</md-td>
  <md-td>1470403</md-td>
  <md-td>缺少查看自定义字段的权限。</md-td>
  <md-td>确认调用身份拥有查看自定义字段的权限。</md-td>
</md-tr>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1470404</md-td>
  <md-td>要查看的自定义字段不存在。</md-td>
  <md-td>确认要查看的自定义字段是否存在。</md-td>
</md-tr>
