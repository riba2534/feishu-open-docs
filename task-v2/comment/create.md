---
title: "创建评论"
fullPath: "/uAjLw4CM/ukTMukTMukTM/task-v2/comment/create"
updateTime: "1691401975000"
---
...
若要创建一个回复评论，需要在创建时设置`reply_to_comment_id`字段。被回复的评论和新建的评论必须属于同一个任务。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=comment&method=create)
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	评论归属的资源类型，目前只支持任务“task”，默认为"task"。
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	评论归属的资源ID。当归属资源类型为"task"时，这里应填写任务的GUID。
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1470404</md-td>
  <md-td>要评论的资源不存在或已删除。</md-td>
  <md-td>检查要评论的资源是否存在或已被删除。</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>1470403</md-td>
  <md-td>缺少评论权限。</md-td>
  <md-td>对任务进行评论时需要评论的读取权限。详情见[清单功能概述](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/overview)中的“清单是如何鉴权的？“章节。</md-td>
</md-tr>
