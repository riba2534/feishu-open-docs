...
支持分页。评论可以按照创建时间的正序（asc, 从最老到最新），或者逆序（desc，从最老到最新），返回数据。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=task&version=v2&resource=comment&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/task/v2/comments</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="task:comment:read" desc="查看任务评论" support_app_types="custom,isv" tags="">查看任务评论</md-perm>
            <md-perm name="task:comment:write" desc="查看、创建、修改、删除任务评论" support_app_types="custom,isv" tags="">查看、创建、修改、删除任务评论</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
**可选值有**：
<md-enum>
<md-enum-item key="asc" >评论发表时间升序</md-enum-item>
<md-enum-item key="desc" >评论发表时间降序</md-enum-item>
</md-enum>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1470400</md-td>
  <md-td>请求参数错误，如传入了不支持的resource_type。</md-td>
...
<md-tr>
  <md-td>404</md-td>
  <md-td>1470404</md-td>
  <md-td>要获取列表的资源不存在或已删除。</md-td>
  <md-td>确认要获取列表的资源不存在或已删除。</md-td>
</md-tr>
...
<md-tr>
  <md-td>403</md-td>
  <md-td>1470403</md-td>
  <md-td>缺少获取评论列表的权限。</md-td>
  <md-td>获取一个任务的评论列表需要该任务的读取权限，详见[任务是如何鉴权的？](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/task-v2/faq)</md-td>
</md-tr>
