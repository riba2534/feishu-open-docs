---
title: "获取应用反馈列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/application-v6/application-feedback/list"
updateTime: "1721719962000"
---

# 获取应用反馈列表

查询应用的反馈数据{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=application&version=v6&resource=application.feedback&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/application/v6/applications/:app_id/feedbacks</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="application:application.feedback.feedback_info" desc="管理应用反馈数据" support_app_types="custom,isv" tags="">管理应用反馈数据</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >from_date</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >to_date</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >feedback_type</md-text>
	</md-dt-td>
	<md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >故障反馈</md-enum-item>
<md-enum-item key="2" >产品建议</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
**可选值有**：
<md-enum>
<md-enum-item key="0" >反馈未处理</md-enum-item>
<md-enum-item key="1" >反馈已处理</md-enum-item>
<md-enum-item key="2" >反馈处理中</md-enum-item>
<md-enum-item key="3" >反馈已关闭</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >feedback_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >application.feedback\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	应用的反馈列表
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >feedback_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >feedback_time</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >tenant_name</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >fault_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >fault_time</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >小程序</md-enum-item>
<md-enum-item key="2" >网页应用</md-enum-item>
<md-enum-item key="3" >机器人</md-enum-item>
<md-enum-item key="4" >WebSDK</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >contact</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >feedback_path</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-tr>
  ...
  <md-td>当前租户中不存在目标应用。请检查被查询应用与当前调用接口应用是否在同一企业内</md-td>
</md-tr>
