...
查看应用在某一天/某一周/某一个月的使用数据，可以根据部门做多层子部门的筛选{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=application&version=v6&resource=application.app_usage&method=department_overview)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/application/v6/applications/:app_id/app_usage/department_overview</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >recursion</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >application.department_app_usage\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	部门内员工使用应用的概览数据
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >webapp</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >application.app_usage\[\]</md-text>
	</md-dt-td>
