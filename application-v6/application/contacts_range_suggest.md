...
fullPath: "/uAjLw4CM/ukTMukTMukTM/application-v6/application-app_version/contacts_range_suggest"
updateTime: "1689924101000"
---

# 获取应用版本中开发者申请的通讯录权限范围

该接口用于根据应用的 App ID 和版本 ID 获取企业自建应用某个版本的通讯录权限范围。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=application&version=v6&resource=application.app_version&method=contacts_range_suggest)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/application/v6/applications/:app_id/app_versions/:version_id/contacts_range_suggest</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >contacts_range</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >application.app_contacts_range</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >contacts_scope_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="equal_to_availability" >与应用可用范围一致，可通过[获取应用在企业内的可用范围](/ssl:ttdoc/ukTMukTMukTM/uIjM3UjLyIzN14iMycTN)接口查询具体人员</md-enum-item>
<md-enum-item key="some" >部分成员，具体人员参见visible_list</md-enum-item>
<md-enum-item key="all" >全部成员</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-tr>
  ...
  <md-td>请检查应用已申请权限与被查询 app_id，当被查询 app_id 非本应用且未申请<md-perm name="application:application.app_version:readonly" desc="获取应用版本信息" support_app_types="custom" tags="">获取应用版本信息</md-perm>权限时，返回该错误码</md-td>
</md-tr>
