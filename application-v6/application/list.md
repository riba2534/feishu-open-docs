...
根据 app_id 获取对应应用版本列表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=application&version=v6&resource=application.app_version&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/application/v6/applications/:app_id/app_versions</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>210514</md-td>
  <md-td>invalid order</md-td>
  <md-td>请检查 order 范围是否在 [0, 1] 范围内</md-td>
</md-tr>
