...
> **Tip**: 若用 user_access_token 代表某个终端用户操作API，则需确保该用户为应用当前的所有者，否则无法操作成功。
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| `app_id` | `string` | 应用 ID，获取方式参见 [app_id](https://open.larkoffice.com/document/ukTMukTMukTM/uYTM5UjL2ETO14iNxkTN/terminology#b047be0c)。<br>**示例值**："cli_a306c5476fb8d00c" |
