---
title: "应用创建"
fullPath: "/uAjLw4CM/ukTMukTMukTM/application-v6/application/events/created"
updateTime: "1726661618000"
---
...
| 支持的应用类型 | custom |
| 权限要求             订阅该事件所需的权限，开启其中任意一项权限即可订阅 | `admin:app.info:readonly` 获取应用信息 |
...
| &nbsp;&nbsp;└ `create_source` | `string` | 应用创建来源<br>**可选值有**：<br>- `developer_console`: 开发者后台 - `base`: 多维表格自动化流程创建的应用 - `app_engine`: 飞书应用引擎 - `bot_builder`: 机器人助手 - `aily`: aily(智能伙伴搭建平台) - `unknown`: 未知来源 |
