...
该接口用于查询用户、部门、用户组是否在应用的可用或禁用名单中{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=application&version=v6&resource=application.visibility&method=check_white_black_list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/application/v6/applications/:app_id/visibility/check_white_black_list</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >user_visibility_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >application.visibility.user_white_black_info\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >in_white_list</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >in_black_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >boolean</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >in_paid_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >boolean</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >department_visibility_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >application.visibility.department_white_black_info\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >group_visibility_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >application.visibility.group_white_black_info\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
