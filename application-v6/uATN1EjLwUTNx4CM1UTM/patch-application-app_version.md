---
title: "更新应用审核状态"
fullPath: "/uAjLw4CM/ukTMukTMukTM/application-v6/application-app_version/patch"
...
| 支持的应用类型 | custom |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 | `application:application.app_version` 更新应用版本信息 |
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `status` | `int` | 否 | 版本状态<br>**示例值**：1<br>**可选值有**：<br>- `0`: 未知状态 - `1`: 审核通过 - `2`: 审核拒绝 - `3`: 审核中 - `4`: 未提交审核 |
