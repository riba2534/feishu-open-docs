---
title: "获取应用通讯录权限范围配置"
fullPath: "/uAjLw4CM/ukTMukTMukTM/application-v6/application/contacts_range_configuration"
updateTime: "1689924100000"
---

# 获取应用通讯录权限范围配置

获取当前企业内某个自建应用线上实际生效的通讯录权限范围配置。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=application&version=v6&resource=application&method=contacts_range_configuration)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/application/v6/applications/:app_id/contacts_range_configuration</md-td>
    </md-tr>
    <md-tr>
