---
title: "查询应用管理员列表"
fullPath: "/ukTMukTMukTM/ucDOwYjL3gDM24yN4AjN"
updateTime: "1660049326000"
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/user/v4/app_admin_user/list</md-td>
    </md-tr>
    <md-tr>
...
<div style="color: rgb(100, 106, 115);font-size: 12px;line-height: 20px;white-space: pre-line;font-weight: 500;padding-top: 4px;">开启任一权限即可</div>
      ...
      <md-td>
<md-perm name="admin:app.admin_id:readonly" desc="获取应用管理员 ID" support_app_types="custom,isv" tags="">获取应用管理员 ID</md-perm>
...
<md-perm name="contact:user.employee_id:readonly" desc="获取用户 userid" support_app_types="custom" tags="">获取用户 userid</md-perm>
</md-td>
    </md-tr>
  </md-tbody>
</md-table>
