...
| 400 | 213007 | user is invisible | 当前应用对用户不可见。请参考[配置应用可用范围](https://open.larkoffice.com/document/home/introduction-to-scope-and-authorization/availability)确保用户在应用可见范围内 |
