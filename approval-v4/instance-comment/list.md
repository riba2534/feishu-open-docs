---
title: "获取评论"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance-comment/list"
...
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 开启任一权限即可 | `approval:approval` 查看、创建、更新、删除审批应用相关信息 `approval:approval:readonly` 访问审批应用 `approval:instance.comment` 查看、创建、更新、删除原生审批评论相关信息 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `is_delete` | `int` | 是否删除。可能值有：<br>- 0：未删除 - 1：已删除 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `name` | `string` | 被艾特人的姓名 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `offset` | `string` | 被艾特人在评论中的位置，从 0 开始。例如：<br>- 取值为 0 时的效果：@username 示例文本 - 取值为 2 时的效果：示例 @username 文本 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `commentator` | `string` | 评论创建人 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `extra` | `string` | 附加字段 |
