---
title: "查询抄送列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/search_cc"
updateTime: "1745207137000"
---

# 查询抄送列表

该接口通过不同条件查询审批系统中符合条件的审批抄送列表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=approval&version=v4&resource=instance&method=search_cc)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/approval/v4/instances/search_cc</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >cc_title</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >cc_create_time_from</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
	...
	<md-dt-td>
	抄送查询开始时间，Unix 毫秒时间戳。与 cc_create_time_from 参数构成时间段查询条件，仅会返回在该时间段内的审批抄送。
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >cc_create_time_to</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
	...
	<md-dt-td>
	抄送查询结束时间，Unix 毫秒时间戳。与 cc_create_time_from 参数构成时间段查询条件，仅会返回在该时间段内的审批抄送。
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >cc_search_item\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	审批抄送列表
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >cc_search_node</md-text>
	</md-dt-td>
	<md-dt-td>
	审批抄送信息
	</md-dt-td>
