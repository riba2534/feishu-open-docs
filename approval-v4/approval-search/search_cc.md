...
| `read_status` | `string` | 否 | 审批抄送状态。<br>**注意**：若不设置则查询全部状态，若不在集合中，则报错。<br>**示例值**："read"<br>**可选值有**：<br>- `READ`: 已读 - `UNREAD`: 未读 - `ALL`: 所有状态 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `read_status` | `string` | 审批抄送状态<br>**可选值有**：<br>- `read`: 已读 - `unread`: 未读 |
