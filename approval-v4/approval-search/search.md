...
该接口通过不同条件查询审批系统中符合条件的审批任务列表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=approval&version=v4&resource=task&method=search)
...
- 该接口查询结果可能存在延迟，无法保证实时性。如需实时查询，建议使用[查询用户的任务列表](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/task/query)。
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/approval/v4/tasks/search</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >instance_external_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >group_external_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >task_title</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-enum-item key="APPROVED" >已通过</md-enum-item>
<md-enum-item key="TRANSFERRED" >已转交</md-enum-item>
<md-enum-item key="DONE" >已完成</md-enum-item>
<md-enum-item key="RM_REPEAT" >去重</md-enum-item>
<md-enum-item key="PROCESSED" >已处理</md-enum-item>
<md-enum-item key="ALL" >所有状态</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >task_start_time_from</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
	...
	<md-dt-td>
	任务查询开始时间，Unix 毫秒时间戳。与 task_start_time_to 参数构成时间段查询条件，仅会返回在该时间段内的审批任务。
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >task_start_time_to</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
	...
	<md-dt-td>
	任务查询结束时间，Unix 毫秒时间戳。与 task_start_time_from 参数构成时间段查询条件，仅会返回在该时间段内的审批任务。
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >task_status_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
	...
	<md-dt-td>
	查询多种状态的任务，当填写此参数时，task_status 参数将失效。
...
**可选值有**：
<md-enum>
<md-enum-item key="0" >按审批任务更新时间（update_time）倒排。</md-enum-item>
<md-enum-item key="1" >按审批任务更新时间（update_time）正排。</md-enum-item>
<md-enum-item key="2" >按审批任务开始时间（start_time）倒排。</md-enum-item>
<md-enum-item key="3" >按审批任务开始时间（start_time）正排。</md-enum-item>
</md-enum>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >count</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >task_search_item\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	审批任务列表
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >approval</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >instance_search_approval</md-text>
	</md-dt-td>
	<md-dt-td>
	审批定义信息
	</md-dt-td>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	<md-text type="field-type" >instance_search_approval_external</md-text>
	</md-dt-td>
	<md-dt-td>
	第三方审批信息
	</md-dt-td>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >batch_cc_read</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >boolean</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >instance_search_group</md-text>
	</md-dt-td>
	<md-dt-td>
	审批定义分组
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >instance</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >instance_search_node</md-text>
	</md-dt-td>
	<md-dt-td>
	审批实例信息
	</md-dt-td>
...
<md-enum-item key="rejected" >已拒绝</md-enum-item>
<md-enum-item key="pending" >审批中</md-enum-item>
<md-enum-item key="canceled" >已撤回</md-enum-item>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >serial_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	<md-text type="field-type" >instance_search_link</md-text>
	</md-dt-td>
	<md-dt-td>
	审批实例链接（只有第三方审批有返回值）
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >task_search_node</md-text>
	</md-dt-td>
	<md-dt-td>
	审批任务信息
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >task_external_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
