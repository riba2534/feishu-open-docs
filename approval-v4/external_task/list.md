...
该接口用于获取三方审批的状态。用户传入查询条件，接口返回满足条件的审批实例的状态。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=approval&version=v4&resource=external_task&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/approval/v4/external_tasks</md-td>
    </md-tr>
    <md-tr>
