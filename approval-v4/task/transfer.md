---
title: "转交审批任务"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/task/transfer"
updateTime: "1745206965000"
---

# 转交审批任务

对于单个审批任务进行转交操作。转交后审批流程流转给被转交人。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=approval&version=v4&resource=task&method=transfer)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/approval/v4/tasks/transfer</md-td>
    </md-tr>
    <md-tr>
