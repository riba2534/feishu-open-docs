---
title: "审批实例状态变更"
fullPath: "/ukTMukTMukTM/uIDO24iM4YjLygjN/event/common-event/approval-instance-event"
updateTime: "1746601193000"
---
...
| &nbsp;&nbsp;└ status | string | 审批实例状态。可能值有： - PENDING：审批中 - APPROVED：已通过 - REJECTED：已拒绝 - CANCELED：已撤回 - DELETED：已删除 - REVERTED：已撤销 - OVERTIME_CLOSE：超时被关闭 - OVERTIME_RECOVER：超时实例被恢复 |
...
| &nbsp;&nbsp;└ uuid | string | 如果[创建审批实例](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/create)时传入了 uuid，则此处返回该实例的 uuid。 |
