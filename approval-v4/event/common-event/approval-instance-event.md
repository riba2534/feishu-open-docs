...
<md-dt-td>uuid</md-dt-td>
<md-dt-td>string</md-dt-td>
<md-dt-td>如果[创建审批实例](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/create)时传入了 uuid，则此处返回该实例的 uuid。</md-dt-td>
</md-dt-tr>
