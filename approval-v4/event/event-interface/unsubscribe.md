---
title: "取消订阅审批事件"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/approval/unsubscribe"
updateTime: "1742781452000"
---

# 取消订阅审批事件

调用[订阅审批事件](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/approval/subscribe)接口订阅审批定义 Code 后，如果不再需要接收该审批定义下的事件订阅通知，可以调用本接口取消订阅审批定义 Code，取消后应用无法再收到该审批定义对应实例的事件通知。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=approval&version=v4&resource=approval&method=unsubscribe)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/approval/v4/approvals/:approval_code/unsubscribe</md-td>
    </md-tr>
    <md-tr>
