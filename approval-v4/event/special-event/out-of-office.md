---
title: "外出审批"
fullPath: "/ukTMukTMukTM/uIDO24iM4YjLygjN/event/out-of-office"
updateTime: "1747722084000"
---
...
| &nbsp;&nbsp;└ open_id | string | 审批发起人的 open_id。你可以调用[获取单个用户信息](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/user/get)接口，通过 open_id 获取用户信息。 |
...
| &nbsp;&nbsp;└ out_unit | string | 外出时长的单位，该单位对应填写表单时显示的时长单位。例如表单的外出时长单位是小时，则这里取值 HOUR。<br>- HOUR：小时 - DAY：天 - HALR_DAY：半天 |
| &nbsp;&nbsp;└ tenant_key | string | 租户 Key，是企业的唯一标识。 |
| &nbsp;&nbsp;└ type | string | 事件类型。固定值 `out_approval` |
| &nbsp;&nbsp;└ user_id | string | 审批发起人的 user_id。你可以调用[获取单个用户信息](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/user/get)接口，通过 user_id 获取用户信息。 |
