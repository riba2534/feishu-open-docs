---
title: "获取关联组织详情"
fullPath: "/uAjLw4CM/ukTMukTMukTM/trust_party-v1/collaboration_tenant/get"
updateTime: "1745918482000"
---
...
| HTTP状态码 | 错误码 | 描述 | 排查建议 |
| --- | --- | --- | --- |
| 400 | 1971001 | User not visible to target tenant. | 配置用户对关联组织的可见性，请[更新可搜可见规则](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/directory-v1/collaboration_rule/update)来让用户对关联组织可见 |
