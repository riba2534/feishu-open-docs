...
在创建规则时，需要知道对方组织的tenant key，可通过该接口获取有效的tenant key。只允许关联组织管理员权限调用。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=directory&version=v1&resource=collaboration_tenant&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/directory/v1/collaboration_tenants</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >short_name</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >i18n_text</md-text>
	</md-dt-td>
...
<md-tr>
  ...
  <md-td>需要有关联组织管理员的权限，请联系本租户超管将你配置为关联组织管理员
