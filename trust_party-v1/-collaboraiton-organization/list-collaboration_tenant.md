...
分页获取用户可见的关联列表。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=trust_party&version=v1&resource=collaboration_tenant&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/trust_party/v1/collaboration_tenants</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >target_tenant_list</md-text>
	</md-dt-td>
	<md-dt-td>
