---
title: "查询可搜可见规则"
fullPath: "/uAjLw4CM/ukTMukTMukTM/directory-v1/collaboration_rule/list"
updateTime: "1745918567000"
---

# 查询可搜可见规则

管理员视角查询可搜可见规则。用户需具备关联组织管理员权限。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=directory&version=v1&resource=collaboration_rule&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/directory/v1/collaboration_rules</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="trust_party:collaboration_rule:read" desc="获取关联组织协作规则" support_app_types="custom" tags="">获取关联组织协作规则</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >collaboration_rule\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	规则列表
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >subject_is_valid</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >object_is_valid</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >boolean</md-text>
	</md-dt-td>
