...
管理员视角删除可搜可见规则。用户需具备关联组织管理员权限。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=directory&version=v1&resource=collaboration_rule&method=delete)
...
<md-tr>
  ...
  <md-td>无操作权限，请联系超管配置你为关联组织管理员权限</md-td>
</md-tr>
