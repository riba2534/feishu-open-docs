...
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/exchange_binding/delete"
updateTime: "1720582463000"
---

# 解除 Exchange 账户绑定

调用该接口解除 Exchange 账户和飞书账户的绑定关系，Exchange 账户解除绑定后才能和其他飞书账户继续绑定。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=calendar&version=v4&resource=exchange_binding&method=delete)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/calendar/v4/exchange_bindings/:exchange_binding_id</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            ...
            <md-perm name="calendar:exchange.bindings:delete" desc="删除 Exchange 绑定关系" support_app_types="custom,isv" tags="">删除 Exchange 绑定关系</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	Exchange 绑定的唯一标识 ID。调用 [将 Exchange 账户绑定到飞书账户](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/exchange_binding/create) 绑定时，可从返回结果中获取 exchange_binding_id。
