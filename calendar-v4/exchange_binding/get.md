...
调用该接口获取 Exchange 账户的绑定状态，包括 Exchange 日历的同步状态。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=calendar&version=v4&resource=exchange_binding&method=get)
  ...
  <md-tbody>
    ...
    <md-tr>
      ...
      <md-td>
            ...
            <md-perm name="calendar:exchange.bindings:read" desc="读取 Exchange 绑定关系" support_app_types="custom,isv" tags="">读取 Exchange 绑定关系</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
