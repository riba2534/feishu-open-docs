---
title: "解绑会议群"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-event-meeting_chat/delete"
updateTime: "1721111428000"
---

# 解绑会议群

调用该接口以当前身份（应用或用户）为日程解绑已创建的会议群。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=calendar&version=v4&resource=calendar.event.meeting_chat&method=delete)
...
<md-tr>
  <md-td>403</md-td>
  <md-td>195107</md-td>
  <md-td>no permission unbind meeting chat</md-td>
  <md-td>没有权限解绑会议群。你需要检查当前身份是否为群主。</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>195108</md-td>
  <md-td>chat not match with event</md-td>
  <md-td>传入的群 ID 和日程不匹配，无法解绑会议群。需检查输入参数是否填写正确。</md-td>
</md-tr>
