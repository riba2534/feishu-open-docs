...
调用该接口以当前身份（应用或用户）删除指定日程的一个或多个参与人。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=calendar&version=v4&resource=calendar.event.attendee&method=batch_delete)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/calendar/v4/calendars/:calendar_id/events/:event_id/attendees/batch_delete</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >attendee_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >delete_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >calendar.event.attendee_id\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	否
	</md-dt-td>
