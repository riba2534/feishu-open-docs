---
title: "删除请假日程"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/timeoff_event/delete"
updateTime: "1721111429000"
---

# 删除请假日程

调用该接口删除一个指定的请假日程。请假日程删除后，用户个人签名页的请假信息也会消失。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=calendar&version=v4&resource=timeoff_event&method=delete)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/calendar/v4/timeoff_events/:timeoff_event_id</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="calendar:time_off:delete" desc="删除请假日程" support_app_types="custom,isv" tags="">删除请假日程</md-perm>
...
<md-tr>
  ...
  <md-td>无权删除请假日程。你需要检查请假日程是否是当前应用创建的，并修改为正确的请假日程 ID。</md-td>
</md-tr>
