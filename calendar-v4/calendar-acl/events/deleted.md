...
:::html
<md-alert type="warn">
你需要先为用户[订阅日历访问控制变更事件](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-acl/subscription)，并且需要在应用中配置事件订阅，这样才可以在事件触发时接收到事件数据。了解事件订阅参见[事件订阅概述](/ssl:ttdoc/ukTMukTMukTM/uUTNz4SN1MjL1UzM)。
</md-alert>
:::
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>calendar.calendar.acl.deleted_v4</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	<md-text type="field-type" >calendar.acl_event</md-text>
	</md-dt-td>
	<md-dt-td>
	\-
	</md-dt-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >acl_scope_event</md-text>
	</md-dt-td>
	<md-dt-td>
	权限生效范围。
	</md-dt-td>
