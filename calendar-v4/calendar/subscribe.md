...
调用该接口以当前身份（应用或用户）订阅指定的日历。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=calendar&version=v4&resource=calendar&method=subscribe)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/calendar/v4/calendars/:calendar_id/subscribe</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            ...
            <md-perm name="calendar:calendar:subscribe" desc="订阅、退订日历" support_app_types="custom,isv" tags="">订阅、退订日历</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-tr>
  ...
  <md-td>订阅日历数量已达上限（同一身份可订阅日历数量上限为 1000）。建议取消订阅其他不再使用的日历，然后重试。</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>- 不允许订阅机器人的主日历。
- 不允许订阅其他租户或者公开范围为私密的日历。你可以调用[查询日历信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/get)接口获取日历的公开范围、类型以及访问权限等信息，并确保传入的日历适用于当前接口。</md-td>
</md-tr>
