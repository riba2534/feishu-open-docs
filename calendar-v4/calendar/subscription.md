---
title: "订阅日历变更事件"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/subscription"
updateTime: "1721110840000"
---

# 订阅日历变更事件

调用该接口为当前用户身份订阅[日历变更事件](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/events/changed)。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=calendar&version=v4&resource=calendar&method=subscription)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/calendar/v4/calendars/subscription</md-td>
    </md-tr>
    <md-tr>
