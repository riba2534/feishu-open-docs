---
title: "取消订阅日历"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/unsubscribe"
updateTime: "1723609306000"
---

# 取消订阅日历

调用该接口以当前身份（应用或用户）取消指定日历的订阅状态。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=calendar&version=v4&resource=calendar&method=unsubscribe)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/calendar/v4/calendars/:calendar_id/unsubscribe</md-td>
    </md-tr>
    <md-tr>
...
<md-tr>
  ...
  <md-td>目标日历已经取消订阅，你需要检查并改为正确的日历 ID。</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>191008</md-td>
  <md-td>primary calendar can not be unsubscribed</md-td>
  <md-td>当前身份的主日历不能被取消订阅。</md-td>
</md-tr>
