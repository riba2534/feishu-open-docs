---
title: "查询主日历信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/primary"
updateTime: "1721110838000"
---
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `calendar_id` | `string` | 日历 ID。你可以通过该 ID 查询、更新主日历信息。更多信息可参见[日历 ID 字段说明](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/introduction)。 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `summary` | `string` | 日历标题。 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `user_id` | `string` | 日历创建者的 User ID。了解用户不同类型的 ID，可参见[用户身份概述](https://open.larkoffice.com/document/home/user-identity-introduction/introduction)。 |
