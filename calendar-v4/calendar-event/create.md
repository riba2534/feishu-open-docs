...
调用该接口以当前身份（应用或用户）在指定日历上创建一个日程。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=calendar&version=v4&resource=calendar.event&method=create)
  ...
  <md-tbody>
    ...
    <md-tr>
      ...
      <md-td>
            ...
            <md-perm name="calendar:calendar.event:create" desc="创建日程" support_app_types="custom,isv" tags="">创建日程</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >idempotency_key</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-enum-item key="only_organization_employees" >仅企业内的用户可以加入会议</md-enum-item>
