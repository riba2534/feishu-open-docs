  ...
  <md-tbody>
    ...
    <md-tr>
      ...
      <md-td>
            ...
            <md-perm name="calendar:calendar.event:delete" desc="删除日程" support_app_types="custom,isv" tags="">删除日程</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
- [创建日程](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-event/create)会返回日程 ID
...
<md-tr>
  ...
  <md-td>日程已经被删除。你需要检查并改为正确的日程 ID。日程获取方式：

- [创建日程](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-event/create)会返回日程 ID
- [获取日程列表](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-event/list)
- [搜索日程](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-event/search)</md-td>
</md-tr>
