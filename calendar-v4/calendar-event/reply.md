...
调用该接口以当前身份（应用或用户）回复日程。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=calendar&version=v4&resource=calendar.event&method=reply)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/calendar/v4/calendars/:calendar_id/events/:event_id/reply</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            ...
            <md-perm name="calendar:calendar.event:reply" desc="回复日程" support_app_types="custom,isv" tags="">回复日程</md-perm>
            <md-perm name="calendar:calendar.event:writeonly" desc="创建或更新日程信息" support_app_types="custom,isv" tags="">创建或更新日程信息</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	日程所在的日历 ID。了解更多，参见[日历 ID 说明](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/introduction)。
...
**可选值有**：
<md-enum>
<md-enum-item key="accept" >接受</md-enum-item>
<md-enum-item key="decline" >拒绝</md-enum-item>
<md-enum-item key="tentative" >待定</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
