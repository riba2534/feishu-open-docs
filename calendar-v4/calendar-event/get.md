...
调用该接口以当前身份（应用或用户）获取指定日历内的某一日程信息，包括日程的标题、时间段、视频会议信息、公开范围以及参与人权限等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=calendar&version=v4&resource=calendar.event&method=get)
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >need_meeting_settings</md-text>
	</md-dt-td>
	<md-dt-td>
	...
	<md-dt-td>
	是否需要返回飞书视频会议（VC）的会前设置。需满足以下条件才可以获取到返回结果：
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >need_attendee</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >boolean</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >max_attendee_num</md-text>
	</md-dt-td>
	<md-dt-td>
	...
	<md-dt-td>
	返回的最大参与人数量。调用[获取日程参与人列表](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-event-attendee/list)可获取日程完整的参与人信息。
...
<md-dt-tr level="4">
	...
	<md-dt-td>
	（灰度中，仅部分租户可见）设置会议密码，仅支持 4-9 位数字
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >has_more_attendee</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >boolean</md-text>
	</md-dt-td>
