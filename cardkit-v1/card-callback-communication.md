...
![image.png](https://sf3-cn.feishucdn.com/obj/open-platform-opendoc/8bf97ff2bceed633b28f5ce2d2ec0270_zPTWqjljT8.png?height=329&lazyload=true&maxWidth=500&width=1574)</md-dt-td>
  </md-dt-tr>
...
![image.png](https://sf3-cn.feishucdn.com/obj/open-platform-opendoc/b3e96c8ca7c5c029bdbce6c0ca1ba413_aoV0ao7VUo.png?height=384&lazyload=true&maxWidth=500&width=1459)</md-dt-td>
  </md-dt-tr>
...
1. 前往[开发者后台](https://open.feishu.cn/app)，点击目标应用，选择 <strong>开发配置</strong> > <strong>事件与回调</strong>。<br>
 2. 在 <strong>事件与回调</strong> 页面 <strong>回调配置</strong> 页签下，填写正确有效的请求地址并保存。
	...
	<img src="https://sf3-cn.feishucdn.com/obj/open-platform-opendoc/f014fb193c475cf0a335fcac883e3e82_fqr82G8RrO.png" alt="回调配置">

3. 在 **已订阅的回调** 项中，确保已添加卡片回传交互回调。

        
    <img src="https://sf3-cn.feishucdn.com/obj/open-platform-opendoc/1f1daabce2053bd9d94b828a6172aedd_QJM06G0lYC.png" alt="回调配置"><br>
