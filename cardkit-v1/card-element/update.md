---
title: "更新组件"
fullPath: "/uAjLw4CM/ukTMukTMukTM/cardkit-v1/card-element/update"
updateTime: "1754918759000"
---
...
| `element` | `string` | 是 | 新的组件的完整的 JSON 数据。<br>注意： - 以下示例值未转义，使用时请注意将其转为 JSON 序列化后的字符串。 - 仅支持[卡片 JSON 2.0 结构](https://open.larkoffice.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-json-v2-structure)。<br>**示例值**："{\"tag\":\"markdown\",\"element_id\":\"md_1\",\"content\":\"这是一段更新后的文本\"}"<br>**数据校验规则**：<br>- 长度范围：`1` ～ `1000000` 字符 |
...
| 400 | 200810 | The card is in an ongoing interaction and cannot be updated | 在用户点击卡片[请求回调](https://open.larkoffice.com/document/uAjLw4CM/ukzMukzMukzM/feishu-cards/card-callback-communication)交互期间，卡片无法实现流式更新。请等待交互结束后再尝试更新。 |
