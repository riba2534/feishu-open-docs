...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/application/v6/app_recommend_rules</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="application:app_recommend_rule:readonly" desc="获取应用的推荐规则信息" support_app_types="custom" tags="">获取应用的推荐规则信息</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >app_recommend_rule\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	推荐规则列表
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >visibility_info</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >app_recommend_rule.visibility_info</md-text>
	</md-dt-td>
	<md-dt-td>
	推荐规则可见性信息
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >recommend_item_infos</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >app_recommend_rule.item_info\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	不可移除推荐应用项列表
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >item_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >link_url</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	<md-text type="field-type" >app_recommend_rule.item_info.i18n_name</md-text>
	</md-dt-td>
	<md-dt-td>
	应用项的多语种名称
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >distributed_recommend_item_infos</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >app_recommend_rule.item_info\[\]</md-text>
	</md-dt-td>
