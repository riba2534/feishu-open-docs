...
获取指定群组的成员信息，包括成员名字与 ID。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=chat.members&method=get)
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	成员的用户ID，ID 值与查询参数中的 member_id_type 对应。
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >member_total</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
