...
fullPath: "/ukTMukTMukTM/uYDNxYjL2QTM24iN0EjN/bot-events"
updateTime: "1730257117000"
---
...
你需要先为应用配置事件订阅，才可以在触发事件时接收到事件。事件订阅介绍参见[事件概述](https://open.larkoffice.com/document/ukTMukTMukTM/uUTNz4SN1MjL1UzM)。
...
| 支持的应用类型 | custom,isv |
| 权限要求             订阅该事件所需的权限，开启其中任意一项权限即可订阅 开启任一权限即可 | 无 |
| 字段权限要求 | 无 |
| 推送方式 | `Webhook` |
