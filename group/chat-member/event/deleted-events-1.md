...
- 你需要在应用中配置事件订阅，在事件列表的 ==消息与群组== 分类下订阅 ==机器人被移出群== 事件，这样才可以在事件触发时接收到事件数据。了解事件订阅可参见[事件订阅概述](/ssl:ttdoc/ukTMukTMukTM/uUTNz4SN1MjL1UzM)。
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>im.chat.member.bot.deleted_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
