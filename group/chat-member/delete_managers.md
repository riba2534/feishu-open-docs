...
指定群组，删除群组内指定的管理员，包括用户类型的管理员和机器人类型的管理员。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=chat.managers&method=delete_managers)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/im/v1/chats/:chat_id/managers/delete_managers</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	要删除的管理员 ID，ID 类型与查询参数 member_id_type 取值一致。
