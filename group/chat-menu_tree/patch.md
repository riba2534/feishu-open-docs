---
title: "修改群菜单元信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-menu_item/patch"
updateTime: "1748248143000"
---

# 修改群菜单元信息

修改指定群组内的某个一级菜单或者二级菜单的元信息，包括图标、名称、国际化名称和跳转链接。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=chat.menu_item&method=patch)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/im/v1/chats/:chat_id/menu_items/:menu_item_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >menu_item_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
	<md-dt-td>
	一级菜单或者二级菜单的 ID，ID 可通过 [获取群菜单](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-menu_tree/get) 接口获取。
...
**可选值有**：
<md-enum>
<md-enum-item key="ICON" >图标</md-enum-item>
<md-enum-item key="NAME" >名称</md-enum-item>
<md-enum-item key="I18N_NAME" >国际化名称</md-enum-item>
<md-enum-item key="REDIRECT_LINK" >跳转链接</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	图标的 key 值。通过 [上传图片](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/image/create) 接口上传 message 类型图片获取 image_key，并传入该值。
...
<md-tr>
  <md-td>400</md-td>
  <md-td>232073</md-td>
  <md-td>The group menu is being modified, please try again later.</md-td>
  <md-td>群内菜单正在修改中，请稍后重试。</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>232078</md-td>
  <md-td>The chat menu is illegal.</md-td>
  <md-td>群菜单内容非法。</md-td>
</md-tr>
