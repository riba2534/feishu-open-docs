...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `tab_ids` | `string\[\]` | 是 | 会话标签页 ID 列表，ID 可以在[添加会话标签页](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-tab/create)或者[拉取会话标签页](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-tab/list_tabs)接口返回值中获取。<br>**示例值**：["6936075528890826780"] |
