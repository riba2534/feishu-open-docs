---
title: "拉取会话标签页"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-tab/list_tabs"
...
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 开启任一权限即可 | `im:chat` 获取与更新群组信息 `im:chat.tabs:read` 查看群会话标签页 `im:chat:readonly` 获取群组信息 |
