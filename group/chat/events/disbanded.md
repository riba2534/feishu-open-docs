---
title: "群解散"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat/events/disbanded"
updateTime: "1730257052000"
---
...
- 应用需要配置[事件订阅](https://open.larkoffice.com/document/ukTMukTMukTM/uUTNz4SN1MjL1UzM)，订阅 **消息与群组** 分类下的 **解散群** 事件。
...
| `event` | `\-` | \- |
| &nbsp;&nbsp;└ `chat_id` | `string` | 群组 ID。详情介绍参见[群 ID 说明](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-id-description)。 |
