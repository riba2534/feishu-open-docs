...
- 应用需要配置[事件订阅](/ssl:ttdoc/ukTMukTMukTM/uUTNz4SN1MjL1UzM)，订阅 **消息与群组** 分类下的 **解散群** 事件。
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>im.chat.disbanded_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	群组 ID。详情介绍参见[群 ID 说明](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-id-description)。
	</md-dt-td>
</md-dt-tr>
