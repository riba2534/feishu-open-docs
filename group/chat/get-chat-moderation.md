...
获取指定群组的发言模式、可发言用户名单等信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=chat.moderation&method=get)
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >list_moderator\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
