...
获取指定群的基本信息，包括群名称、群描述、群头像、群主 ID 以及群权限配置等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=chat&method=get)
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	群主的用户 ID 类型，与查询参数中的 user_id_type 相同。取值为 `open_id`、`user_id`、`union_id` 其中之一，不同 ID 的说明参见 [用户相关的 ID 概念](/ssl:ttdoc/home/user-identity-introduction/introduction)。
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	群主的用户 ID，ID 类型与查询参数中的 user_id_type 对应。
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >user_manager_id_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	用户管理员 ID 列表，ID 类型与查询参数 user_id_type 一致。
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >bot_manager_id_list</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	机器人管理员 ID 列表，ID 类型为应用的 App ID。
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >bot_count</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
