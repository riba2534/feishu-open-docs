...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `validity_period` | `string` | 否 | 群分享链接有效时长<br>**示例值**："week"<br>**可选值有**：<br>- `week`: 有效期 7 天 - `year`: 有效期 1 年 - `permanently`: 永久有效<br>**默认值**：`week` |
