...
{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=docx&version=v1&resource=chat.announcement.block.children&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/docx/v1/chats/:chat_id/announcement/blocks/:block_id/children</md-td>
    </md-tr>
    <md-tr>
