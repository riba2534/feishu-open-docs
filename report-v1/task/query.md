---
title: "查询任务"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/report/report-v1/task/query"
updateTime: "1727319723000"
---
...
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 | `report:task:readonly` 查看汇报任务 |
