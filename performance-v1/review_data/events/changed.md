...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>performance.review_data.changed_v2</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >review_data_change\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	评估数据列表
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	员工 ID， ID 类型请参考：[用户资源介绍](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/user/field-overview)
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	周期 ID，详情请查看：[获取周期](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v1/semester/list)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	项目 ID，详情请查看：[获取项目配置](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v2/activity/query)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >stage_changes</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >stage_change\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	发生更新的环节
	</md-dt-td>
