...
你需要在应用中配置事件订阅，才可以在事件触发时接收到事件数据。了解事件订阅可参见[事件订阅概述](/ssl:ttdoc/ukTMukTMukTM/uUTNz4SN1MjL1UzM)。
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>performance.stage_task.open_result_v2</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >open_result\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	新开通绩效结果的被评估人列表
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	员工 ID，用户 ID 类型请参考：[用户资源介绍](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/user/field-overview)
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	绩效评估周期 ID，详情可查看：[获取周期](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v1/semester/list)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	绩效评估项目 ID，详情可查看：[获取项目配置](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v2/activity/query)
	</md-dt-td>
</md-dt-tr>
