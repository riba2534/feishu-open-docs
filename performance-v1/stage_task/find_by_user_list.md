---
title: "获取周期任务（指定用户）"
fullPath: "/uAjLw4CM/ukTMukTMukTM/performance-v1/stage_task/find_by_user_list"
updateTime: "1722592412000"
---

# 获取周期任务（指定用户）

根据用户 ID 批量获取指定周期的任务信息。支持传入任务分类、任务截止时间参数删选周期内任务数据。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=performance&version=v1&resource=stage_task&method=find_by_user_list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/performance/v1/stage_tasks/find_by_user_list</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >user_id_lists</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >task_option_lists</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >after_time</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >before_time</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >base</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >semester_base_info</md-text>
	</md-dt-td>
	<md-dt-td>
	周期基本信息
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	周期 ID，详情可查看[获取周期](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v1/semester/list)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >semester_name</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >stage_task\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	周期任务
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >stage_num_lists</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >stage_task_status_num\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	各分类的任务数
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >task_option_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >待完成</md-enum-item>
<md-enum-item key="2" >已完成</md-enum-item>
<md-enum-item key="3" >已逾期（此分类仅在租户系统设置为不允许逾期提交时存在）</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >stage_num</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >stage_task_info_lists</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >stage_task_info\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	环节任务信息
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >need_todo_count</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >int</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >jump_url</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >stage_task_status</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="need_todo" >还有待完成的任务</md-enum-item>
<md-enum-item key="overdue" >剩余未完成的任务均已逾期</md-enum-item>
<md-enum-item key="all_done" >全部任务均已完成</md-enum-item>
<md-enum-item key="stage_pause" >环节被暂停</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
