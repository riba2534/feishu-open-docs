...
批量获取指标的字段基础信息，如指标字段名称、指标字段类型等信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=performance&version=v2&resource=metric_field&method=query)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/performance/v2/metric_fields/query</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >field_ids</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >metric_field\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	指标字段信息
	</md-dt-td>
...
<md-enum-item key="pencentage" >百分比</md-enum-item>
<md-enum-item key="person" >人员单选</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
