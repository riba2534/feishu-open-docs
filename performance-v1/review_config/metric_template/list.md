...
批量获取指标的标签信息，如标签名称、创建时间等信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=performance&version=v2&resource=metric_tag&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/performance/v2/metric_tags</md-td>
    </md-tr>
    <md-tr>
