...
获取指标库中的指标信息，如指标名称、指标类型、指标标签和指标字段等信息。可通过指标启用状态、指标类型、指标可用范围等筛选条件获取指定范围的指标信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=performance&version=v2&resource=metric_lib&method=query)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/performance/v2/metric_libs/query</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >is_active</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	指标标签 ID 列表，可通过[获取指标标签信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v2/metric_tag/list)接口获取，填写时筛选拥有指定标签的指标
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >type_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
	...
	<md-dt-td>
	指标类型 ID 列表，可通过[获取指标模板列表](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v2/metric_template/query)
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >range_of_availability</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="admins_and_reviewees" >允许管理员下发和被评估人选用</md-enum-item>
<md-enum-item key="only_admins" >仅允许管理员下发</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
**可选值有**：
<md-enum>
<md-enum-item key="score_manually" >手动评分</md-enum-item>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >metric_in_library\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	指标信息
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >metric_tag\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	指标标签信息
	</md-dt-td>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	指标标签 ID，详情可查看：[获取指标标签信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v2/metric_tag/list)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >tag_name</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >metric_field_in_library\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	指标字段信息
	</md-dt-td>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	指标字段 ID，详情可查看：[获取指标字段详情](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v2/metric_field/query)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >scoring_formula</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >formula_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >formula_name</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >formula_details</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	指标数据源录入人的 user_id，取值与入参 `user_id_type` 类型一致
	</md-dt-td>
</md-dt-tr>
...
<md-tr>
  ...
  <md-td>服务内部错误，请根据实际报错信息定位或咨询[技术支持](https://applink.feishu.cn/TLJpeNdW)</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>page token 不存在，请检查 `page_token` 是否正确</md-td>
</md-tr>
