---
title: "获取评估项列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/performance-v2/indicator/query"
updateTime: "1722592320000"
---
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `type` | `string` | 评估项类型<br>**可选值有**：<br>- `general_review_item`: 常规评估项 - `review_item_based_on_key_metric`: 关键指标评估项 - `okr_review_item`: OKR 评估项 - `plus`: 加分项 - `minus`: 减分项 |
