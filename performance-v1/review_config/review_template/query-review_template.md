...
获取绩效模板信息，包括模版名称、执行角色、填写项类型等{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=performance&version=v2&resource=review_template&method=query)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/performance/v2/review_templates/query</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            ...
            <md-perm name="performance:review_template:read" desc="获取评估配置信息" support_app_types="custom,isv" tags="">获取评估配置信息</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >review_template_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >review_templates</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >review_template\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	绩效模板信息
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >review_stage_data_write_mode</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="4">
	...
	<md-dt-td>
	如果是填写项，为填写项名称，字段可能为空值；如果是评估项，为评估项名称，字段不为空值；如果是标签填写题，为标签填写题名称，字段不为空值
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="4">
	...
	<md-dt-td>
	评估项 ID，详细信息请参考[获取评估项配置](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v2/indicator/query)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >objective_text_qustion_title</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >i18n</md-text>
	</md-dt-td>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >keyresult_text_qustion_title</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >i18n</md-text>
	</md-dt-td>
...
<md-dt-tr level="4">
	<md-dt-td>
	<md-text type="field-name" >kpi_template_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
