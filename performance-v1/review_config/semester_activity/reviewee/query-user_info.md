---
title: "获取绩效周期的人员信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/performance-v2/user_info/query"
updateTime: "1768271834000"
---
...
| `department_id_type` | `string` | 否 | 指定查询结果中的部门 ID 类型。关于部门 ID 的详细介绍，可参见[部门 ID](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/field-overview#23857fe0) 说明。<br>**示例值**：open_department_id<br>**可选值有：** - `department_id`：支持用户自定义配置的部门 ID。自定义配置时可复用已删除的 department_id，因此在未删除的部门范围内 department_id 具有唯一性。 - `open_department_id`：由系统自动生成的部门 ID，ID 前缀固定为 od-，在租户内全局唯一。<br>**默认值：** open_department_id |
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `semester_id` | `string` | 是 | 评估周期 ID 列表，semester_id 可通过[【获取周期】](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/performance-v1/semester/list)获得<br>**示例值**："6992035450862224940" |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `direct_leader_user_id` | `user` | 人员的直属上级的用户 ID<br>**字段权限要求**： `performance:user_snapshot.direct_leader:read` 查看员工在绩效周期的直属上级 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `open_id` | `string` | 人员的直属上级的 open_id |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `user_id` | `string` | 人员的直属上级的 user_id，取值与user_id_type一致 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `department` | `department` | 人员的部门<br>**字段权限要求**： `performance:user_snapshot.department:read` 查看员工在绩效周期的部门信息 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `id` | `string` | 部门 ID，与入参中的department_id_type类型一致，详情请查看：[获取单个部门信息](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/get) |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `name` | `i18n` | 部门名称 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `zh_cn` | `string` | 中文 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `en_us` | `string` | 英文 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `job_family` | `job_family` | 人员的序列<br>**字段权限要求**： `performance:user_snapshot.job_family:read` 查看员工在绩效周期的序列信息 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `id` | `string` | 序列 ID |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `name` | `i18n` | 序列名称 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `zh_cn` | `string` | 中文 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `en_us` | `string` | 英文 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `job_level` | `job_level` | 人员的职级<br>**字段权限要求**： `performance:user_snapshot.job_level:read` 查看员工在绩效周期的职级信息 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `id` | `string` | 职级 ID |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `name` | `i18n` | 职级名称 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `zh_cn` | `string` | 中文 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `en_us` | `string` | 英文 |
