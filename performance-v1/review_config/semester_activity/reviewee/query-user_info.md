...
获取指定绩效周期下，被评估人在评估时的部门、序列、职级等人员信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=performance&version=v2&resource=user_info&method=query)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/performance/v2/user_info/query</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
        ...
        <md-perm name="performance:user_snapshot.department:read" desc="查看员工在绩效周期的部门信息" support_app_types="custom" tags="">查看员工在绩效周期的部门信息</md-perm>
        <md-perm name="performance:user_snapshot.direct_leader:read" desc="查看员工在绩效周期的直属上级" support_app_types="custom" tags="">查看员工在绩效周期的直属上级</md-perm>
        <md-perm name="performance:user_snapshot.job_family:read" desc="查看员工在绩效周期的序列信息" support_app_types="custom" tags="">查看员工在绩效周期的序列信息</md-perm>
        <md-perm name="performance:user_snapshot.job_level:read" desc="查看员工在绩效周期的职级信息" support_app_types="custom" tags="">查看员工在绩效周期的职级信息</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	指定查询结果中的部门 ID 类型。关于部门 ID 的详细介绍，可参见[部门 ID](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/field-overview#23857fe0) 说明。
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >direct_leader_user_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >user</md-text>
	</md-dt-td>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	人员的直属上级的 user_id，取值与user_id_type一致
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="3">
	...
	<md-dt-td>
	部门 ID，与入参中的department_id_type类型一致，详情请查看：[获取单个部门信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/get)
	</md-dt-td>
</md-dt-tr>
