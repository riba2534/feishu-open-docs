...
获取绩效周期中被圈定到项目中的被评估人信息，包括未启动的项目。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=performance&version=v2&resource=reviewee&method=query)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/performance/v2/reviewees/query</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            ...
            <md-perm name="performance:semester_user:read" desc="获取周期人员信息" support_app_types="custom,isv" tags="">获取周期人员信息</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	周期 ID，可通过[获取周期列表](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v1/semester/list)
接口获取
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	项目 ID 列表，可通过[获取项目列表](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v2/activity/query)
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >reviewees</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >reviewee\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	被评估人列表
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	被评估人参与的项目，详细信息请参考[获取项目配置](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v2/activity/query)
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >reviewprofile_url</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
