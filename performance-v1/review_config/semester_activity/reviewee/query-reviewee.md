---
title: "获取被评估人信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/performance-v2/reviewee/query"
updateTime: "1727332890000"
---
...
| 支持的应用类型 | custom,isv |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 开启任一权限即可 | `performance:performance` 管理绩效数据 `performance:performance:readonly` 查看绩效数据 `performance:semester_user:read` 获取周期人员信息 |
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `semester_id` | `string` | 是 | 周期 ID，可通过[获取周期列表](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/performance-v1/semester/list) 接口获取<br>**示例值**："6992035450862224940" |
...
| `activity_ids` | `string\[\]` | 否 | 项目 ID 列表，可通过[获取项目列表](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/performance-v2/activity/query) 接口获取，查询指定的项目下的被评估人信息<br>**示例值**：["7266780609384392723"] |
...
| &nbsp;&nbsp;&nbsp;&nbsp;└ `activity_ids` | `string\[\]` | 被评估人参与的项目，详细信息请参考[获取项目配置](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/performance-v2/activity/query) |
