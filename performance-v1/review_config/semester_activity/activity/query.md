...
批量获取项目的配置信息，如项目名称、项目模式等信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=performance&version=v2&resource=activity&method=query)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/performance/v2/activity/query</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            ...
            <md-perm name="performance:semester_activity:read" desc="获取周期与项目配置信息" support_app_types="custom,isv" tags="">获取周期与项目配置信息</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	评估周期 ID 列表，可通过[获取周期](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v1/semester/list)获取
<br>
...
**可选值有**：
<md-enum>
<md-enum-item key="metric_development" >指标制定</md-enum-item>
<md-enum-item key="performance_review" >绩效评估</md-enum-item>
<md-enum-item key="metric_development_and_performance_review" >指标制定及绩效评估</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
**可选值有**：
<md-enum>
<md-enum-item key="configurable" >待完成配置</md-enum-item>
<md-enum-item key="unable" >未启动</md-enum-item>
<md-enum-item key="initiating" >启动中</md-enum-item>
<md-enum-item key="enabled" >已启动</md-enum-item>
<md-enum-item key="finished" >已结束</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
