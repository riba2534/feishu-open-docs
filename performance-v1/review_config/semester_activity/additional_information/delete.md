...
批量删除被评估人的补充信息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=performance&version=v2&resource=additional_informations.batch&method=delete)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/performance/v2/additional_informations/batch</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	补充信息 ID 列表，可通过[批量查询补充信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v2/additional_information/query)接口获取
...
<md-tr>
  ...
  <md-td>操作无权限的被评估人数据，请检查当前应用申请的被评估人数据范围
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1580201</md-td>
  <md-td>item_id is invalid</md-td>
  <md-td>补充信息 ID 不合法，请检查入参 `additional_informations ` 中的 ID 是否正确</md-td>
</md-tr>
