---
title: "批量删除补充信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/performance-v2/additional_informations-batch/delete"
updateTime: "1729567670000"
---
...
| `additional_informations` | `string\[\]` | 是 | 补充信息 ID 列表，可通过[批量查询补充信息](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/performance-v2/additional_information/query)接口获取<br>**示例值**：["7350195758357807123"]<br>**数据校验规则**：<br>- 长度范围：`1` ～ `100` |
