...
批量查询被评估人的补充信息，如补充信息的事项、时间以及具体描述等。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=performance&version=v2&resource=additional_information&method=query)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/performance/v2/additional_informations/query</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	补充信息 ID 列表，可通过[批量导入补充信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v2/additional_information/import)接口获取
<br>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >external_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
	...
	<md-dt-td>
	外部系统补充信息 ID 列表，该 ID 在通过[批量导入补充信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v2/additional_information/import)接口导入时写入
<br>
