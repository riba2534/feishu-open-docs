...
该接口用于撤回通过[批量发送消息](/ssl:ttdoc/ukTMukTMukTM/ucDO1EjL3gTNx4yN4UTM)接口发送的消息。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=batch_message&method=delete)
...
- 仅支持撤回通过[批量发送消息](/ssl:ttdoc/ukTMukTMukTM/ucDO1EjL3gTNx4yN4UTM)接口发送的消息。如果你需要撤回单条消息，请使用[撤回消息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/delete)接口。
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/im/v1/batch_messages/:batch_message_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	待撤回的批量消息任务 ID，该 ID 为[批量发送消息](/ssl:ttdoc/ukTMukTMukTM/ucDO1EjL3gTNx4yN4UTM)接口返回值中的`message_id`字段，用于标识一次批量发送消息请求。
...
<md-tr>
  <md-td>400</md-td>
  <md-td>230009</md-td>
  <md-td>Message can only be recalled within one days.</md-td>
...
<md-tr>
  ...
  <md-td>机器人没有权限撤回该消息，只能撤回机器人自己发出的消息。</md-td>
</md-tr>
