...
Pin 一条指定的消息。Pin 消息的效果可参见[Pin 消息概述](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/pin/pin-overview)。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=pin&method=create)
