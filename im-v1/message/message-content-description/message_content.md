---
title: "接收消息内容结构"
fullPath: "/uAjLw4CM/ukTMukTMukTM/im-v1/message/events/message_content"
updateTime: "1775810750000"
---
...
- 部分接口支持通过传入参数来获取原始卡片 JSON，详情请参考对应接口中 **`card_msg_content_type`** 参数的说明：
  1. [获取会话历史消息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/list)
  2. [获取指定消息的内容](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/get)
:::
