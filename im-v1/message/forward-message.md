...
调用该接口将一条指定的消息转发给用户、群聊或话题。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=message&method=forward)
...
- 向用户转发消息时，用户需要在机器人的[可用范围](/ssl:ttdoc/home/introduction-to-scope-and-authorization/availability)内。
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/im/v1/messages/:message_id/forward</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	消息类型。包括 text、post、image、file、audio、media、sticker、interactive、share_chat、share_user 等。各类型定义参考[接收消息内容](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/im-v1/message/events/message_content)。
	</md-dt-td>
</md-dt-tr>
...
<md-tr>
  ...
  <md-td>待转发的消息无效的。如消息不存在、已被撤回、对操作者不可见等原因导致无法转发当前消息。</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>要转发的消息都已被撤回，无法进行当前操作。</md-td>
</md-tr>
...
<md-tr>
  ...
  <md-td>指定的群已被解散，无法进行操作。如需更换为其他群，参见 [获取群  ID](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-id-description#2c14aa7f)。
    </md-td>
</md-tr>
