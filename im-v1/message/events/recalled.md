---
title: "撤回消息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/events/recalled"
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>im.message.recalled_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >recall_time</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >recall_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="message_owner" >消息发送者撤回</md-enum-item>
<md-enum-item key="group_owner" >群主撤回</md-enum-item>
<md-enum-item key="group_manager" >群管理员撤回</md-enum-item>
<md-enum-item key="enterprise_manager" >企业管理员撤回</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
