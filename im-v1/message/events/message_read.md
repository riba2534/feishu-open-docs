---
title: "消息已读"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/events/message_read"
updateTime: "1723193944000"
---
...
- 你需要在应用中配置事件订阅，订阅 ==消息与群组== 分类下的 ==消息已读== 事件才可接收推送。了解事件订阅可参见[事件订阅概述](/ssl:ttdoc/ukTMukTMukTM/uUTNz4SN1MjL1UzM)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>im.message.message_read_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >reader</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >event_message_reader</md-text>
	</md-dt-td>
	<md-dt-td>
	\-
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >reader_id</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >read_time</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	消息 ID 列表。你可以调用[获取指定消息的内容](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/get)接口，通过消息 ID 查询消息内容。
	</md-dt-td>
</md-dt-tr>
