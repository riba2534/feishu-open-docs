...
- 应用需要配置事件订阅并订阅该事件，才能接收到事件数据。详情参见[事件概述](/ssl:ttdoc/ukTMukTMukTM/uUTNz4SN1MjL1UzM)。
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>im.message.reaction.deleted_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	消息 ID。调用[获取指定消息的内容](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/get)接口，可通过 message_id 获取消息内容。
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	emoji 类型。emoji_type 值对应的表情可参见[表情文案说明](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message-reaction/emojis-introduce)。
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	用户 ID。调用[获取单个用户信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/user/get)接口，可通过用户 ID 获取用户信息。
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	应用 ID。调用[获取应用信息](/ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/application-v6/application/get)接口，可通过 app_id 获取应用信息。
	</md-dt-td>
</md-dt-tr>
