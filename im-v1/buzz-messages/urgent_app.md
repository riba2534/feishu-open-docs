---
title: "发送应用内加急"
fullPath: "/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/urgent_app"
updateTime: "1727245979000"
---

# 发送应用内加急

调用该接口把指定消息加急给目标用户，加急仅在飞书客户端内通知。了解加急可参见[加急功能](https://www.feishu.cn/hc/zh-CN/articles/360024757913)。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=message&method=urgent_app)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/im/v1/messages/:message_id/urgent_app</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="im:message.urgent" desc="发送应用内加急消息" support_app_types="custom,isv" tags="">发送应用内加急消息</md-perm>
            <md-perm name="im:message.urgent:app_send" desc="发送应用内加急消息（历史版本）" support_app_types="custom" tags="">发送应用内加急消息（历史版本）</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
