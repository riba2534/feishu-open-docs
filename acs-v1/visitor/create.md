---
title: "添加访客"
fullPath: "/uAjLw4CM/ukTMukTMukTM/acs-v1/visitor/create"
updateTime: "1704791410000"
---

# 添加访客

添加访客{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=acs&version=v1&resource=visitor&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/acs/v1/visitors</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >visitor_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1490203</md-td>
  <md-td>phone num already exist</md-td>
  <md-td>电话号码已重复</md-td>
</md-tr>
