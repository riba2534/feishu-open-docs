---
title: "获取门禁记录列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/acs-v1/access_record/list"
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/acs/v1/access_records</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="acs:access_record:readonly" desc="查看智能门禁记录" support_app_types="custom" tags="">查看智能门禁记录</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >access_record\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	-
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >is_clock_in</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >access_time</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >access_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >is_door_open</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >boolean</md-text>
	</md-dt-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1490017</md-td>
  <md-td>time range oversize error</md-td>
  <md-td>减少查询时间范围</md-td>
</md-tr>
