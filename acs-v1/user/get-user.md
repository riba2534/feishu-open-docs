---
title: "获取单个用户信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/acs-v1/user/get"
updateTime: "1628238375000"
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/acs/v1/users/:user_id</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >feature</md-text>
	</md-dt-td>
	<md-dt-td>
	用户特征
	</md-dt-td>
...
<md-dt-tr level="3">
	<md-dt-td>
	<md-text type="field-name" >face_uploaded</md-text>
	</md-dt-td>
	<md-dt-td>
