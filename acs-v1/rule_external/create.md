...
创建或更新权限组{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=acs&version=v1&resource=rule_external&method=create)
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1490030</md-td>
  <md-td>device does not exist</md-td>
  <md-td>请检查设备id,该id不存在</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1490112</md-td>
  <md-td>rule name already exist</md-td>
  <md-td>请检查权限组名称,该id该名称已存在</md-td>
</md-tr>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1490111</md-td>
  <md-td>rule count reach limit</md-td>
  <md-td>请检查权限组个数,已达上限</md-td>
</md-tr>
