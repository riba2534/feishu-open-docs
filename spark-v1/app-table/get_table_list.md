---
title: "获取数据表列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/spark-v1/app-table/get_table_list"
updateTime: "1775199124000"
---
...
| 项目 | 值 |
| --- | --- |
| HTTP URL | https://open.feishu.cn/open-apis/spark/v1/apps/:app_id/tables |
| HTTP Method | GET |
| 接口频率限制 | [10 次/秒](https://open.larkoffice.com/document/ukTMukTMukTM/uUzN04SN3QjL1cDN) |
| 支持的应用类型 | custom |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 开启任一权限即可 | `spark:app.table:read` 读取数据表信息 `spark:app.table:write` 修改数据表信息 |
...
| &nbsp;&nbsp;└ `items` | `app_table\[\]` | 数据表列表 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `name` | `string` | 数据表名，如 student |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `description` | `string` | 数据表描述 |
| &nbsp;&nbsp;&nbsp;&nbsp;└ `columns` | `app_table_column\[\]` | 数据表列 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ `name` | `string` | 列名 |
