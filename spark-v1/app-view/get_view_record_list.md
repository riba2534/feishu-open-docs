---
title: "查询视图数据记录"
fullPath: "/uAjLw4CM/ukTMukTMukTM/spark-v1/app-view/get_view_record_list"
updateTime: "1775706904000"
---
...
| 项目 | 值 |
| --- | --- |
| HTTP URL | https://open.feishu.cn/open-apis/spark/v1/apps/:app_id/views/:view_name/records |
| HTTP Method | GET |
...
| `view_name` | `string` | 妙搭视图表名，必须属于 app_id 对应的妙搭应用，可从妙搭应用数据库管理视图列表中获取<br>**示例值**："student_table_view" |
