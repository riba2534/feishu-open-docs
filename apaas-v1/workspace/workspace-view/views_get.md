...
查询视图数据记录{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=apaas&version=v1&resource=workspace.view&method=views_get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/apaas/v1/workspaces/:workspace_id/views/:view_name/records</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="app_engine:workspace.table.record:read" desc="读取数据表数据记录" support_app_types="custom" tags="">读取数据表数据记录</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
