---
title: "数据记录变更"
fullPath: "/uAjLw4CM/ukTMukTMukTM/apaas-v1/workspace/events/record_change"
updateTime: "1767774032000"
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      <md-th>事件类型</md-th>
      <md-td>apaas.workspace.record_change_v1</md-td>
    </md-tr>
    <md-tr>
      <md-th>支持的应用类型</md-th>
      <md-td>
    ...
    <md-th>
      ...
      <md-td>
            <md-perm name="app_engine:data.record.change:read" desc="读取数据表变更记录" support_app_types="custom" tags="">读取数据表变更记录</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>推送方式</md-th>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >workspace</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
