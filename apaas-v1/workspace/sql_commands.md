...
在工作空间下执行 SQL 语句{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=apaas&version=v1&resource=workspace&method=sql_commands)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/apaas/v1/workspaces/:workspace_id/sql_commands</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="app_engine:workspace.sql_commands:write" desc="在工作空间下执行 SQL 语句" support_app_types="custom" tags="">在工作空间下执行 SQL 语句</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >sql</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
