---
title: "获取数据表详细信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/apaas-v1/workspace-table/table_get"
updateTime: "1766996719000"
---
...
| 支持的应用类型 | custom |
| 权限要求             调用该 API 所需的权限。开启其中任意一项权限即可调用 开启任一权限即可 | `app_engine:workspace.table:read` 读取工作空间及数据表相关信息 `app_engine:workspace.table:write` 修改工作空间及数据表相关信息 |
