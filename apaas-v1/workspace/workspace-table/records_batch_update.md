...
批量更新数据表中的记录{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=apaas&version=v1&resource=workspace.table&method=records_batch_update)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/apaas/v1/workspaces/:workspace_id/tables/:table_name/records_batch_update</md-td>
    </md-tr>
    <md-tr>
