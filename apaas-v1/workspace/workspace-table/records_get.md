...
# 查询数据表数据记录
 ...
 查询数据表数据记录{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=apaas&version=v1&resource=workspace.table&method=records_get)
...
- 示例：
查找 student 表中 age 大于 10 的学生列表：age=gt.10, URLEncode 后拼在 filter 中。
