---
title: "删除数据表中的记录"
fullPath: "/uAjLw4CM/ukTMukTMukTM/apaas-v1/workspace-table/records_delete"
updateTime: "1764571061000"
---
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| `filter` | `string` | 是 | 筛选条件，尊许 PostgREST 语法，详情可查看 `https://docs.postgrest.org/en/v13/references/api/tables_views.html#horizontal-filtering` 此处用法和查询数据记录一致。 - 示例：查找 student 表中 age 大于 10 的学生列表：age=gt.10, URLEncode 后拼在 filter 中。<br>**示例值**：age%3Dgt.10 |
