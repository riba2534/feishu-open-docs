...
获取工作空间下的自定义枚举列表{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=apaas&version=v1&resource=workspace.enum&method=list)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/apaas/v1/workspaces/:workspace_id/enums</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >workspace_enum\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	枚举列表
	</md-dt-td>
