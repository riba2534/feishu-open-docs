---
title: "获取自定义枚举详细信息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/apaas-v1/workspace-enum/enum_get"
updateTime: "1766996778000"
---

# 获取自定义枚举详细信息

获取自定义枚举详细信息{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=apaas&version=v1&resource=workspace.enum&method=enum_get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/apaas/v1/workspaces/:workspace_id/enums/:enum_name</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >workspace_user_info</md-text>
	</md-dt-td>
	<md-dt-td>
	创建人
	</md-dt-td>
