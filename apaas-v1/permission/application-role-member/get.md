...
获取角色成员详情{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=apaas&version=v1&resource=application.role.member&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/apaas/v1/applications/:namespace/roles/:role_api_name/member</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="app_engine:role:read" desc="查询角色配置信息" support_app_types="custom,isv" tags="">查询角色配置信息</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >role_api_name</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >need_display_name</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >use_api_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >boolean</md-text>
	</md-dt-td>
...
<md-dt-tr level="1">
	<md-dt-td>
	<md-text type="field-name" >role_member</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >role_member</md-text>
	</md-dt-td>
	<md-dt-td>
	角色成员
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >role_api_id</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >user_filter</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="5">
	<md-dt-td>
	<md-text type="field-name" >display_names</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >user_display_infos</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >permission_name_info\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >department_display_infos</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >permission_name_info\[\]</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="all" >全部用户</md-enum-item>
