---
title: "查询环境变量列表"
fullPath: "/uAjLw4CM/ukTMukTMukTM/apaas-v1/application-environment_variable/query"
updateTime: "1752136750000"
---

# 查询环境变量列表

查询基于飞书 aPaaS 开发的应用的环境变量列表{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=apaas&version=v1&resource=application.environment_variable&method=query)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/apaas/v1/applications/:namespace/environment_variables/query</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="app_engine:application.environment_variable:read" desc="查询环境变量" support_app_types="custom,isv" tags="">查询环境变量</md-perm>
      </md-td>
    </md-tr>
  </md-tbody>
</md-table>
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	<md-text type="field-type" >environment_variable_filter</md-text>
	</md-dt-td>
	<md-dt-td>
	否
	</md-dt-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >environment_variable\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	环境变量列表
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >label</md-text>
	</md-dt-td>
	<md-dt-td>
	环境变量的名称
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >is_encrypted</md-text>
	</md-dt-td>
	<md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >object_label</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >label</md-text>
	</md-dt-td>
