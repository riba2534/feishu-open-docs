---
title: "查询环境变量详情"
fullPath: "/uAjLw4CM/ukTMukTMukTM/apaas-v1/application-environment_variable/get"
updateTime: "1752136769000"
---

# 查询环境变量详情

查询基于飞书 aPaaS 开发的应用的环境变量详情，包括名称、描述、变量值等{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=apaas&version=v1&resource=application.environment_variable&method=get)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/apaas/v1/applications/:namespace/environment_variables/:environment_variable_api_name</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >environment_variable_api_name</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
