---
title: "查询数据变更日志详情"
fullPath: "/uAjLw4CM/ukTMukTMukTM/apaas-v1/application-audit_log/data_change_log_detail"
updateTime: "1737441315000"
---

# 飞书低代码平台-查询数据变更日志详情

根据日志 ID 查询数据变更日志详情{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=apaas&version=v1&resource=application.audit_log&method=data_change_log_detail)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/apaas/v1/applications/:namespace/audit_log/data_change_log_detail</md-td>
    </md-tr>
    <md-tr>
