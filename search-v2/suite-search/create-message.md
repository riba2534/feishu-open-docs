---
title: "搜索消息"
fullPath: "/uAjLw4CM/ukTMukTMukTM/search-v2/message/create"
updateTime: "1701053675000"
---

# 搜索消息

用户可以通过关键字搜索可见消息，可见性和套件内搜索一致。{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=search&version=v2&resource=message&method=create)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/search/v2/message</md-td>
    </md-tr>
    <md-tr>
    ...
    <md-tr>
      ...
      <md-td>
            <md-perm name="search:message" desc="获取消息搜索结果" support_app_types="custom,isv" tags="">获取消息搜索结果</md-perm>
      </md-td>
    </md-tr>
    <md-tr>
      <md-th>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >from_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-enum-item key="media" >视频</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >at_chatter_ids</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >from_type</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string</md-text>
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="group_chat" >群聊</md-enum-item>
<md-enum-item key="p2p_chat" >单聊</md-enum-item>
</md-enum>
	</md-dt-td>
</md-dt-tr>
