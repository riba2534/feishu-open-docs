---
title: "批量获取数据源"
fullPath: "/uAjLw4CM/ukTMukTMukTM/search-v2/data_source/list"
updateTime: "1677552937000"
---
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/search/v2/data_sources</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	<md-text type="field-type" >data_source\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	数据源中的数据记录
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >is_exceed_quota</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >boolean</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	<md-dt-td>
	<md-text type="field-name" >searchable_fields</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >string\[\]</md-text>
	</md-dt-td>
...
<md-dt-tr level="2">
	...
	<md-dt-td>
	<md-text type="field-type" >i18n_meta</md-text>
	</md-dt-td>
	<md-dt-td>
	数据源的国际化展示名称
	</md-dt-td>
...
<md-tr>
  <md-td>400</md-td>
  <md-td>1271001</md-td>
  <md-td>非法 page_token</md-td>
  <md-td>page_token 无法解析，看是否填写正确</md-td>
</md-tr>
...
<md-tr>
  <md-td>500</md-td>
  <md-td>1271002</md-td>
  <md-td>生成 page_token 失败</md-td>
  <md-td>系统生成 page_token 失败。如果重试后仍然无法成功，请联系系统开发人员</md-td>
</md-tr>
