...
updateTime: "1678425490000"
---

# 常见问题

- 数据源 `state` 为 1（未上线状态）时，无法在飞书搜索中看到对应的 tab，也无法在“综合”中搜索到。可以参考[修改数据源](https://open.larkoffice.com/document/uAjLw4CM/ukTMukTMukTM/search-v2/data_source/patch) 将 `state` 改成 0（上线状态）。
- 如果重复创建数据项，会覆盖。
