---
title: "删除应用消息流卡片"
fullPath: "/uAjLw4CM/ukTMukTMukTM/group/im-v2/app_feed_card-batch/delete"
updateTime: "1724931947000"
---

# 删除应用消息流卡片

该接口用于删除应用消息流卡片{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v2&resource=app_feed_card.batch&method=delete)
...
<md-dt-tr level="0">
	...
	<md-dt-td>
	<md-text type="field-type" >user_open_app_feed_card_deleter\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	否
	</md-dt-td>
...
<md-dt-tr level="1">
	...
	<md-dt-td>
	用户 ID（ID 类型与 user_id_type 的取值一致。如果
