---
title: "更新应用消息流卡片"
fullPath: "/uAjLw4CM/ukTMukTMukTM/group/im-v2/app_feed_card-batch/update"
updateTime: "1724931925000"
---

# 更新应用消息流卡片

该接口用于更新消息流卡片的头像、标题、预览、标签状态、按钮等信息{尝试一下}(url=/api/tools/api_explore/api_explore_config?project=im&version=v2&resource=app_feed_card.batch&method=update)
...
<md-table>
  ...
  <md-tbody>
    <md-tr>
      ...
      <md-td>https://open.feishu.cn/open-apis/im/v2/app_feed_card/batch</md-td>
    </md-tr>
    <md-tr>
...
<md-dt-tr level="0">
	<md-dt-td>
	<md-text type="field-name" >feed_cards</md-text>
	</md-dt-td>
	<md-dt-td>
	<md-text type="field-type" >user_open_app_feed_card_updater\[\]</md-text>
	</md-dt-td>
	<md-dt-td>
	否
	</md-dt-td>
...
**可选值有**：
<md-enum>
<md-enum-item key="1" >标题</md-enum-item>
<md-enum-item key="2" >头像 key</md-enum-item>
<md-enum-item key="3" >预览</md-enum-item>
<md-enum-item key="10" >状态标签</md-enum-item>
<md-enum-item key="11" >按钮</md-enum-item>
<md-enum-item key="12" >跳转链接</md-enum-item>
<md-enum-item key="13" >即时提醒状态</md-enum-item>
<md-enum-item key="101" >展示时间更新到当前</md-enum-item>
<md-enum-item key="102" >排序时间更新到当前</md-enum-item>
<md-enum-item key="103" >进行通知</md-enum-item>
</md-enum>
